...
var _dialog = require('polythene/dialog/dialog');
...
var _shadow = require('polythene/shadow/shadow');

var _shadow2 = _interopRequireDefault(_shadow);

require('polythene/dialog/theme/theme');
...
var show = function show(ctrl, opts) {
    ...
    return _transition2.default.show(Object.assign({}, opts, {
        el: ctrl.el,
...
var hide = function hide(ctrl, opts) {
    var id = ctrl.instanceId;
    ctrl.isTransitioning = true;
    return _transition2.default.hide(Object.assign({}, opts, {
        el: ctrl.el,
        showClass: CSS_CLASSES.visible
    })).then(function () {
...
var createView = function createView(ctrl) {
    ...
    }, [opts.fullscreen ? null : _mithril2.default.component(_shadow2.default, {
        z: ctrl.z,
        animated: true
