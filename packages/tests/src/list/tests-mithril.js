import { List, Icon, ListTile, Notification } from "polythene-mithril";
...
const mithrilTests = ({ List, Icon, ListTile, h }) => {
...
export default []
  ...
  .concat(mithrilTests({ List, Icon, ListTile, Notification, h, a }));
