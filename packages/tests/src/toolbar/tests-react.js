...
import { Toolbar, ToolbarTitle, IconButton, Checkbox } from "polythene-react";
...
const reactTests = ({ Toolbar, ToolbarTitle, IconButton, h }) => {
...
export default []
  .concat(genericTests({ Toolbar, ToolbarTitle, IconButton, Checkbox, h }))
  .concat(reactTests({ Toolbar, ToolbarTitle, IconButton, Checkbox, h }));
