...
export const trustedIconMenu = h => h.trust(iconMenuSVG);
export const trustedIconRefresh = h => h.trust(iconRefreshSVG);
export const trustedIconAddSVG = h => h.trust(iconAddSVG);
