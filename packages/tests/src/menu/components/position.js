...
const createPositionContainer = ({ h, a, Menu, List, ListTile, Shadow, IconButton }) => ({
  oninit: vnode => {
...
export default ({ h, a, Menu, List, ListTile, Shadow, IconButton }) => {
  const PositionContainer = createPositionContainer({ h, a, Menu, List, ListTile, Shadow, IconButton });
  return {
    view: () =>
      h("div", null, [
        h(".layout.horizontal",
