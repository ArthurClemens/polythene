...
export default ({ h, a, Menu, List, ListTile, Button, Shadow, IconButton, Icon, Dialog }) => {

  const { themeColor, themedList, styledList } = themed({ h, Menu, List, ListTile });
  ...
  const MenuItems = menuItems({ h, Menu, List, ListTile });
  ...
  return [
    {
      name: "Menu items",
      component: menuItems({ h, Menu, List, ListTile })
    },
    {
      name: "Exposed menu (simple, without state)",
      interactive: true,
      exclude: true,
      component: opener({ h, a, Menu, button: Button, List, ListTile, dropdown: true, menuFn: simple, id: "simple" })
    },
    {
    ...
    },
    {
      ...
      interactive: true,
      exclude: true,
      component: opener({ h, a, Menu, button: Button, List, ListTile, menuFn: simple, id: "top-menu", height: "50vh", topMenu: true, exposed: false })
    },
    {
      name: "Dropdown menu (option: origin)",
      interactive: true,
      exclude: true,
      component: position({ h, a, Menu, List, ListTile, Shadow, IconButton })
    },
    {
      name: "Dropdown menu (option: reposition) (positioned to the selected item)",
      interactive: true,
      exclude: true,
      component: settings({ h, a, Menu, List, ListTile })
    },
    {
      ...
      component: {
        view: () =>
          Opener(menuDialog({ h, a, Icon, List, ListTile, Dialog }))
      }
    },
    {
      ...
      interactive: true,
      exclude: true,
      component: opener({ h, a, Menu, Button, List, ListTile, menuFn: transitions, id: "transitions",
        transitionOptions: {
          transitions: {
            show: ({ el }) => ({
              el,
    ...
    },
    {
      ...
      interactive: true,
      exclude: true,
      component: opener({ h, a, Menu, Button, List, ListTile, menuFn: transitions, id: "showDelay",
        transitionOptions: {
          showDuration: .9,
          hideDuration: 1.2,
          hideDelay: .3,
    ...
    {
      name: "Option: width",
      component: widths({ h, Menu, List, ListTile })
    },
    {
      name: "Option: style",
      component: {
    ...
    },
    {
      ...
      interactive: true,
      exclude: true,
      component: opener({ h, a, Menu, Button, List, ListTile, menuFn: transitions, id: "theme-transitions",
        className: "tests-menu-transitions"
      })
    },
    {
      name: "Themed behavior: set top menu",
      component: opener({ h, a, Menu, button: Button, List, ListTile, menuFn: simple, id: "top-menu-themed", exposed: false, className: "tests-menu-themed-behavior-top" })
    },
