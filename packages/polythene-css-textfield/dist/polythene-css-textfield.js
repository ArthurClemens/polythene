(function (global, factory) {
  ...
  const tintFns = tint => ({
    ["color_" + tint + "_focus_border"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
      color: vars["color_" + tint + "_focus_border"] // override by specifying "color"

    })],
    ["color_" + tint + "_input_background"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
      " .pe-textfield__input-area": {
    ...
    ["color_" + tint + "_counter_ok_border"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
    ...
    ["color_" + tint + "_input_bottom_border"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
      " .pe-textfield__input": {
    ...
    ["color_" + tint + "_disabled_label_text"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--disabled, &.pe-textfield--readonly": {
        " .pe-textfield__input-area:after": {
    ...
    ["color_" + tint + "_readonly_label_text"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
    ...
    ["color_" + tint + "_highlight_text"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
    ...
    ["color_" + tint + "_required_symbol"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--focused": {
    ...
    ["color_" + tint + "_help_text"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
      " .pe-textfield__help, .pe-textfield__counter": {
        color: vars["color_" + tint + "_help_text"]
      }
    })],
    ["color_" + tint + "_input_error_border"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--invalid:not(.pe-textfield--hide-validation)": {
        " .pe-textfield__input": {
    ...
    ["color_" + tint + "_input_error_text"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--invalid:not(.pe-textfield--hide-validation)": {
        " .pe-textfield__label": {
  ...
  const vertical_spacing_top_input_padding_v = (selector, vars) => polytheneCoreCss.sel(selector, {
    " .pe-textfield__label": {
      top: vars.vertical_spacing_top + vars.input_padding_v + "px"
    }
  });

  const floating_label_vertical_spacing_top_input_padding_v = (selector, vars) => polytheneCoreCss.sel(selector, {
    ".pe-textfield--floating-label .pe-textfield__label": {
      top: vars.floating_label_vertical_spacing_top + vars.input_padding_v + "px"
    }
  });

  const dense_floating_label_vertical_spacing_top_input_padding_v = (selector, vars) => polytheneCoreCss.sel(selector, {
  ...
  const input_padding_v_input_padding_h = (selector, vars) => polytheneCoreCss.sel(selector, {
    " .pe-textfield__input": {
  ...
  const full_width_input_padding_v_full_width_input_padding_h = (selector, vars) => polytheneCoreCss.sel(selector, {
  ...
  const dense_full_width_input_padding_v_dense_full_width_input_padding_h = (selector, vars) => polytheneCoreCss.sel(selector, {
  ...
  const varFns = {
    general_styles: selector => [polytheneCoreCss.sel(selector, [alignLeft(), polytheneCoreCss.mixin.clearfix(), {
      position: "relative",
    ...
    vertical_spacing_bottom: (selector, vars) => [polytheneCoreCss.sel(selector, {
      paddingBottom: vars.vertical_spacing_bottom + "px"
    })],
    floating_label_vertical_spacing_bottom: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--floating-label": {
    ...
    vertical_spacing_top: (selector, vars) => [polytheneCoreCss.sel(selector, {
      " .pe-textfield__input-area": {
        paddingTop: vars.vertical_spacing_top + "px"
      }
    }), vertical_spacing_top_input_padding_v(selector, vars)],
    input_padding_v: (selector, vars) => [vertical_spacing_top_input_padding_v(selector, vars), floating_label_vertical_spacing_top_input_padding_v(selector, vars), dense_floating_label_vertical_spacing_top_input_padding_v(selector, vars), input_padding_v_input_padding_h(selector, vars)],
    input_padding_h: (selector, vars) => [polytheneCoreCss.sel(selector, {
      " .pe-textfield__label": {
        left: vars.input_padding_h + "px",
        right: vars.input_padding_h + "px"
      }
    }), input_padding_v_input_padding_h(selector, vars)],
    floating_label_vertical_spacing_top: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--floating-label": {
        " .pe-textfield__input-area": {
    ...
    dense_floating_label_vertical_spacing_top: (selector, vars) => [polytheneCoreCss.sel(selector, {
    ...
    input_focus_border_animation_duration: (selector, vars) => [polytheneCoreCss.sel(selector, {
    ...
    input_focus_border_width: (selector, vars) => [polytheneCoreCss.sel(selector, {
      " .pe-textfield__input-area:after": {
        height: vars.input_focus_border_width + "px"
      }
    })],
    font_size_error: (selector, vars) => [polytheneCoreCss.sel(selector, {
      " .pe-textfield__error, .pe-textfield__error-placeholder, .pe-textfield__help, .pe-textfield__counter": {
    ...
    input_border_width: (selector, vars) => [polytheneCoreCss.sel(selector, {
      " .pe-textfield__input": {
    ...
    full_width_input_padding_v: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--full-width": {
        " .pe-textfield__label": {
    ...
    full_width_input_padding_h: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--full-width": {
    ...
    dense_font_size_input: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--dense": {
        "&, .pe-textfield__input, .pe-textfield__label": {
    ...
    dense_full_width_font_size_input: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--dense": {
        " .pe-textfield__input": {
    ...
    dense_full_width_input_padding_v: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--full-width": {
        ".pe-textfield--dense": {
          " .pe-textfield__label": {
    ...
    dense_full_width_input_padding_h: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--full-width": {
        ".pe-textfield--dense": {
          " .pe-textfield__label": {
    ...
    margin_top_error_message: (selector, vars) => [polytheneCoreCss.sel(selector, {
      " .pe-textfield__error, .pe-textfield__error-placeholder, .pe-textfield__help, .pe-textfield__counter": {
        marginTop: vars.margin_top_error_message + "px"
      }
    })],
    floating_label_animation_duration: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--floating-label": {
        " .pe-textfield__label": polytheneCoreCss.mixin.defaultTransition("all", vars.floating_label_animation_duration)
      }
    })],
    dense_font_size_floating_label: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--floating-label": {
        ".pe-textfield--dense": {
          ".pe-textfield--focused, &.pe-textfield--dirty": {
    ...
    dense_floating_label_top: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--floating-label": {
        ".pe-textfield--dense": {
          ".pe-textfield--focused, &.pe-textfield--dirty": {
            " .pe-textfield__label": {
    ...
    floating_label_top: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--floating-label": {
        ".pe-textfield--focused, &.pe-textfield--dirty": {
          " .pe-textfield__label": {
    ...
    font_size_floating_label: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-textfield--floating-label": {
        ".pe-textfield--focused, &.pe-textfield--dirty": {
          " .pe-textfield__label": {
