(function (global, factory) {
	...
	var keyboardState = (function (_ref) {
	  ...
	  polytheneCss.ListTileCSS.addStyle(".tests-list-keyboard-list-tile", {
	  ...
	  return {
	    oninit: function oninit(vnode) {
	      ...
	      _extends(vnode.state, {
	        cityIndex: cityIndex,
	        handleKey: handleKey,
	        redrawOnUpdate: stream$1.merge([cityIndex]) // for React
	      });
	    },
	    view: function view(vnode) {
	      ...
	      _defineProperty({}, k.onkeydown, state.handleKey), h(List, {
	        border: true,
	...
	polytheneCss.ListTileCSS.addStyle(".tests-list-navigation-list", {
	...
	var genericTests = (function (_ref) {
	  ...
	  var KeyboardState = keyboardState({ h: h, k: k, List: List, ListTile: ListTile });
	  var Navigation = navigation({ h: h, k: k, Icon: Icon, List: List, ListTile: ListTile });

	  polytheneCss.ListCSS.addStyle(".tests-lists-themed-list", {
	  ...
	  polytheneCss.ListTileCSS.addStyle(".tests-lists-themed-list-tile", {
	  ...
	  var ListTileJennifer = h(ListTile, {
	  ...
	  return [{
	    ...
	    attrs: {
	      ...
	      tiles: [h(ListTile, { style: { color: "#fff" }, title: "One", key: "One" }), h(ListTile, { style: { color: "#fff" }, title: "Two", key: "Two" }), h(ListTile, { style: { color: "#fff" }, title: "Three", key: "Three" })],
	      style: {
	...
	var testsMithril = [].concat(genericTests({ List: polytheneMithril.List, Icon: polytheneMithril.Icon, ListTile: polytheneMithril.ListTile, Notification: polytheneMithril.Notification, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys })).concat(mithrilTests({ List: polytheneMithril.List, Icon: polytheneMithril.Icon, ListTile: polytheneMithril.ListTile, Notification: polytheneMithril.Notification, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys }));
	...
	*/
	  ...
	  return [{
	    ...
	    component: function component() {
	      return react.createElement(
	        ...
	        react.createElement(ListTile, { key: "one", indent: true, title: "Jennifer Barker", subtitle: "Starting post doc", front: react.createElement(Icon, {
	            src: "http://arthurclemens.github.io/assets/polythene/examples/avatar-1.png",
	            avatar: true,
	            size: "large"
	          })
	        }),
	        react.createElement(ListTile, { key: "two", indent: true, title: "Ali Connors", subtitle: "Brunch this weekend?", front: react.createElement(Icon, {
	            src: "http://arthurclemens.github.io/assets/polythene/examples/avatar-2.png",
	            avatar: true,
	            size: "large"
	          })
	        }),
	        react.createElement(ListTile, { key: "three", indent: true, title: "Grace VanDam", subtitle: "Binge watching...", front: react.createElement(Icon, {
	            src: "http://arthurclemens.github.io/assets/polythene/examples/avatar-3.png",
	            avatar: true,
	            size: "large"
	          })
	...
	var testsReact = [].concat(genericTests({ List: polytheneReact.List, Icon: polytheneReact.Icon, ListTile: polytheneReact.ListTile, Notification: polytheneReact.Notification, renderer: polytheneReact.renderer, keys: polytheneReact.keys })).concat(reactTests({ List: polytheneReact.List, Icon: polytheneReact.Icon, ListTile: polytheneReact.ListTile, Notification: polytheneReact.Notification, renderer: polytheneReact.renderer, keys: polytheneReact.keys }));
