import { transitionStateReducer, transitionComponent, classForSize, filterSupportedAttributes } from 'polythene-core';
...
var showSpinner = function showSpinner(opts) {
  return transitionComponent(_objectSpread2(_objectSpread2({}, opts), {}, {
    isShow: true
  }));
