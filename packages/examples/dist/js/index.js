...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_j2c__ = __webpack_require__(191);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_polythene_core_css__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_polythene_theme__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_polythene_theme___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__);
...
var throttle = function throttle(func) {
    ...
    var context = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : __WEBPACK_IMPORTED_MODULE_0_polythene_core__["a" /* isClient */] ? window : {};
...
if (__WEBPACK_IMPORTED_MODULE_0_polythene_core__["a" /* isClient */]) {
...
var isTouch = __WEBPACK_IMPORTED_MODULE_0_polythene_core__["b" /* isServer */] ? false : 'ontouchstart' in window || navigator.MaxTouchPoints > 0 || navigator.msMaxTouchPoints > 0;
...
var whichTransitionEvent = (function () {
    if (__WEBPACK_IMPORTED_MODULE_0_polythene_core__["b" /* isServer */]) {
        return 'animationend';
    }
...
var defaultTransition = function defaultTransition() {
    ...
    var duration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].animation_duration;
    var curve = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].animation_curve_default;

    return [vendorize({
        'transition-delay': 0
    }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_transition), vendorize({
        'transition-duration': duration
    }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_transition), vendorize({
        'transition-timing-function': curve
    }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_transition), vendorize({
        'transition-property': properties
    }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_transition)];
};
...
var createStyles = function createStyles(config) {
    return [{
        '.pe-ripple': [mixin.fit(), {
            ...
            }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_transform)],

            ' .pe-ripple__waves': [mixin.vendorize({
                'transform': 'scale(' + config.start_scale + ')'
            }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_transform), mixin.vendorize({
                'animation': 'ripple ' + __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].animation_curve_default
            }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_animation),
            // default durations; finally set in js
            mixin.vendorize({
                'animation-duration': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].animation_duration
            }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_animation), {
...
var configFn = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].ripple;
var config = configFn ? configFn(vars) : vars;
var id = 'pe-ripple';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id, layout(config));
...
var createView$1 = function createView(ctrl) {
    ...
    if (opts.disabled) {
        return __WEBPACK_IMPORTED_MODULE_2_mithril___default()('');
    }
    ...
    var content = __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
        class: CSS_CLASSES$1.mask
    }, __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
        class: CSS_CLASSES$1.waves,
        config: initWaves
    }));
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(tag, props, content);
};

var component$1 = {
    controller: function controller() {
        return {
            ripple: __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.prop(),
            waves: __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.prop(),
            delegate: __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.prop()
        };
    },
...
var shadowDirective = function shadowDirective(dir) {
    return mixin.vendorize({
        'box-shadow': dir
    }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_box_shadow);
};
...
var configFn$1 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].shadow;
var config$1 = configFn$1 ? configFn$1(vars$1) : vars$1;
var id$1 = 'pe-shadow';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$1, layout$1(config$1));
...
var createView$2 = function createView(ctrl) {
    ...
    var content = [opts.content ? opts.content : null, __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
...
var style = [{
    '.pe-button': [mixin.vendorize({
        'user-select': 'none'
    }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_user_select), {
        outline: 'none',
        padding: 0,
...
__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$2, style);

var rgba = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba;

var touch_height = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_touch_height;
var height = 36;

var buttonConfig = {
    margin_h: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit,
    border_radius: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_item_border_radius,
    font_size: 14,
    font_weight: 500,
    outer_padding_v: (touch_height - height) / 2,
    padding_h: 2 * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit,
    padding_v: 11,
    min_width: 8 * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component,
    ...
    color_light_flat_normal_text: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_primary),
    color_light_flat_hover_background: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_background_hover),
    color_light_flat_focus_background: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_background_hover),
    color_light_flat_active_background: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_background_active),
    color_light_flat_disabled_background: 'transparent',
    color_light_flat_disabled_text: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_disabled),
    ...
    color_light_raised_normal_text: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_primary),
    color_light_raised_hover_background: 'transparent',
    color_light_raised_focus_background: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_background_hover),
    color_light_raised_active_background: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_background_hover), // same as hover
    color_light_raised_disabled_background: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_background_disabled),
    color_light_raised_disabled_text: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_disabled),

    color_dark_flat_normal_background: 'transparent',
    color_dark_flat_normal_text: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_primary),
    color_dark_flat_hover_background: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_background_hover),
    color_dark_flat_focus_background: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_background_hover),
    color_dark_flat_active_background: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_background_active),
    color_dark_flat_disabled_background: 'transparent',
    color_dark_flat_disabled_text: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_disabled),
    ...
    color_dark_raised_normal_background: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary),
    color_dark_raised_normal_text: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_primary),
    color_dark_raised_hover_background: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary_active,
    color_dark_raised_focus_background: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary_active,
    color_dark_raised_active_background: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary_dark,
    color_dark_raised_disabled_background: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_background_disabled),
    color_dark_raised_disabled_text: rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_disabled)
};
...
var configFn$2 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].button;
var config$2 = configFn$2 ? configFn$2(buttonConfig) : buttonConfig;
var id$3 = 'pe-button-text';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$3, layout$3(config$2), color(config$2));
...
var MAX_Z = 5;
var startType = __WEBPACK_IMPORTED_MODULE_0_polythene_core__["a" /* isClient */] ? window.PointerEvent ? 'pointerdown' : 'ontouchstart' in window || window.DocumentTouch && document instanceof window.DocumentTouch ? 'touchstart' : 'mousedown' : 'mousedown';
var endType = __WEBPACK_IMPORTED_MODULE_0_polythene_core__["a" /* isClient */] ? window.PointerEvent ? 'pointerup' : 'ontouchend' in window || window.DocumentTouch && document instanceof window.DocumentTouch ? 'touchend' : 'mouseup' : 'mouseup';
...
var animateZ = function animateZ(ctrl, opts, name) {
    ...
    if (z !== ctrl.z()) {
        ctrl.z(z);
        __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.redraw(); // make animation visible
    }
};

var inactivate = function inactivate(ctrl, opts) {
    ctrl.inactive = true;
    __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.redraw();
    setTimeout(function () {
        ctrl.inactive = false;
        __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.redraw();
...
var createView = function createView(ctrl) {
        ...
        onkeydown: function onkeydown(e) {
            if (e.which === 13 && ctrl.focus && ctrl.el) {
                ...
                var event = new MouseEvent('click', {
                    view: __WEBPACK_IMPORTED_MODULE_0_polythene_core__["a" /* isClient */] ? window : {},
                    bubbles: true,
                    cancelable: true
                });
    ...
    var label = opts.content ? opts.content : opts.label ? _typeof(opts.label) === 'object' ? opts.label : __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES.label }, opts.label) : null;
    ...
    }, [opts.raised && !disabled ? __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.component(component$2, {
        z: ctrl.z(),
        animated: true
    }) : null,
    // ripple
    disabled ? null : __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.component(component$1, rippleOpts),
    // hover
    wash ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES.wash }) : null,
    // focus
    disabled ? null : __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES.focus }), label]);
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(tag, props, [opts.before, content, opts.after]);
};
...
var component = {
    controller: function controller() {
        ...
        return {
            el: undefined,
            baseZ: __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.prop(z),
            z: __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.prop(z),
            inactive: undefined,
            focus: false,
            mouseover: false
        };
...
var vars$2 = {
    size_small: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size_small,
    size_regular: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size,
    size_medium: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size_medium,
    size_large: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size_large
};

var iconSizesPx = function iconSizesPx() {
    var size = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size;
    return {
        width: size + 'px',
        height: size + 'px'
    };
...
var configFn$3 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].icon;
var config$3 = configFn$3 ? configFn$3(vars$2) : vars$2;
var id$4 = 'pe-icon';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$4, layout$4(config$3));
...
var layoutContent = function layoutContent(opts) {
    if (opts.content) {
        ...
        return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$6, svgOpts);
    } else if (opts.msvg) {
        return __WEBPACK_IMPORTED_MODULE_2_mithril___default()('i.pe-svg', __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.trust(opts.msvg));
    } else {
        return __WEBPACK_IMPORTED_MODULE_2_mithril___default()('i', __WEBPACK_IMPORTED_MODULE_2_mithril___default()('img', {
            src: opts.src
        }));
    }
};
...
var component$5 = {
    controller: function controller() {
        __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.redraw.strategy('none');
    },
    view: function view(ctrl) {
        var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
var rgba$1 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba;
...
var vars$3 = {
    ...
    front_item_width: 72,
    side_padding: 2 * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component,
    font_size_title: 16,
    ...
    color_light_title: rgba$1(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_primary),
    color_light_subtitle: rgba$1(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_secondary),
    color_light_info: rgba$1(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_tertiary),
    color_light_text_disabled: rgba$1(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_disabled),
    color_light_list_header: rgba$1(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_tertiary),
    color_light_background_hover: rgba$1(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_background_hover),
    color_light_background_selected: rgba$1(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_background_hover),

    color_dark_title: rgba$1(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_primary),
    color_dark_subtitle: rgba$1(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_secondary),
    color_dark_info: rgba$1(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_tertiary),
    color_dark_text_disabled: rgba$1(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_disabled),
    color_dark_list_header: rgba$1(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_tertiary),
    color_dark_background_hover: rgba$1(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_background_hover),
    color_dark_background_selected: rgba$1(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_background_hover)
};
    ...
    return [{
        '.pe-list-tile': [flex$1.layout, {
            ...
            ' .pe-list-tile__title': [mixin.ellipsis(1), {
                'font-size': config.font_size_title + 'px',
                'font-weight': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].font_weight_normal,
            ...
            '&.pe-list__header': {
                ...
                ' .pe-list-tile__title': [mixin.ellipsis(1, config.single_height), {
                    ...
                    'font-weight': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].font_weight_medium,
...
var configFn$4 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"]['list-tile'];
var config$4 = configFn$4 ? configFn$4(vars$3) : vars$3;
var id$5 = 'pe-list-tile';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$5, layout$5(config$4), color$1(config$4));
...
var parsePrimaryContent = function parsePrimaryContent(opts) {
    ...
    var frontComp = opts.front ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
        class: CSS_CLASSES$6.content + ' ' + CSS_CLASSES$6.contentFront
    }, opts.front) : opts.indent ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
        class: CSS_CLASSES$6.content + ' ' + CSS_CLASSES$6.contentFront
    }) : null;

    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(tag, _extends$5({}, {
        class: CSS_CLASSES$6.primary
    }, opts.url, opts.events), [frontComp, __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
        class: CSS_CLASSES$6.content
    }, [opts.content ? opts.content : null, opts.title ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$6.title }, opts.title) : null, opts.subtitle ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$6.subtitle }, opts.subtitle) : null, opts.highSubtitle ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$6.subtitle + ' ' + CSS_CLASSES$6.highSubtitle }, opts.highSubtitle) : null])]);
};
...
var parseSecondaryContent = function parseSecondaryContent(opts) {
    ...
    }, secondaryOpts.url, secondaryOpts.events), __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
        class: CSS_CLASSES$6.content
    }, [secondaryOpts.icon ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$5, secondaryOpts.icon) : null, secondaryOpts.content ? secondaryOpts.content : null]));
};
...
var createView$6 = function createView(ctrl) {
    ...
    var content = [opts.ink && !opts.disabled ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$1, opts.ripple) : null, parsePrimaryContent(opts), opts.secondary ? parseSecondaryContent(opts) : null];
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(tag, props, [opts.before, content, opts.after]);
};
...
var rgba$2 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba;
...
var vars$4 = {
    ...
    border_radius: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_block_border_radius,
    padding_h: 16,
    ...
    color_light_main_background: rgba$2(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_background),
    color_light_title_text: rgba$2(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_primary),
    color_light_subtitle_text: rgba$2(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_secondary),
    color_light_text: rgba$2(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_regular),
    color_light_actions_border: rgba$2(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_border_light),
    color_light_overlay_background: rgba$2(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_overlay_background),

    color_dark_main_background: rgba$2(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_background),
    color_dark_title_text: rgba$2(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_primary),
    color_dark_subtitle_text: rgba$2(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_secondary),
    color_dark_text: rgba$2(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_regular),
    color_dark_actions_border: rgba$2(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_border_light),
    color_dark_overlay_background: rgba$2(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_overlay_background)
};
...
var configFn$5 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].card;
var config$5 = configFn$5 ? configFn$5(vars$4) : vars$4;
var id$6 = 'pe-card';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$6, layout$7(config$5), color$2(config$5));
...
var createOverlay = function createOverlay() {
    ...
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
        class: [CSS_CLASSES$3.overlay, opts.sheet ? CSS_CLASSES$3.overlaySheet : null].join(' ')
    }, [__WEBPACK_IMPORTED_MODULE_2_mithril___default()(tag, {
        class: [CSS_CLASSES$3.overlayContent, opts.class].join(' ')
    }, content), __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
...
var createText = function createText(o) {
    var opts = o.text || {};
    var tag = opts.tag || 'div';
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(tag, {
...
var createMedia = function createMedia(o) {
    ...
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(tag, {
        ...
        config: initImage
    }, [opts.content, opts.overlay ? createOverlay(opts.overlay) : __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$3.mediaDimmer })]);
};

var createHeader = function createHeader(o) {
    var opts = o.header || {};
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$7, _extends$2({}, opts, {
        class: [CSS_CLASSES$3.header, opts.class].join(' ')
    }, opts.icon ? {
        front: __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$5, opts.icon)
    } : null));
};
...
var createPrimary = function createPrimary(o) {
    ...
    var lookup = {
        title: function title(pops) {
            return pops.attrs ? pops : __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$3.title }, [pops.title ? pops.title : null, pops.subtitle ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$3.subtitle }, pops.subtitle) : null]);
        },
...
var createView$3 = function createView(ctrl) {
    ...
    if (Array.isArray(opts.content)) {
        ...
        content.unshift(__WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$2, {
            z: ctrl.z(),
            animated: true
        }));
    } else {
        content = [__WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$2, {
            z: ctrl.z(),
            animated: true
        }), opts.content];
    }
...
var createView$8 = function createView(ctrl) {
    ...
    var content = [__WEBPACK_IMPORTED_MODULE_2_mithril___default()('input', {
    ...
    }), __WEBPACK_IMPORTED_MODULE_2_mithril___default()('label', _extends$6({}, {
    ...
    }), [opts.selectionView ? opts.selectionView(checked, opts) : null, opts.label ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('span', opts.label) : null])];
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(tag, props, [opts.before, content, opts.after]);
};
...
var padding$1 = (__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_icon_button - __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size) / 2; // 12
var padding_compact = (__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_icon_button - __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size) / 3; // 8

var iconButtonConfig = {
  padding: padding$1,
  padding_compact: padding_compact,

  color_light_wash_opacity: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_background_hover_medium,
  color_light_focus_opacity: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_background_hover_medium,
  color_light_flat_normal_text: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_secondary),

  color_dark_wash_opacity: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_background_hover_medium,
  color_dark_focus_opacity: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_background_hover_medium,
  color_dark_flat_normal_text: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_secondary)
};
...
var configFn$6 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"]['icon-button'];
var config$6 = configFn$6 ? configFn$6(iconButtonConfig) : iconButtonConfig;
var id$7 = 'pe-icon-button';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$7, layout$8(config$6), color$3(config$6));
...
var createView$9 = function createView(ctrl) {
    ...
    var content = opts.icon ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$5, opts.icon) : opts.content ? opts.content : null;
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component, _extends$8({}, opts, {
        content: __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
...
var createSelection = function createSelection(checked, opts) {
    ...
    }, __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$11, _extends$7({}, {
        tag: 'div',
        class: CSS_CLASSES$8.button,
        content: [__WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$5, createIcon('iconOn', _extends$7({}, {
            class: CSS_CLASSES$8.buttonOn
        }, opts))), __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$5, createIcon('iconOff', _extends$7({}, {
...
var activeColor = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary; // or override in CSS by setting 'color' property on '.pe-checkbox' / '.pe-radio-button'
var rgba$3 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba;
var label_padding = (__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_icon_button - __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size) / 2; // 12

var selectionControlConfig = {
    label_font_size: 2 * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component, // 16
    label_height: 3 * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component, // 24
    padding: Math.floor(1.7 * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component),
    label_padding: label_padding,
    button_size: 6 * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component,
    icon_size: 3 * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component,
    animation_duration: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].animation_duration,

    color_light_on_text: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(activeColor),
    color_light_off_text: rgba$3(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_secondary),
    color_light_off_icon: rgba$3(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_secondary),
    color_light_label_text: rgba$3(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_secondary),
    color_light_disabled_text: rgba$3(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_disabled),
    color_light_thumb_off_focus_opacity: .08,
    color_light_thumb_on_focus_opacity: .11,

    color_light_focus_on: rgba$3(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary),
    color_light_focus_on_opacity: .11,
    color_light_focus_off: rgba$3(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground),
    color_light_focus_off_opacity: .07,

    color_dark_on_text: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(activeColor),
    color_dark_off_text: rgba$3(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_secondary),
    color_dark_off_icon: '#fff',
    color_dark_label_text: rgba$3(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_secondary),
    color_dark_disabled_text: rgba$3(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_disabled),
    color_dark_thumb_off_focus_opacity: .08,
    color_dark_thumb_on_focus_opacity: .11,

    color_dark_focus_on: rgba$3(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary), // or '#80cbc4'
    color_dark_focus_on_opacity: .14,
    color_dark_focus_off: rgba$3(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground),
...
var getSize = function getSize(config, height) {
    var iconSize = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size;
...
var createStyles$12 = function createStyles(config, className, type) {
    ...
    return [{
        '.pe-control': (_peControl = {
            ...
            'appearance': 'none'
        }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_appearance), {
            'line-height': config.label_height + 'px',
            // Hide input element
            position: 'absolute',
            'z-index': '-1',
        ...
        }), _defineProperty$6(_peControl, '&.pe-control--small', getSize(config, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size_small, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size_small)), _defineProperty$6(_peControl, '&.pe-control--regular', getSize(config, config.label_height, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size)), _defineProperty$6(_peControl, '&.pe-control--medium', getSize(config, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size_medium, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size_medium)), _defineProperty$6(_peControl, '&.pe-control--large', getSize(config, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size_large, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size_large)), _peControl)
    }];
};
...
var configFn$7 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].checkbox;
var config$7 = configFn$7 ? configFn$7(selectionControlConfig) : selectionControlConfig;
var id$8 = 'pe-checkbox';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$8, layout$9(config$7), color$4(config$7));

// default icons
var iconOff = __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.trust('<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M19 5v14H5V5h14m0-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z"/></svg>');
var iconOn = __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.trust('<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M19 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.11 0 2-.9 2-2V5c0-1.1-.89-2-2-2zm-9 14l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>');
...
var createView$7 = function createView(ctrl) {
    ...
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$10, opts);
};
    ...
    return {
        ...
        view: function view() {
            ...
            if (!toShowItems.length) {
                ...
                return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(mOpts.noneTag);
            } else {
                if (__WEBPACK_IMPORTED_MODULE_0_polythene_core__["a" /* isClient */]) {
                    document.body.classList.add(mOpts.bodyShowClass);
                }
            }
            return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(mOpts.tag, toShowItems.map(function (itemData) {
                return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(mOpts.instance, _extends$9({}, itemData, {
...
var transition = function transition(opts, state) {
    var deferred = __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.deferred();
    var el = opts.el;
    if (!el) {
        deferred.resolve();
...
var rgba$4 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba;

var vars$6 = {
    border_radius: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_block_border_radius,
    padding: 3 * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component,
    header_bottom: 20,
    header_height: 60,
    footer_height: 52,

    color_light_content_background: rgba$4(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_background),
    color_light_title_text: rgba$4(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_primary),
    color_light_body_text: rgba$4(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_regular),
    color_light_body_border: rgba$4(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_border_light),
    color_light_backdrop_background: 'rgba(0, 0, 0, .4)',

    color_dark_content_background: rgba$4(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_background),
    color_dark_title_text: rgba$4(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_primary),
    color_dark_body_text: rgba$4(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_regular),
    color_dark_body_border: rgba$4(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_border_light),
...
var createStyles$14 = function createStyles(config) {
    ...
    return [{
        ...
        mixin.vendorize({
        ...
        }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_transition), mixin.vendorize({
            ...
            right: 0,
            bottom: 0,
            'z-index': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].z_dialog,
            ...
            ' .pe-dialog__content': [flex$1.layoutVertical, {
                ...
                'max-height': '100%',
                'min-width': 56 * 5 + 'px',
                'max-width': 7 * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_menu + 'px',
                'border-radius': config.border_radius + 'px',
            ...
            ' .pe-dialog__title': {
                'font-size': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].font_size_title + 'px',
...
var configFn$8 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].dialog;
var config$8 = configFn$8 ? configFn$8(vars$6) : vars$6;
var id$9 = 'pe-dialog';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$9, layout$10(config$8), color$5(config$8));
...
var hide = function hide(ctrl, opts) {
    ...
    return transition$1.hide(_extends$10({}, opts, {
        ...
        setTimeout(__WEBPACK_IMPORTED_MODULE_2_mithril___default.a.redraw, 0); // removes remainder of drawn component
    });
};
...
var createView$10 = function createView(ctrl) {
        ...
        config: function config(el, inited, context, vdom) {
            ...
            show(ctrl, opts).then(function () {
                ...
                if (ctrl.topOverflow || ctrl.bottomOverflow) {
                    setTimeout(__WEBPACK_IMPORTED_MODULE_2_mithril___default.a.redraw, 0);
                }
            });
        },
    ...
    }, [opts.fullscreen ? null : __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$2, {
        z: ctrl.z,
        animated: true
    }), opts.fullscreen ? null : opts.title ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
        class: CSS_CLASSES$10.header,
        config: function config(el) {
            ctrl.headerHeight = el.scrollHeight;
        }
    }, [__WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$10.title }, opts.title)]) : null, body, opts.fullscreen ? null : opts.footer ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
    ...
    }, [__WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$10.actions }, opts.footer)]) : null]);
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(tag, props, [opts.before, content, opts.after]);
};
...
var rgba$5 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba;

var vars$7 = {
    size_regular: 7 * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component,
    size_mini: 5 * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component,
    padding_regular: 2 * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component,

    color_light_background: rgba$5(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary),
    color_light_text: rgba$5(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary_foreground),

    color_dark_background: rgba$5(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary),
    color_dark_text: rgba$5(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary_foreground)
};
    ...
    return [{
        '.pe-button--fab': [mixin.vendorize({
            ...
            '&.pe-button--fab-mini': {
                ...
                padding: (config.size_mini - __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size) / 2 + 'px'
            },
            ...
            ' .pe-button__wash': [mixin.vendorize({
                transition: 'background-color ' + __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].animation_duration + ' ease-in-out'
            }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_transition), {
                'border-radius': 'inherit',
                'pointer-events': 'none',
...
var configFn$9 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].fab;
var config$9 = configFn$9 ? configFn$9(vars$7) : vars$7;
var id$10 = 'pe-fab';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$10, layout$11(config$9), color$6(config$9));
...
var createView$11 = function createView(ctrl) {
    ...
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$11, _extends$11({}, opts, {
...
var margin_side = 2 * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component - 12; // (buttonSize - iconSize) / 2 = (48 - 24) / 2
var height_desktop = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component * 8; // 64
var height_mobile_portrait = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component * 7; // 56
var height_mobile_landscape = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component * 6; // 48

var vars$8 = {
    margin_side: margin_side,
    indent: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_indent,
    transition_duration: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].animation_duration,
    font_size: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].font_size_title,
    line_height: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].line_height,
    ...
    color_light_text: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_primary),
    color_dark_text: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_primary)
};
        ...
        mixin.vendorize({
            ...
            ' .pe-toolbar__bar': [flex$1.layoutCenter, flex$1.layoutHorizontal, {
                ...
                ' .pe-button--icon + span, .pe-button--icon + .pe-title': {
                    'margin-left': config.indent - config.margin_side - __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_icon_button + 'px'
                }
            }, {
                '> span, > .pe-title': [mixin.ellipsis(1, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].line_height, 'em'), mixin.vendorize({
                    'transform-origin': 'left 50%'
                }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_transform), {
                    'line-height': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].line_height + 'em',
                    'word-break': 'break-all'
                }]
            }, {
                '> span:first-child, .pe-toolbar__title--indent': [mixin.ellipsis(1, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].line_height, 'em'), {
                ...
                ' .pe-header': mixin.ellipsis(1, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].line_height, 'em'),
...
var configFn$10 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].toolbar;
var config$10 = configFn$10 ? configFn$10(vars$8) : vars$8;
var id$11 = 'pe-toolbar';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$11, layout$12(config$10), color$7(config$10));
    ...
    return [{
        '.pe-header-panel': {
            ...
            ':not(.pe-header-panel--fit):not(.pe-header-panel--fixed):not(.pe-header-panel--scroll) > .pe-header-panel__outer-container > .pe-header-panel__header-container': {
                'z-index': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].z_header_container
            },
            '.pe-header-panel--fit > .pe-header-panel__outer-container > .pe-header-panel__header-container': {
                'z-index': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].z_fixed_header_container
            },
            ...
            }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_background_size), {
                position: 'absolute',
                top: 0,
                left: 0,
                width: '100%',
...
var configFn$11 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"]['header-panel'];
var config$11 = configFn$11 ? configFn$11(vars$9) : vars$9;
var id$12 = 'pe-header-panel';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$12, layout$13(config$11));
...
var setTransform = __WEBPACK_IMPORTED_MODULE_0_polythene_core__["a" /* isClient */] ? document.documentElement.style.transform !== undefined ? function (style, string) {
...
var createHeaderComponent = function createHeaderComponent() {
    ...
    if (toolbarOpts) {
        ...
        if (!toolbarOpts.topBar) {
            toolbarOpts.topBar = __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div');
        }
        return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$17, toolbarOpts);
    } else if (opts.content) {
        return __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
            class: [CSS_CLASSES$12.header, opts.class || null, tall ? tallClass : null, opts.animated ? CSS_CLASSES$12.headerAnimated : ''].join(' ')
        }, opts.content);
    } else {
        return __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', opts);
    }
};
...
var createViewHeader = function createViewHeader(ctrl) {
    ...
    }, [__WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$12.condensedBackground }), __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$12.headerBackground }), __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$12.mediaDimmer })]), header, ctrl.mode === 'seamed' || ctrl.shadow === false ? null : __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$12.dropShadow })]);
};
...
var rgba$6 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba;

var vars$10 = {
    padding: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component,
    padding_compact: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component / 2,
    border_width_stacked: 1,
    border_width_bordered: 1,

    color_light_border: rgba$6(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_border_light),
    color_dark_border: rgba$6(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_border_light)
};
...
var configFn$12 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].list;
var config$12 = configFn$12 ? configFn$12(vars$10) : vars$10;
var id$13 = 'pe-list';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$13, layout$14(config$12), color$8(config$12));
...
var createView$14 = function createView(ctrl) {
    ...
    var content = [headerOpts ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$7, headerOpts) : null, opts.tiles ? opts.tiles : null];
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(tag, props, [opts.before, content, opts.after]);
};
...
var vars$11 = {
    ...
    size_factor: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_menu,
    border_radius: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_block_border_radius,

    color_light_background: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_background),
    color_dark_background: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_background)
};
...
var createStyles$23 = function createStyles(config) {
    return [{
        ...
        mixin.vendorize({
            ...
            'transition-property': 'opacity'
        }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_transition), config.sizes.map(function (size) {
            return widthStyle(config, size);
        }), _defineProperty$12({
            'z-index': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].z_menu,
            opacity: 0,
            position: 'absolute',
            width: '100%',
            'min-width': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_menu * config.min_size + 'px',
        ...
        }, '@media (max-width: ' + __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_screen_size_large + 'px)', {
            'max-width': config.max_size_small_screen * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_menu + 'px'
        })]
...
var configFn$13 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].menu;
var config$13 = configFn$13 ? configFn$13(vars$11) : vars$11;
var id$14 = 'pe-menu';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$14, layout$15(config$13), color$9(config$13));
...
var hide$2 = function hide(ctrl, opts) {
    ...
    return transition$1.hide(_extends$14({}, opts, {
        ...
        __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.redraw(); // removes remainder of drawn component
    });
};
...
var createView$15 = function createView(ctrl) {
    ...
    }, [__WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$2, {
        z: ctrl.z,
        animated: true
    }), opts.content ? opts.content : null]);
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(tag, props, [opts.before, content, opts.after]);
...
var component$20 = {
    ...
    view: function view(ctrl) {
        ...
        if (ctrl.visible) {
            ...
            return __WEBPACK_IMPORTED_MODULE_2_mithril___default()('span', { class: CSS_CLASSES$15.placeholder });
        }
    }
};
...
var createView$16 = function createView(ctrl) {
    ...
    var props = {
        ...
        config: function config(el, inited, context, vdom) {
            ...
            ctrl.containerEl = __WEBPACK_IMPORTED_MODULE_0_polythene_core__["a" /* isClient */] ? document.querySelector(opts.containerSelector || '.pe-notification__holder') : null;
            show$3(ctrl, opts);
        },
        onclick: function onclick(e) {
            e.preventDefault();
    ...
    }, [title ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
        class: CSS_CLASSES$16.title,
        config: titleConfig
    }, title) : null, opts.action ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
...
var vars$12 = {
    ...
    color_light_background: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_background, .85),
    color_light_text: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_dark_primary),

    color_dark_background: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_background),
    color_dark_text: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_primary)
};

var createStyles$25 = function createStyles(config) {
    return [{
        '.pe-notification__holder': [mixin.fit(), flex$1.layoutCenterCenter, {
            'z-index': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].z_notification
        }],
...
var configFn$14 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].notification;
var config$14 = configFn$14 ? configFn$14(vars$12) : vars$12;
var id$15 = 'pe-notification-notification';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$15, layout$16(config$14), color$10(config$14));
...
var configFn$15 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"]['radio-button'];
var config$15 = configFn$15 ? configFn$15(selectionControlConfig) : selectionControlConfig;
var id$16 = 'pe-radio-button';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$16, layout$17(config$15), color$11(config$15));

// default icons
var iconOff$1 = __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.trust('<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></svg>');
var iconOn$1 = __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.trust('<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 7c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zm0-5C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></svg>');
...
var rgba$7 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba;
...
var vars$14 = {
    ...
    input_focus_border_animation_duration: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].animation_duration,
    ...
    color_light_input_text: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_primary),
    color_light_input_background: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_background), // only used to 'remove' autofill color
    color_light_highlight_text: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_primary),
    color_light_input_bottom_border: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_border_light),
    color_light_input_error_text: rgba$7('221, 44, 0'),
    color_light_input_error_border: rgba$7('221, 44, 0'),
    color_light_input_placeholder: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_tertiary),
    color_light_label_text: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_tertiary),
    color_light_disabled_label_text: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_disabled),
    color_light_readonly_label_text: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_tertiary),
    color_light_help_text: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_tertiary),
    color_light_required_symbol: rgba$7('221, 44, 0'),
    color_light_focus_border: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary),
    color_light_counter_ok_border: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary),

    color_dark_input_text: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_primary),
    color_dark_input_background: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_background), // only used to 'remove' autofill color
    color_dark_highlight_text: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_primary),
    color_dark_input_bottom_border: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_border_light),
    color_dark_input_error_text: rgba$7('222, 50, 38'),
    color_dark_input_error_border: rgba$7('222, 50, 38'),
    color_dark_input_placeholder: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_tertiary),
    color_dark_label_text: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_tertiary),
    color_dark_disabled_label_text: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_disabled),
    color_dark_readonly_label_text: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_tertiary),
    color_dark_help_text: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_tertiary),
    color_dark_required_symbol: rgba$7('221, 44, 0'),
    color_dark_focus_border: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary),
    color_dark_counter_ok_border: rgba$7(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary)
};
...
var createStyles$28 = function createStyles(config) {
    return [{
        '.pe-textfield': [mixin.clearfix(), {
            position: 'relative',
            'line-height': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].line_height,
            display: 'inline-block',
            'box-sizing': 'border-box',
            margin: 0,
            ...
            ' .pe-textfield__error, .pe-textfield__error-placeholder, .pe-textfield__help, .pe-textfield__counter': {
                ...
                'line-height': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].line_height,
                'min-height': config.font_size_error * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].line_height + 'px'
            },
...
var configFn$16 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].textfield;
var config$16 = configFn$16 ? configFn$16(vars$14) : vars$14;
var id$17 = 'pe-textfield';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$17, layout$18(config$16), color$12(config$16));
...
var startEventType = __WEBPACK_IMPORTED_MODULE_0_polythene_core__["a" /* isClient */] ? window.PointerEvent ? 'pointerdown' : 'ontouchstart' in window || window.DocumentTouch && document instanceof window.DocumentTouch ? 'touchstart' : 'mousedown' : 'mousedown';
...
var createView$19 = function createView(ctrl) {
    ...
    var content = [__WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
    ...
    }, [opts.label ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('label', _defineProperty$15({
    ...
    }), opts.label) : null, __WEBPACK_IMPORTED_MODULE_2_mithril___default()(inputTag, _extends$17({}, {
        ...
        onkeydown: function onkeydown(e) {
            if (e.which === 13) {
                ...
                setTimeout(function () {
                    __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.redraw();
                    setTimeout(__WEBPACK_IMPORTED_MODULE_2_mithril___default.a.redraw, 250);
                }, 1);
            }
        }
    } : null, {
    ...
    opts.readonly !== undefined ? { readonly: true } : null, opts.pattern !== undefined ? { pattern: opts.pattern } : null, opts.maxlength !== undefined ? { maxlength: opts.maxlength } : null, opts.minlength !== undefined ? { minlength: opts.minlength } : null, opts.max !== undefined ? { max: opts.max } : null, opts.min !== undefined ? { min: opts.min } : null, opts.autofocus !== undefined ? { autofocus: opts.autofocus } : null, opts.required !== undefined ? { required: opts.required } : null, opts.tabindex !== undefined ? { tabindex: opts.tabindex } : null, opts.rows !== undefined ? { rows: opts.rows } : null))]), opts.counter ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$18.counter }, ctrl.value.length + ' / ' + opts.counter) : null, opts.help && !showError ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
        class: [CSS_CLASSES$18.help, opts.focusHelp ? CSS_CLASSES$18.focusHelp : ''].join(' ')
    }, opts.help) : null, showError ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$18.error }, ctrl.error) : validates && !opts.help ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$18.errorPlaceholder }) : null];
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(tag, props, [opts.before, content, opts.after]);
};
...
var component$27 = {
    controller: function controller() {
        ...
        error = opts.error || '',
            el = void 0,
            inputEl = __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.prop(),
...
var rgba$8 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba;
...
var inset_border_radius = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_block_border_radius;
...
var vars$15 = {
    ...
    color_light_label_text: rgba$8(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_disabled),
    color_light_background: rgba$8(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_background),

    color_dark_label_text: rgba$8(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_disabled),
    color_dark_background: rgba$8(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_background)
};
...
var createStyles$30 = function createStyles(config) {
    ...
    var fullwidth_input_indent = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_indent - config.fullwidth_side_padding - __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_icon_button;
...
var configFn$17 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].search;
var config$17 = configFn$17 ? configFn$17(vars$15) : vars$15;
var id$18 = 'pe-search';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$18, layout$19(config$17), color$13(config$17));
...
var createView$18 = function createView(ctrl) {
    ...
    }, [__WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$27, _extends$16({}, textfieldOpts, {
        config: function config() {
            __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.redraw.strategy('none');
        },
...
var component$25 = {
    controller: function controller() {
        var state = __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.prop();
        return {
            state: state
        };
    },
...
var rgba$9 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba;
var lightForeground = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground;
var darkForeground = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground;
var activeColor$1 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary; // or override in CSS by setting 'color' property on '.pe-slider'
...
var vars$16 = {
    ...
    color_light_icon: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_secondary),
    color_light_disabled_icon: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_disabled),
    color_light_label: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_secondary),
    color_light_disabled_label: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_disabled),
    ...
    color_dark_icon: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_secondary),
    color_dark_disabled_icon: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_disabled),
    color_dark_label: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_secondary),
    color_dark_disabled_label: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_disabled)
};
    ...
    return [{
        '.pe-slider': [mixin.vendorize({
            ...
            ' .pe-slider__label': {
                ...
                'min-width': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size + 'px',
                'text-align': 'center',
                'font-size': '16px',
                'font-weight': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].font_weight_medium
            },
            ...
            }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_transform), mixin.defaultTransition('transform', '.11s'), {
                position: 'absolute',
                'z-index': 1,
...
var configFn$18 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].slider;
var config$18 = configFn$18 ? configFn$18(vars$16) : vars$16;
var id$19 = 'pe-slider';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$19, layout$20(config$18), color$14(config$18));
...
var eventMoveType = __WEBPACK_IMPORTED_MODULE_0_polythene_core__["a" /* isClient */] ? window.PointerEvent ? 'pointermove' : 'ontouchmove' in window || window.DocumentTouch && document instanceof window.DocumentTouch ? 'touchmove' : 'mousemove' : 'mousemove';
var eventEndType = __WEBPACK_IMPORTED_MODULE_0_polythene_core__["a" /* isClient */] ? window.PointerEvent ? 'pointerup' : 'ontouchend' in window || window.DocumentTouch && document instanceof window.DocumentTouch ? 'touchend' : 'mouseup' : 'mouseup';
...
var generateTickMarks = function generateTickMarks(min, max, stepSize) {
    ...
    var s = steps + 1;
    while (s > 0) {
        items.push(__WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$19.tick }));
        s--;
    }
    return items;
};
...
var createSlider = function createSlider(ctrl) {
    ...
    return [__WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', _extends$18({}, {
    ...
    } : null), [__WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
    ...
    }, __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$19.trackBar }, __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$19.trackBarValue }))), __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', _extends$18({}, {
        ...
        step: stepCount
    } : null), opts.icon ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$19.thumb }, opts.icon) : null), __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
    ...
    }, __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$19.trackBar }, __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$19.trackBarValue }))), hasTicks && !opts.disabled ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$19.ticks }, generateTickMarks(ctrl.min, ctrl.max, stepCount)) : null, hasTicks && opts.pin && !opts.disabled ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
...
var vars$17 = {
    ...
    color_light_background: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_background),
    color_light_text: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_dark_primary),
...
var tabletStyle = function tabletStyle(config) {
    return {
        ...
        'border-top-left-radius': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_block_border_radius + 'px',
        'border-top-right-radius': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_block_border_radius + 'px',
...
var createStyles$34 = function createStyles(config) {
    return [_defineProperty$19({}, '@media (min-width: ' + __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].breakpoint_small_handset_landscape + 'px)', {
...
var configFn$19 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].snackbar;
var config$19 = configFn$19 ? configFn$19(vars$17) : vars$17;
var id$20 = 'pe-notification-snackbar';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$20, layout$21(config$19), color$15(config$19));
...
var rgba$10 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba;
...
var defaultConfig = {
    ...
    color_light_raised_background: rgba$10(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_background),
    // also use light background with dark theme
    color_dark_raised_background: rgba$10(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_background)
};
...
var configFn$20 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"]['spinner-default'];
var config$20 = configFn$20 ? configFn$20(defaultConfig) : defaultConfig;
var id$21 = 'pe-spinner-default';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$21, layout$22(config$20), color$16(config$20));
...
var createView$21 = function createView(ctrl) {
    ...
    var content = [opts.raised && opts.content ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$2, {
        z: opts.z
    }) : null, opts.content || __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$21.animation }, 'Specific spinner missing')];
    ...
    view: function view(ctrl) {
        ...
        if (!ctrl.visible) {
            if (opts.hide !== undefined && !opts.hide || opts.show) {
                ...
                if (showDelay) {
                    setTimeout(function () {
                        return ctrl.visible = true, __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.redraw();
                    }, showDelay);
                } else {
                    ctrl.visible = true;
                }
            ...
            if (opts.show !== undefined && !opts.show || opts.hide) {
                ...
                if (hideDelay) {
                    setTimeout(function () {
                        return ctrl.hide = true, __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.redraw();
                    }, hideDelay);
                } else {
                    ctrl.hide = true;
                }
        ...
        if (ctrl.visible) {
            ...
            return __WEBPACK_IMPORTED_MODULE_2_mithril___default()('span', { class: CSS_CLASSES$21.placeholder });
        }
    }
};
...
var vars$18 = {
    ...
    color_light: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground),
    color_dark: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_dark_foreground)
};
...
var createStyles$38 = function createStyles(config) {
    return [{
        '.pe-spinner--ios': [mixin.vendorize({ 'transform': 'translate3d(0,0,0)' }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_transform), positionBlades(config), {
            position: 'relative',
...
var configFn$21 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"]['spinner-ios'];
var config$21 = configFn$21 ? configFn$21(vars$18) : vars$18;
var id$22 = 'pe-spinner-ios';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$22, layout$23(config$21), color$17(config$21));
...
var component$30 = {
    view: function view(ctrl) {
        ...
        for (var i = 0; i < 12; i = i + 1) {
            blades.push(__WEBPACK_IMPORTED_MODULE_2_mithril___default()('div'));
        }
        opts.content = blades;
        opts.class = [CSS_CLASSES$20.block, opts.class].join(' ');
        return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$32, opts);
    }
};
...
var vars$19 = _extends$20({}, defaultConfig, {
    ...
    color_light: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary),
    color_dark: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary)
});
...
var configFn$22 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"]['spinner-determinate'];
var config$22 = configFn$22 ? configFn$22(vars$19) : vars$19;
var id$23 = 'pe-spinner-determinate';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$23, layout$24(config$22), color$18(config$22));
...
var component$33 = {
    view: function view(ctrl) {
        ...
        opts.content = __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
...
var vars$20 = {
    ...
    color_light_single: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary),
    color_light_1: '#42a5f5', // blue 400
    color_light_2: '#f44336', // red 500
    color_light_3: '#fdd835', // yellow 600,
    color_light_4: '#4caf50', // green 500

    color_dark_single: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary),
    ...
    return [{
        '.pe-spinner-indeterminate': {
            ...
            */
            ...
            }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_animation), [1, 2, 3, 4].map(function (num) {
...
var configFn$23 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"]['spinner-indeterminate'];
var config$23 = configFn$23 ? configFn$23(vars$20) : vars$20;
var id$24 = 'pe-spinner-indeterminate';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$24, layout$25(config$23), color$19(config$23));
...
var rgba$11 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba;
var hit_area_padding = (__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_icon_button - __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size) / 2; // 12

var config$25 = _extends$21({}, selectionControlConfig, {
    track_height: 14,
    track_length: 36,
    thumb_size: 20,
    padding: 1 * __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].grid_unit_component,
    icon_button_padding: iconButtonConfig.padding,
    hit_area_padding: hit_area_padding,

    animation_duration: '.18s',

    color_light_thumb_on: rgba$11(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary),
    color_light_thumb_off: '#f1f1f1',
    color_light_thumb_disabled: '#bdbdbd',

    color_light_track_on: rgba$11(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary_faded),
    color_light_track_on_opacity: .55,
    color_light_track_off: rgba$11(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_text_regular),
    color_light_track_off_opacity: .55,
    color_light_track_disabled: rgba$11(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_light_background_disabled),
    color_light_track_disabled_opacity: 1,

    // color_light_focus_on and so on taken from selectionControlConfig

    color_dark_thumb_on: rgba$11(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary), // or '#80cbc4'
    color_dark_thumb_off: '#bdbdbd',
    color_dark_thumb_disabled: '#555',

    color_dark_track_on: rgba$11(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary_faded, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].blend_dark_text_tertiary), // or '#5a7f7c'
...
var customSize = function customSize(config, size) {
    var factor = size / __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size;
...
var createStyles$44 = function createStyles(config) {
    return [createStyles$12(config, '.pe-control--switch', 'checkbox'), {
        '.pe-control--switch': {
            ...
            '&.pe-control--small': customSize(config, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size_small),
            '&.pe-control--regular': customSize(config, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size),
            '&.pe-control--medium': customSize(config, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size_medium),
            '&.pe-control--large': customSize(config, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_icon_size_large)
        }
    }];
};
...
var configFn$24 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].switch;
var config$24 = configFn$24 ? configFn$24(config$25) : config$25;
var id$25 = 'pe-switch';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$25, layout$26(config$24), color$20(config$24));
...
var selectionView = function selectionView(checked, opts) {
    ...
    return [__WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$24.track }), __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$11, {
        ...
        }, [opts.icon ? opts.icon : null, raised ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$2, {
            z: z,
            animated: true
        }) : null])]
    })];
...
var vars$22 = {
    ...
    color_light_selected_text: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary),
    color_light_selected_background: 'transparent',
    color_light_tab_indicator: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary),
    color_light_icon: iconButtonConfig.color_light_flat_normal_text,

    color_dark_selected_text: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary),
    color_dark_selected_background: 'transparent',
    color_dark_tab_indicator: __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].color_primary),
...
var createStyles$46 = function createStyles(config) {
    return [{
        '.pe-tabs': [mixin.vendorize({
            'user-select': 'none'
        }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_user_select), mixin.vendorize({
            transform: 'translate3d(0,0,0)'
        }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_transform), _defineProperty$28({
            '-webkit-overflow-scrolling': 'touch',
            ...
            ' .pe-tabs__tab': [flex$1.flex(), flex$1.flexIndex('none'), mixin.vendorize({
                'user-select': 'none'
            }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].prefixes_user_select), mixin.defaultTransition('color'), {
                margin: 0,
                'border-radius': 0,
            ...
            ' .pe-toolbar--tabs .pe-toolbar__bar &': [mixin.fit(), {
                ...
                ' .pe-tabs__row.pe-tabs__row--indent': {
                    margin: 0,
                    'padding-left': __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].unit_indent + 'px',
                    overflow: 'auto'
                }
            }]

        }, '@media (min-width: ' + __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["appConfig"].breakpoint_small_tablet_portrait + 'px)', {
...
var configFn$25 = __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"] && __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["componentConfig"].tabs;
var config$26 = configFn$25 ? configFn$25(vars$22) : vars$22;
var id$26 = 'pe-tabs';

__WEBPACK_IMPORTED_MODULE_3_polythene_core_css__["styler"].add(id$26, layout$27(config$26), color$21(config$26));

// default icons
var arrowBackward = __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.trust('<svg width="24" height="24" viewBox="0 0 24 24"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/></svg>');
var arrowForward = __WEBPACK_IMPORTED_MODULE_2_mithril___default.a.trust('<svg width="24" height="24" viewBox="0 0 24 24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>');
...
var createScrollButton = function createScrollButton(ctrl, position, opts) {
    ...
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$11, {
...
var createTab = function createTab(ctrl, opts, index, buttonOpts) {
    ...
    var tabButtonOptions = _extends$22({}, buttonOpts, {
        ...
        }, [buttonOpts.icon ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component$5, buttonOpts.icon) : null, buttonOpts.label ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$25.label }, __WEBPACK_IMPORTED_MODULE_2_mithril___default()('span', buttonOpts.label)) : null]),
    ...
    return __WEBPACK_IMPORTED_MODULE_2_mithril___default()(component, tabButtonOptions);
};
...
var createView$23 = function createView(ctrl) {
    ...
    opts.scrollable ? __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', { class: CSS_CLASSES$25.scrollButtonOffset }) : null]);
    ...
    var tabIndicator = opts.hideIndicator ? null : __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
    ...
    var content = [opts.scrollable ? scrollButtonLeft : null, __WEBPACK_IMPORTED_MODULE_2_mithril___default()('div', {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "flex", function() { return mixinFlex; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "styler", function() { return styler; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_polythene_core__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_j2c_plugin_prefix_browser__ = __webpack_require__(188);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_j2c__ = __webpack_require__(189);
...
exports.componentConfig = exports.appConfig = undefined;
...
var _polytheneMotif = __webpack_require__(37);

var appConfig = exports.appConfig = _extends({}, _polytheneMotif.defaultVariables, { color_primary: '33, 150, 245' // new base color: orange 500
});

var componentConfig = exports.componentConfig = {
...
var _arrowBack = __webpack_require__(12);

var _arrowBack2 = _interopRequireDefault(_arrowBack);

var _moreVert = __webpack_require__(14);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_polythene_theme__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__object_assign__ = __webpack_require__(3);
...
var defaultTransition = function defaultTransition() {
    var properties = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'all';
    var duration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].animation_duration;
    var curve = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].animation_curve_default;

    return [vendorize({
        'transition-delay': 0
    }, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].prefixes_transition), vendorize({
        'transition-duration': duration
    }, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].prefixes_transition), vendorize({
        'transition-timing-function': curve
    }, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].prefixes_transition), vendorize({
        'transition-property': properties
    }, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].prefixes_transition)];
};
...
var _dialogReplaceTwo = __webpack_require__(65);
...
var _polytheneCoreCss = __webpack_require__(2);

var _sliderRgbStyle = __webpack_require__(132);

var _sliderRgbStyle2 = _interopRequireDefault(_sliderRgbStyle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-slider-rgb', _sliderRgbStyle2.default);
...
var _tabsMenuStyle = __webpack_require__(149);

var _tabsMenuStyle2 = _interopRequireDefault(_tabsMenuStyle);

var _tabsMenuScreen = __webpack_require__(148);

var _tabsMenuScreen2 = _interopRequireDefault(_tabsMenuScreen);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-tabs-menu', _tabsMenuStyle2.default);
...
var _tabsRoutingStyle = __webpack_require__(150);

var _tabsRoutingStyle2 = _interopRequireDefault(_tabsRoutingStyle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-tabs-routing', _tabsRoutingStyle2.default);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "defaultVariables", function() { return defaultVariables; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_polythene_utilities__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_core_css__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_core__ = __webpack_require__(9);
...
var addRoboto = function addRoboto() {
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_polythene_utilities__["addWebFont"])('google', 'Roboto:400,500,700,400italic:latin'), __WEBPACK_IMPORTED_MODULE_1_polythene_core_css__["styler"].add("pe-roboto", robotoStyles);
};
...
var isDesktop = __WEBPACK_IMPORTED_MODULE_2_polythene_core__["a" /* isClient */] ? window.innerWidth >= 1024 : true;
...
var defaultVariables = {
    ...
    // environment
    env_tablet: __WEBPACK_IMPORTED_MODULE_2_polythene_core__["a" /* isClient */] ? window.innerWidth >= 600 : false,
    env_desktop: __WEBPACK_IMPORTED_MODULE_2_polythene_core__["a" /* isClient */] ? window.innerWidth >= 1024 : true,
...
var addTypography = function addTypography() {
  return __WEBPACK_IMPORTED_MODULE_1_polythene_core_css__["styler"].add("pe-material-design-typography", resetStyles, typographyStyles);
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_core__ = __webpack_require__(9);



var flex$1 = [{
  ".layout, .layout.horizontal": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].layout,
  ".layout.horizontal.inline, .layout.vertical.inline": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].layoutInline,
  ".layout.horizontal": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].layoutHorizontal,
  ".layout.horizontal.reverse": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].layoutHorizontalReverse,
  ".layout.vertical": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].layoutVertical,
  ".layout.vertical.reverse": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].layoutVerticalReverse,
  ".layout.wrap": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].layoutWrap,
  ".layout.wrap.reverse": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].layoutWrapReverse,
  ".flex": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].flex(1),
  ".span.flex": { "display": "block" }, // for IE 10
  ".flex.auto-vertical": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].flexAutoVertical,
  ".flex.auto": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].flexAuto,
  ".flex.none": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].flexIndex("none"),
  ".flex.one": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].flexIndex(1),
  ".flex.two": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].flexIndex(2),
  ".flex.three": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].flexIndex(3),
  ".flex.four": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].flexIndex(4),
  ".flex.five": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].flexIndex(5),
  ".flex.six": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].flexIndex(6),
  ".flex.seven": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].flexIndex(7),
  ".flex.eight": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].flexIndex(8),
  ".flex.nine": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].flexIndex(9),
  ".flex.ten": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].flexIndex(10),
  ".flex.eleven": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].flexIndex(11),
  ".flex.twelve": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].flexIndex(12),

  // alignment in cross axis
  ".layout.start": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].layoutStart,
  ".layout.center, .layout.center-center": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].layoutCenter,
  ".layout.end": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].layoutEnd,

  // alignment in main axis
  ".layout.start-justified": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].layoutStartJustified,
  ".layout.center-justified, .layout.center-center": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].layoutCenterJustified,
  ".layout.end-justified": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].layoutEndJustified,
  ".layout.around-justified": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].layoutAroundJustified,
  ".layout.justified": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].layoutJustified,

  // self alignment
  ".self-start": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].selfStart,
  ".self-center": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].selfCenter,
  ".self-end": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].selfEnd,
  ".self-stretch": __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["flex"].selfStretch
}];
...
var addLayoutStyles = function addLayoutStyles() {
  return __WEBPACK_IMPORTED_MODULE_0_polythene_core_css__["styler"].add("pe-layout", flex$1, commonStyle);
};

if (__WEBPACK_IMPORTED_MODULE_1_polythene_core__["a" /* isClient */] && !window.WebFontConfig) {
...
var addWebFont = function addWebFont(vendor, family, key) {
    if (__WEBPACK_IMPORTED_MODULE_1_polythene_core__["b" /* isServer */]) {
        return;
    }
...
var _polytheneUtilities = __webpack_require__(38);
...
var _github = __webpack_require__(42);
...
var _fab = __webpack_require__(71);

var _fab2 = _interopRequireDefault(_fab);

var _headerPanel = __webpack_require__(91);
...
var _iconButton = __webpack_require__(96);
...
var _listControls = __webpack_require__(106);

var _listControls2 = _interopRequireDefault(_listControls);

var _listTile = __webpack_require__(112);
...
var _ripple = __webpack_require__(126);
...
var _shadow = __webpack_require__(131);
...
var _speedTest = __webpack_require__(138);
...
var _svg = __webpack_require__(142);
...
var _tabsMenu = __webpack_require__(20);

var _tabsMenu2 = _interopRequireDefault(_tabsMenu);

var _tabsRouting = __webpack_require__(21);
...
var _theming = __webpack_require__(154);

var _theming2 = _interopRequireDefault(_theming);

var _toolbar = __webpack_require__(157);

var _toolbar2 = _interopRequireDefault(_toolbar);

var _validation = __webpack_require__(159);

var _validation2 = _interopRequireDefault(_validation);

var _appStyle = __webpack_require__(41);

var _appStyle2 = _interopRequireDefault(_appStyle);

var _arrowRight = __webpack_require__(15);

var _arrowRight2 = _interopRequireDefault(_arrowRight);

var _recycle = __webpack_require__(45);

var _recycle2 = _interopRequireDefault(_recycle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _polytheneUtilities.addLayoutStyles)();
(0, _polytheneMotif.addRoboto)();
(0, _polytheneMotif.addTypography)();
_polytheneCoreCss.styler.add('polythene-examples-app', _appStyle2.default);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src__ = __webpack_require__(39);
...
var _commonVars = __webpack_require__(4);
...
_polytheneCoreCss.styler.add('polythene-examples-github', style);
...
var _navStyle = __webpack_require__(43);
...
_polytheneCoreCss.styler.add('polythene-examples-nav', _navStyle2.default);
...
var _buttonRow = __webpack_require__(46);

var _buttonRow2 = _interopRequireDefault(_buttonRow);

var _polytheneCoreCss = __webpack_require__(2);

var _buttonStyle = __webpack_require__(47);

var _buttonStyle2 = _interopRequireDefault(_buttonStyle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-button', _buttonStyle2.default);
...
var _polytheneTheme = __webpack_require__(5);
...
var styles = [{
    '.module-card': {
        ...
        ' .demo-card': {
            ...
            }, _polytheneTheme.appConfig.prefixes_box_shadow),
            '&.extra-large': {
                width: _commonVars2.default.listWidth + 'px'
            },
            '&.custom': {
...
var _cardStyle = __webpack_require__(49);
...
_polytheneCoreCss.styler.add('polythene-examples-card', _cardStyle2.default);
...
var _checkboxStyle = __webpack_require__(51);
...
_polytheneCoreCss.styler.add('polythene-examples-checkbox', _checkboxStyle2.default);
...
var styles = [{
    '.demo-dialog': {
        ...
        ' .demo-dialog-settingsmenu .pe-list-item': [_mixin2.default.vendorize({
            'user-select': 'none'
        }, _polytheneTheme.appConfig.prefixes_user_select)]
    }
}];
...
*/
_polytheneCoreCss.styler.add('polythene-examples-dialog', _dialogStyle2.default);
...
var _dialogMultiRoutePage = __webpack_require__(61);

var _dialogMultiRoutePage2 = _interopRequireDefault(_dialogMultiRoutePage);

var _dialogMultiRoutePage3 = __webpack_require__(62);
...
var _accountCircle = __webpack_require__(170);
...
var _fabStyle = __webpack_require__(70);
...
_polytheneCoreCss.styler.add('polythene-examples-fab', _fabStyle2.default);
...
var _background1Style = __webpack_require__(73);

var _background1Style2 = _interopRequireDefault(_background1Style);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-header-panel-background-1', _background1Style2.default);
...
var _background2Style = __webpack_require__(75);

var _background2Style2 = _interopRequireDefault(_background2Style);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-header-panel-background-2', _background2Style2.default);
...
var _background3Style = __webpack_require__(77);

var _background3Style2 = _interopRequireDefault(_background3Style);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-header-panel-background-3', _background3Style2.default);
...
var _background4Style = __webpack_require__(79);

var _background4Style2 = _interopRequireDefault(_background4Style);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-header-panel-background-4', _background4Style2.default);
...
var _condenses1Style = __webpack_require__(81);

var _condenses1Style2 = _interopRequireDefault(_condenses1Style);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-header-panel-condenses-1', _condenses1Style2.default);
...
var _keepCondensedStyle = __webpack_require__(85);

var _keepCondensedStyle2 = _interopRequireDefault(_keepCondensedStyle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-header-panel-keep-condensed', _keepCondensedStyle2.default);
...
var styles = [{
    '.kitchensink': {
        ...
        ' .pe-header-panel': {
            ...
            }, _polytheneTheme.appConfig.prefixes_transition), {
                height: '48px',
                'line-height': '48px',
                'font-size': '18px',
                padding: '0 16px',
...
var _kitchensinkStyle = __webpack_require__(87);
...
_polytheneCoreCss.styler.add('polythene-examples-header-panel-kitchensink', _kitchensinkStyle2.default);
...
_polytheneCoreCss.styler.add('polythene-examples-header-panel', _headerPanelStyle2.default);
...
var _mithrilInfinite = __webpack_require__(168);
...
var _infiniteGridStyle = __webpack_require__(92);

var _infiniteGridStyle2 = _interopRequireDefault(_infiniteGridStyle);

var _infiniteStyle = __webpack_require__(93);

var _infiniteStyle2 = _interopRequireDefault(_infiniteStyle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-header-panel-infinite', _infiniteGridStyle2.default, _infiniteStyle2.default);
...
var _iconButtonStyle = __webpack_require__(95);
...
_polytheneCoreCss.styler.add('polythene-examples-icon-button', _iconButtonStyle2.default);
...
var _iconStyle = __webpack_require__(97);
...
_polytheneCoreCss.styler.add('polythene-examples-icon', _iconStyle2.default);
...
var _layoutStyle = __webpack_require__(99);

var _layoutStyle2 = _interopRequireDefault(_layoutStyle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-layout', _layoutStyle2.default);
...
var _checkboxPrimaryStyle = __webpack_require__(101);
...
_polytheneCoreCss.styler.add('polythene-examples-checkbox-primary-list', _checkboxPrimaryStyle2.default);
...
var _checkboxSecondaryStyle = __webpack_require__(103);

var _checkboxSecondaryStyle2 = _interopRequireDefault(_checkboxSecondaryStyle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-checkbox-secondary-list', _checkboxSecondaryStyle2.default);
...
var _sortableList = __webpack_require__(108);

var _sortableList2 = _interopRequireDefault(_sortableList);

var _checkboxPrimary = __webpack_require__(102);

var _checkboxPrimary2 = _interopRequireDefault(_checkboxPrimary);

var _checkboxSecondary = __webpack_require__(104);

var _checkboxSecondary2 = _interopRequireDefault(_checkboxSecondary);

var _switchSecondary = __webpack_require__(110);

var _switchSecondary2 = _interopRequireDefault(_switchSecondary);

var _polytheneCoreCss = __webpack_require__(2);

var _listControlsStyle = __webpack_require__(105);

var _listControlsStyle2 = _interopRequireDefault(_listControlsStyle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-list-controls', _listControlsStyle2.default);
...
var _sortableListStyle = __webpack_require__(107);
...
_polytheneCoreCss.styler.add('polythene-examples-sortable-list', _sortableListStyle2.default);
...
var _switchSecondaryStyle = __webpack_require__(109);

var _switchSecondaryStyle2 = _interopRequireDefault(_switchSecondaryStyle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-switch-secondary-list', _switchSecondaryStyle2.default);
...
var _listTileStyle = __webpack_require__(111);
...
_polytheneCoreCss.styler.add('polythene-examples-list-tile', _listTileStyle2.default);
...
var _formattingList = __webpack_require__(18);

var _formattingList2 = _interopRequireDefault(_formattingList);

var _listStyle = __webpack_require__(113);

var _listStyle2 = _interopRequireDefault(_listStyle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-list', _listStyle2.default);
...
var _dialogSettingsMenu = __webpack_require__(115);

var _dialogSettingsMenu2 = _interopRequireDefault(_dialogSettingsMenu);

var _menuSettings = __webpack_require__(116);
...
var _menuStyle = __webpack_require__(117);

var _menuStyle2 = _interopRequireDefault(_menuStyle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-menu', _menuStyle2.default);
...
var _notificationMessagesStyle = __webpack_require__(119);
...
_polytheneCoreCss.styler.add('polythene-examples-notification-messages', _notificationMessagesStyle2.default);
...
var _notificationSimple = __webpack_require__(121);

var _notificationSimple2 = _interopRequireDefault(_notificationSimple);

var _notificationMessages = __webpack_require__(120);
...
var _radioButtonStyle = __webpack_require__(123);
...
_polytheneCoreCss.styler.add('polythene-examples-radio-button', _radioButtonStyle2.default);
...
var _rippleStyle = __webpack_require__(125);
...
_polytheneCoreCss.styler.add('polythene-examples-ripple', _rippleStyle2.default);
...
var _searchField = __webpack_require__(127);

var _searchField2 = _interopRequireDefault(_searchField);

var _searchStyle = __webpack_require__(128);
...
_polytheneCoreCss.styler.add('polythene-examples-search', _searchStyle2.default);
...
var _shadowStyle = __webpack_require__(130);

var _shadowStyle2 = _interopRequireDefault(_shadowStyle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-shadow', _shadowStyle2.default);
...
var styles = [{
    ' .rgb-slider': {
        ' .field': {
            width: labelWidth + trackWidth + 2 * _config2.default.horizontal_layout_side_spacing + inputWidth + 'px',
            height: '100px',
            'margin-bottom': '10px'
        },
        ' .pe-header': {
            'font-size': '14px',
            color: _polytheneTheme.appConfig.rgba(_polytheneTheme.appConfig.color_light_foreground, _polytheneTheme.appConfig.blend_light_text_secondary)
        },
        ' .pe-slider': {
            color: '#009688',
...
var styles = [{
    '.module-slider': {
        ...
        ' .pe-dark-theme.icons': {
            ' .pe-header': {
                color: _polytheneTheme.appConfig.rgba(_polytheneTheme.appConfig.color_dark_foreground, _polytheneTheme.appConfig.blend_dark_text_secondary)
            }
        }
    }
}];
...
var _sliderVolumeStyle = __webpack_require__(134);
...
var _alarm = __webpack_require__(171);
...
_polytheneCoreCss.styler.add('polythene-examples-slider-volume', _sliderVolumeStyle2.default);
...
_polytheneCoreCss.styler.add('polythene-examples-slider', _sliderStyle2.default);
...
var _speedTestStyle = __webpack_require__(137);
...
_polytheneCoreCss.styler.add('polythene-examples-speed-test', _speedTestStyle2.default);
...
var _spinnerStyle = __webpack_require__(139);

var _spinnerStyle2 = _interopRequireDefault(_spinnerStyle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-spinner', _spinnerStyle2.default);
...
var _svgStyle = __webpack_require__(141);
...
_polytheneCoreCss.styler.add('polythene-examples-svg', _svgStyle2.default);
...
var _switchStyle = __webpack_require__(143);
...
_polytheneCoreCss.styler.add('polythene-examples-switch', _switchStyle2.default);
...
var _tabsKitchensinkStyle = __webpack_require__(146);
...
_polytheneCoreCss.styler.add('polythene-examples-tabs', _tabsKitchensinkStyle2.default);
...
var _tabsKitchensink = __webpack_require__(147);
...
var _tabsEvents = __webpack_require__(145);
...
var _textfieldStyle = __webpack_require__(152);

var _textfieldStyle2 = _interopRequireDefault(_textfieldStyle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-textfield', _textfieldStyle2.default);
...
var _primaryButton = __webpack_require__(155);
...
_polytheneCoreCss.styler.add('my-button-primary', (0, _layout2.default)(newConfig), (0, _color2.default)(newConfig));
...
var _toolbarStyle = __webpack_require__(156);
...
var _favorite = __webpack_require__(172);
...
_polytheneCoreCss.styler.add('polythene-examples-toolbar', _toolbarStyle2.default);
...
var _validationStyle = __webpack_require__(158);

var _validationStyle2 = _interopRequireDefault(_validationStyle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_polytheneCoreCss.styler.add('polythene-examples-validation', _validationStyle2.default);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_mixin__ = __webpack_require__(8);
function _defineProperty(obj, key, value) {
    if (key in obj) {
        Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });
    } else {
...
var rgba = __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].rgba;

var touch_height = __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].unit_touch_height;
var height = 36;

/* harmony default export */ __webpack_exports__["default"] = ({
    margin_h: __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].grid_unit,
    border_radius: __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].unit_item_border_radius,
    font_size: 14,
    font_weight: 500,
    outer_padding_v: (touch_height - height) / 2,
    padding_h: 2 * __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].grid_unit,
    padding_v: 11,
    min_width: 8 * __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].grid_unit_component,
    text_transform: 'uppercase',
    border_width: 0, // no border in MD, but used to correctly set the height when a theme does set a border

    color_light_flat_normal_background: 'transparent',
    color_light_flat_normal_text: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_light_text_primary),
    color_light_flat_hover_background: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_light_background_hover),
    color_light_flat_focus_background: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_light_background_hover),
    color_light_flat_active_background: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_light_background_active),
    color_light_flat_disabled_background: 'transparent',
    color_light_flat_disabled_text: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_light_text_disabled),
    ...
    color_light_raised_normal_background: '#E0E0E0',
    color_light_raised_normal_text: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_light_text_primary),
    color_light_raised_hover_background: 'transparent',
    color_light_raised_focus_background: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_light_background_hover),
    color_light_raised_active_background: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_light_background_hover), // same as hover
    color_light_raised_disabled_background: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_light_background_disabled),
    color_light_raised_disabled_text: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_light_text_disabled),

    color_dark_flat_normal_background: 'transparent',
    color_dark_flat_normal_text: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_dark_text_primary),
    color_dark_flat_hover_background: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_dark_background_hover),
    color_dark_flat_focus_background: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_dark_background_hover),
    color_dark_flat_active_background: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_dark_background_active),
    color_dark_flat_disabled_background: 'transparent',
    color_dark_flat_disabled_text: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_dark_text_disabled),
    ...
    color_dark_raised_normal_background: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_primary),
    color_dark_raised_normal_text: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_dark_text_primary),
    color_dark_raised_hover_background: __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_primary_active,
    color_dark_raised_focus_background: __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_primary_active,
    color_dark_raised_active_background: __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_primary_dark,
    color_dark_raised_disabled_background: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_dark_background_disabled),
    color_dark_raised_disabled_text: rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_dark_text_disabled)
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_fastclick__ = __webpack_require__(190);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_core__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__polythene_polythene__ = __webpack_require__(165);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__events__ = __webpack_require__(163);





var layer = __WEBPACK_IMPORTED_MODULE_1_polythene_core__["a" /* isClient */] ? document.body : { body: {} };
...
var init = function init() {
    if (__WEBPACK_IMPORTED_MODULE_2__polythene_polythene__["a" /* default */].isTouch) {
        __WEBPACK_IMPORTED_MODULE_3__events__["a" /* default */].subscribe('scroll', handleScroll, throttleDelay);
        add();
    }
};
...
var rgba = __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].rgba;
var lightForeground = __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_light_foreground;
var darkForeground = __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_dark_foreground;
var activeColor = __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_primary; // or override in CSS by setting 'color' property on '.pe-slider'
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    thumb_border_width: thumb_border_width,
    active_thumb_scale: active_thumb_scale,
    animation_duration: __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].animation_duration,
    disabled_thumb_scale: disabled_thumb_scale,
    active_pin_thumb_scale: active_pin_thumb_scale,
    ...
    color_light_icon: __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_light_text_secondary),
    color_light_disabled_icon: __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_light_text_disabled),
    color_light_label: __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_light_text_secondary),
    color_light_disabled_label: __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_light_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_light_text_disabled),
    ...
    color_dark_icon: __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_dark_text_secondary),
    color_dark_disabled_icon: __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_dark_text_disabled),
    color_dark_label: __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_dark_text_secondary),
    color_dark_disabled_label: __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].rgba(__WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].color_dark_foreground, __WEBPACK_IMPORTED_MODULE_0_polythene_theme__["appConfig"].blend_dark_text_disabled)
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_verge__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_verge___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_verge__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_j2c__ = __webpack_require__(167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_j2c___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_j2c__);
