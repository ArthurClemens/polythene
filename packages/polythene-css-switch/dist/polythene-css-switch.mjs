...
import { layout, vars } from 'polythene-css-selection-control';
...
var createSize = function createSize(selector, vars$$1) {
  var sizeData = {
    small: getSizeData(vars$$1, vars$1.unit_icon_size_small),
    regular: getSizeData(vars$$1, vars$1.unit_icon_size),
    medium: getSizeData(vars$$1, vars$1.unit_icon_size_medium),
    large: getSizeData(vars$$1, vars$1.unit_icon_size_large)
  };
  return [sel(selector, {
...
var vars$3 = {
  ...
  hit_area_padding: (vars$1.grid_unit_icon_button - vars$1.unit_icon_size) / 2, // 12
  icon_button_padding: vars$2.padding,
  padding: vars$1.grid_unit_component,
  thumb_size: 20,
  track_height: 14,
  track_length: 36,
  label_height: vars.label_height,
