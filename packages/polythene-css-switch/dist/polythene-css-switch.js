(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('polythene-theme'), require('polythene-css-selection-control'), require('polythene-css-icon-button'), require('polythene-core-css')) :
  typeof define === 'function' && define.amd ? define(['exports', 'polythene-theme', 'polythene-css-selection-control', 'polythene-css-icon-button', 'polythene-core-css'], factory) :
  (factory((global.polythene = {}),global['polythene-theme'],global['polythene-css-selection-control'],global['polythene-css-icon-button'],global['polythene-core-css']));
}(this, (function (exports,polytheneTheme,polytheneCssSelectionControl,polytheneCssIconButton,polytheneCoreCss) { 'use strict';
  ...
  var vars = _extends({}, polytheneCssSelectionControl.vars, {
    general_styles: true,
