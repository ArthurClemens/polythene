(function (global, factory) {
  ...
  const onMount = vnode => {
    ...
    state.cleanUp = () => (polytheneCore.unsubscribe("resize", redraw), polytheneCore.unsubscribe("webfontloader", handleFontEvent)); // A promise can't resolve during the oncreate loop
