...
var vars$1 = {
  ...
  color_light_hover_text: rgba(vars.color_light_foreground, vars.blend_light_text_primary),
  ...
  color_dark_hover_text: rgba(vars.color_dark_foreground, vars.blend_dark_text_primary),
