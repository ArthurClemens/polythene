(function (global, factory) {
  ...
  var genericTests = (function (_ref) {
    ...
    polytheneCss.DialogPaneCSS.addStyle(".dialog-pane-tests-blue-dialog", {
      color_light_background: "#2196F3",
      color_light_body_text: "#fff"
    });

    polytheneCss.ToolbarCSS.addStyle(".tests-dialog-pane-themed-toolbar", {
    ...
    return [{
      ...
      attrs: {
        ...
        body: renderer.trust(longText),
        footerButtons: cancelOkButtons({ renderer: renderer, Button: Button })
      }
    }, {
      ...
      component: {
        oninit: function oninit(vnode) {
          ...
          _extends(vnode.state, {
            file: file,
            redrawOnUpdate: stream$1.merge([file]) // for React
          });
        },
        view: function view(vnode) {
          return h(DialogPane, form({ renderer: renderer, keys: keys, Button: Button, file: vnode.state.file }));
        }
      }
    }];
  });
  ...
  var testsMithril = [].concat(genericTests({ DialogPane: polytheneMithril.DialogPane, Toolbar: polytheneMithril.Toolbar, ToolbarTitle: polytheneMithril.ToolbarTitle, Button: polytheneMithril.Button, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys })).concat(mithrilTests({ DialogPane: polytheneMithril.DialogPane, Toolbar: polytheneMithril.Toolbar, ToolbarTitle: polytheneMithril.ToolbarTitle, Button: polytheneMithril.Button, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys }));
  ...
  */
  ...
  var reactTests = function reactTests() {
    ...
    var cancelOkButtons$$1 = [react.createElement(polytheneReact.Button, { label: "Cancel", key: "cancel" }), react.createElement(polytheneReact.Button, { label: "Save", key: "save" })];
    ...
    return [{
      ...
      component: function component() {
        return react.createElement(polytheneReact.DialogPane, {
          title: "Long dialog with a very long title that surely won't fit here",
          body: polytheneReact.renderer.trust(longText),
  ...
  var testsReact = [].concat(genericTests({ DialogPane: polytheneReact.DialogPane, Toolbar: polytheneReact.Toolbar, ToolbarTitle: polytheneReact.ToolbarTitle, Button: polytheneReact.Button, renderer: polytheneReact.renderer, keys: polytheneReact.keys })).concat(reactTests({ DialogPane: polytheneReact.DialogPane, Toolbar: polytheneReact.Toolbar, ToolbarTitle: polytheneReact.ToolbarTitle, Button: polytheneReact.Button, renderer: polytheneReact.renderer, keys: polytheneReact.keys }));
...
//# sourceMappingURL=test-dialog-pane.js.map
