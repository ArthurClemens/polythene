...
import { Button, classes, filterSupportedAttributes, isTouch, subscribe, unsubscribe } from 'polythene-core';
...
var view$1 = function view(vnode) {
  ...
  var tabButtonOptions = _extends$2({}, attrs, {
    content: m("div", { className: classes$1.tabContent }, [attrs.icon ? m(Icon, attrs.icon) : null, attrs.label ? m("div", { className: classes$1.label }, m("span", attrs.label)) : null]),
    className: [classes$1.tab, attrs.icon && attrs.label ? classes$1.tabHasIcon : null, attrs.class].join(" "),
...
var view$2 = function view(vnode) {
  ...
  return m(IconButton, {
    className: [classes$1.scrollButton, attrs.class].join(" "),
    icon: icon,
    ripple: { center: true },
    events: attrs.events,
    oncreate: function oncreate(vnode) {
...
var view = function view(vnode) {
  ...
  m("div", { className: classes$1.scrollButtonOffset })]) : tabRowButtons;
...
export { classes$1 as classes, vars$2 as vars };export default tabs;
