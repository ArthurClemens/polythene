(function (global, factory) {
  ...
  const tintFns = tint => ({
    ["color_" + tint + "_title"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
    ...
    ["color_" + tint + "_list_header"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-list-tile--header": {
        color: vars["color_" + tint + "_list_header"]
      }
    })],
    ["color_" + tint + "_subtitle"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
      " .pe-list-tile__subtitle": {
        color: vars["color_" + tint + "_subtitle"]
      }
    })],
    ["color_" + tint + "_secondary"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
      " .pe-list-tile__secondary": {
        color: vars["color_" + tint + "_secondary"]
      }
    })],
    ["color_" + tint + "_front"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
      " .pe-list-tile__content-front": {
        color: vars["color_" + tint + "_front"]
      }
    })],
    ["color_" + tint + "_text_disabled"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
    ...
    ["color_" + tint + "_highlight_background"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
  ...
  const hoverTintFns = tint => ({
    ...
    ["color_" + tint + "_hover_front"]: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-list-tile--hoverable:not(.pe-list-tile--selected)": {
  ...
  const title_line_count_single_line_height = (selector, vars) => polytheneCoreCss.sel(selector, {
  ...
  const varFns = {
    general_styles: (selector, vars) => [polytheneCoreCss.sel(selector, [alignLeft(vars), polytheneCoreCss.flex.layout, {
      position: "relative",
      ".pe-list-tile--navigation": {
        " .pe-list-tile__title": {
          whiteSpace: "pre-wrap"
      ...
      // RTL
      [polytheneCoreCss.selectorRTL(selector)]: alignRight(vars)
    }],
    title_line_count: (selector, vars) => [title_line_count_single_line_height(selector, vars)],
    single_line_height: (selector, vars) => [title_line_count_single_line_height(selector, vars)],
    font_size_title: (selector, vars) => [polytheneCoreCss.sel(selector, {
      fontSize: vars.font_size_title + "px",
      " .pe-list-tile__secondary": {
        fontSize: vars.font_size_title + "px"
      }
    })],
    font_weight_title: (selector, vars) => [polytheneCoreCss.sel(selector, {
      fontWeight: vars.font_weight_title
    })],
    font_size_navigation_title: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-list-tile--navigation": {
        fontSize: vars.font_size_navigation_title + "px"
      }
    })],
    font_weight_navigation_title: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-list-tile--navigation": {
    ...
    compact_front_item_width: (selector, vars) => [polytheneCoreCss.sel(selector, {
      " .pe-list-tile__content-front": {
    ...
    front_item_width: (selector, vars) => [polytheneCoreCss.sel(selector, {
      " .pe-list-tile__content-front": {
    ...
    font_size_small: (selector, vars) => [polytheneCoreCss.sel(selector, {
      " .pe-list-tile__content": {
        " small": {
    ...
    has_high_subtitle_padding: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-list-tile--high-subtitle": {
        " .pe-list-tile__content": [paddingV(vars.has_high_subtitle_padding, vars.has_high_subtitle_padding + 1)]
      }
    })],
    has_subtitle_padding: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-list-tile--subtitle": {
        " .pe-list-tile__content": [paddingV(vars.has_subtitle_padding, vars.has_subtitle_padding + 1)]
      }
    })],
    single_height: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-list-tile--header": {
    ...
    font_size_list_header: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-list-tile--header": {
        " .pe-list-tile__title": {
    ...
    font_weight_list_header: (selector, vars) => [polytheneCoreCss.sel(selector, {
      ".pe-list-tile--header": {
        " .pe-list-tile__title": {
    ...
    compact_padding: (selector, vars) => [polytheneCoreCss.sel(selector, {
  ...
  var vars = {
    ...
    color_dark_highlight_background: polytheneCoreCss.rgba(polytheneTheme.vars.color_dark_foreground, polytheneTheme.vars.blend_dark_background_hover) // background color may be set in theme; disabled by default
