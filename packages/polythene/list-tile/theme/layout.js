    ...
    return [{
        '.pe-list-tile': [flex.layout, {
            ...
            ' .pe-list-tile__primary': [flex.flex(), {
                ...
                ' .pe-list-tile__content:not(.pe-list-tile__content--front)': [flex.flex(), paddingV(config.padding, config.padding + 1)]
            }],
            ...
            '&.pe-list-tile--high-subtitle': {
                ...
                ' .pe-list-tile__content': [flex.selfStart, paddingV(config.has_high_subtitle_padding, config.has_high_subtitle_padding + 1), {
                    ' .pe-list-tile__title': {
                        padding: 0
                    }
                }]
