...
var activeColor = common.color_primary; // or override in CSS by setting 'color' property on '.pe-checkbox' / '.pe-radio-button'
var rgba = common.rgba;
var label_padding = (common.grid_unit_icon_button - common.unit_icon_size) / 2; // 12
