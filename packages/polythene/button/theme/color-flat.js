...
export default (function (selector, componentVars) {
  return [style([".pe-dark-theme", ".pe-dark-theme "], selector, componentVars, "flat", "dark"), // has/inside dark tone
  style(["", ".pe-light-theme", ".pe-light-theme "], selector, componentVars, "flat", "light"), // normal, has/inside light tone
  noTouchStyle(["html.pe-no-touch .pe-dark-theme "], selector, componentVars, "flat", "dark"), // inside dark tone
  noTouchStyle(["html.pe-no-touch ", "html.pe-no-touch .pe-light-theme "], selector, componentVars, "flat", "light")];
});