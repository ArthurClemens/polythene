...
export default {
  ...
  color_light_flat_background: "transparent",
  color_light_flat_text: rgba(vars.color_light_foreground, vars.blend_light_text_primary),
  ...
  // color_light_flat_border:              "transparent", // only specify this variable to get all 4 states
  ...
  color_dark_flat_background: "transparent",
  color_dark_flat_text: rgba(vars.color_dark_foreground, vars.blend_dark_text_primary),
  ...
  // border colors may be set in theme; disabled by default
  // color_dark_flat_border:               "transparent", // only specify this variable to get all 4 states
  ...
  color_light_raised_background: "#e0e0e0", // grey-300
  color_light_raised_text: rgba(vars.color_light_foreground, vars.blend_light_text_primary),
  ...
  color_dark_raised_background: rgba(vars.color_primary),
  color_dark_raised_text: rgba(vars.color_dark_foreground, vars.blend_dark_text_primary),
