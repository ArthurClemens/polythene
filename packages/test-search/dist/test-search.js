(function (global, factory) {
	...
	var results = (function (_ref) {
	  ...
	  polytheneCss.ListCSS.addStyle(".tests-search-keyboard-color-list", {
	    color_light_background: "#fff"
	  });
	  polytheneCss.ListTileCSS.addStyle(".tests-search-keyboard-color-list-tile", {
	  ...
	  return {
	    oninit: function oninit(vnode) {
	      var searchValue = stream$1(defaultValue);
	      var selectedValue = stream$1();
	      var matches = stream$1();
	      var selectedListIndex = stream$1(-1);
	      ...
	      _extends(vnode.state, {
	        ...
	        redrawOnUpdate: stream$1.merge([searchValue, selectedListIndex]) // for React
	      });
	    },
	    view: function view(vnode) {
	      ...
	      return h(".container", _defineProperty({}, k.onkeydown, state.handleKey), [h(SearchField, _extends({}, {
	        key: "search",
	      ...
	      }, state.selectedValue() ? { value: state.selectedValue() } : null)), matches.length ? h(List, {
	...
	var genericTests = (function (_ref) {
	  ...
	  polytheneCss.SearchCSS.addStyle(".tests-search-themed-search", {
	    color_dark_input_text: "#fff",
	    color_dark_background: "#43a047"
	  });

	  var Results = results({ h: h, k: k, List: List, ListTile: ListTile, SearchField: SearchField });
	  ...
	  return {
	    oninit: function oninit(vnode) {
	      ...
	      _extends$2(vnode.state, {
	        ...
	        clear: clear,
	        leave: leave,
	        redrawOnUpdate: stream$1.merge([value]) // for React
	      });
	    },
	...
	var SearchField = searchField({ renderer: polytheneMithril.renderer, keys: polytheneMithril.keys, Search: polytheneMithril.Search, IconButton: polytheneMithril.IconButton, Button: polytheneMithril.Button, Shadow: polytheneMithril.Shadow });
	...
	var testsMithril = [].concat(genericTests({ Search: polytheneMithril.Search, IconButton: polytheneMithril.IconButton, Button: polytheneMithril.Button, Shadow: polytheneMithril.Shadow, SearchField: SearchField, List: polytheneMithril.List, ListTile: polytheneMithril.ListTile, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys })).concat(mithrilTests({ Search: polytheneMithril.Search, IconButton: polytheneMithril.IconButton, Button: polytheneMithril.Button, Shadow: polytheneMithril.Shadow, SearchField: SearchField, List: polytheneMithril.List, ListTile: polytheneMithril.ListTile, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys }));
	...
	*/
	...
	var iconSearch = polytheneReact.renderer.trust(iconSearchSVG$1);
	var iconBack = polytheneReact.renderer.trust(iconBackSVG$1);
	var iconClear = polytheneReact.renderer.trust(iconClearSVG$1);
	var iconMic = polytheneReact.renderer.trust(iconMicSVG$1);
	...
	var _class = function (_Component) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function render() {
	      ...
	      return polytheneReact.renderer(polytheneReact.Search, _extends$4({}, {
	        textfield: {
	          onChange: function onChange(_ref3) {
	            var value = _ref3.value,
	        ...
	        buttons: {
	          none: {
	            before: polytheneReact.renderer(SearchIcon),
	            after: polytheneReact.renderer(MicIcon)
	          },
	          focus: {
	            before: polytheneReact.renderer(SearchIcon),
	            after: polytheneReact.renderer(MicIcon)
	          ...
	          focus_dirty: {
	            before: polytheneReact.renderer(BackButton, { leave: this.leave }),
	            after: polytheneReact.renderer(ClearButton, { clear: this.clear })
	          },
	          dirty: {
	            before: polytheneReact.renderer(BackButton, { leave: this.leave }),
	            after: polytheneReact.renderer(ClearButton, { clear: this.clear })
	        ...
	        before: polytheneReact.renderer(polytheneReact.Shadow)
	      }, this.props));
	    }
	  }]);
	...
	var _class$1 = function (_Component) {
	  ...
	  _createClass$1(_class, [{
	    ...
	    value: function render() {
	      ...
	      // incoming value added for result list example:
	      var value = this.props.value !== undefined ? this.props.value : this.state.value;
	      return react.createElement(polytheneReact.Search, _extends$5({
	        textfield: {
	          onChange: function onChange(_ref3) {
	            var value = _ref3.value,
	                setInputState = _ref3.setInputState;
	        ...
	        before: react.createElement(polytheneReact.Shadow, null)
	      }, this.props));
	    }
	  }]);
	...
	var testsReact = [].concat(genericTests({ Search: polytheneReact.Search, IconButton: polytheneReact.IconButton, Button: polytheneReact.Button, Shadow: polytheneReact.Shadow, SearchField: _class, List: polytheneReact.List, ListTile: polytheneReact.ListTile, renderer: polytheneReact.renderer, keys: polytheneReact.keys })).concat(reactTests({ Search: polytheneReact.Search, IconButton: polytheneReact.IconButton, Button: polytheneReact.Button, Shadow: polytheneReact.Shadow, SearchField: _class, List: polytheneReact.List, ListTile: polytheneReact.ListTile, renderer: polytheneReact.renderer, keys: polytheneReact.keys }));
