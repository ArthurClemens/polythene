...
import { renderer as renderer$1, Switch as Switch$1, Icon as Icon$1, RaisedButton as RaisedButton$1, keys as keys$1 } from 'polythene-react';
...
var genericTests = (function (_ref) {
  ...
  var sizes = function sizes(_sizes, attrs) {
    return _sizes.map(function (size) {
      return h(Switch$$1, _extends$3({}, attrs, {
        label: size,
        size: size
      }));
    });
