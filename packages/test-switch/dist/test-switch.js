(function (global, factory) {
	...
	var genericTests = (function (_ref) {
	  ...
	  polytheneCss.SwitchCSS.addStyle(".tests-switch-themed-switch", {
	    label_font_size: 28,
	  ...
	  polytheneCss.SwitchCSS.addStyle(".tests-switch-themed-icon", {
	  ...
	  var sizes = function sizes(_sizes, attrs) {
	    return _sizes.map(function (size) {
	      return h(Switch, _extends$3({}, attrs, {
	        label: size,
	        size: size
	      }));
	    });
	  ...
	  return [{
	    ...
	    interactive: true,
	    exclude: true,
	    component: onChange({ h: h, Switch: Switch })
	  }, {
	    name: "Option: events",
	    interactive: true,
	    exclude: true,
	    component: events({ h: h, k: k, Switch: Switch })
	  }, {
	    name: "Setting the checked state",
	    interactive: true,
	    exclude: true,
	    component: toggleButton({ h: h, k: k, RaisedButton: RaisedButton, Switch: Switch })
	  },
	...
	var testsMithril = [].concat(genericTests({ Switch: polytheneMithril.Switch, Icon: polytheneMithril.Icon, RaisedButton: polytheneMithril.RaisedButton, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys })).concat(mithrilTests({ Switch: polytheneMithril.Switch, Icon: polytheneMithril.Icon, RaisedButton: polytheneMithril.RaisedButton, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys }));
	...
	*/
	...
	var testsReact = [].concat(genericTests({ Switch: polytheneReact.Switch, Icon: polytheneReact.Icon, RaisedButton: polytheneReact.RaisedButton, renderer: polytheneReact.renderer, keys: polytheneReact.keys })).concat(reactTests({ Switch: polytheneReact.Switch, Icon: polytheneReact.Icon, RaisedButton: polytheneReact.RaisedButton, renderer: polytheneReact.renderer, keys: polytheneReact.keys }));
...
//# sourceMappingURL=test-switch.js.map
