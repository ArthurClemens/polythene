(function (global, factory) {
  ...
  var genericTests = (function (_ref) {
    ...
    polytheneCss.IconButtonCSS.addStyle(".tests-icon-button-themed-icon-button", {
      padding: 24,
    ...
    var FavIcon = h(Icon, null, h(SVG, null, trustedIconFavorite));
  ...
  var testsMithril = [].concat(genericTests({ IconButton: polytheneMithril.IconButton, Icon: polytheneMithril.Icon, SVG: polytheneMithril.SVG, renderer: polytheneMithril.renderer })).concat(mithrilTests({ IconButton: polytheneMithril.IconButton, SVG: polytheneMithril.SVG, renderer: polytheneMithril.renderer }));
  ...
  */
  ...
  var reactTests = function reactTests(_ref) {
    ...
    return [{
      ...
      component: function component() {
        return react.createElement(IconButton, { icon: { svg: { content: iconFavoriteSVG } } });
      }
    }, {
  ...
  var testsReact = [].concat(genericTests({ IconButton: polytheneReact.IconButton, Icon: polytheneReact.Icon, SVG: polytheneReact.SVG, renderer: polytheneReact.renderer })).concat(reactTests({ IconButton: polytheneReact.IconButton, Icon: polytheneReact.Icon, SVG: polytheneReact.SVG, renderer: polytheneReact.renderer }));
...
//# sourceMappingURL=test-icon-button.js.map
