(function (global, factory) {
	...
	var onChange = (function (_ref) {
	  ...
	  return {
	    oninit: function oninit(vnode) {
	      var checkedValue = stream$1();
	      _extends(vnode.state, {
	        checkedValue: checkedValue,
	        redrawOnUpdate: stream$1.merge([checkedValue]) // for React
	      });
	    },
	    view: function view(vnode) {
	      ...
	      }, "Value: " + (checkedValue === undefined ? "Not set" : checkedValue)), h(RadioGroup, {
	        name: "onChange",
	...
	var events = (function (_ref) {
	  ...
	  return {
	    ...
	    view: function view(vnode) {
	      ...
	      }, "Value: " + (checkedValue === undefined ? "Not set" : checkedValue)), h(".multiple", [h(RadioButton, {
	        key: "one", // for React
	        name: "events",
	        value: "One",
	        label: "One",
	...
	var genericTests = (function (_ref) {
	  ...
	  polytheneCss.RadioButtonCSS.addStyle(".tests-radio-button-themed-radio", {
	    label_font_size: 28,
	  ...
	  var RadioGroup = {
	    view: function view(_ref2) {
	      ...
	      return h(PeRadioGroup, _extends$2({}, { className: "multiple" }, attrs));
	    }
	  };
	  ...
	  return [{
	    ...
	    interactive: true,
	    component: onChange({ h: h, RadioGroup: RadioGroup })
	  }, {
	    name: "Option: events",
	    interactive: true,
	    exclude: true,
	    component: events({ h: h, k: k, RadioButton: RadioButton })
	  },
	...
	var testsMithril = [].concat(genericTests({ RadioButton: polytheneMithril.RadioButton, RadioGroup: polytheneMithril.RadioGroup, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys })).concat(mithrilTests({ RadioButton: polytheneMithril.RadioButton, RadioGroup: polytheneMithril.RadioGroup, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys }));
	...
	*/
	...
	var reactTests = function reactTests(_ref) {
	  var RadioButton = _ref.RadioButton,
	      h = _ref.renderer;
	  ...
	  return [{
	    ...
	    component: function component() {
	      return react.createElement(polytheneReact.RadioGroup, { buttons: [{
	          value: "One",
	          label: "One"
	        }, {
	          value: "Two",
	...
	var testsReact = [].concat(genericTests({ RadioButton: polytheneReact.RadioButton, RadioGroup: polytheneReact.RadioGroup, renderer: polytheneReact.renderer, keys: polytheneReact.keys })).concat(reactTests({ RadioButton: polytheneReact.RadioButton, RadioGroup: polytheneReact.RadioGroup, renderer: polytheneReact.renderer, keys: polytheneReact.keys }));
...
//# sourceMappingURL=test-radio-button.js.map
