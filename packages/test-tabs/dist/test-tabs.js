(function (global, factory) {
	  ...
	  return {
	    oninit: function oninit(vnode) {
	      ...
	      _extends(vnode.state, {
	        tab: tab,
	        redrawOnUpdate: stream$1.merge([tab]) // for React
	      });
	    },
	    view: function view(vnode) {
	      ...
	      }, [h("li", { key: "index" }, "" + tab.index), h("li", { key: "options" }, "" + JSON.stringify(tab.options))]), h(Tabs, {
	        tabs: threeButtons,
	        autofit: true,
	...
	var genericTests = (function (_ref) {
	  ...
	  var OnChange = onChange({ h: h, Tabs: Tabs });

	  polytheneCss.TabsCSS.addStyle(".tests-tabs-fixed-width", {
	    tab_max_width: 110,
	    tab_min_width: 110
	  });

	  polytheneCss.TabsCSS.addStyle(".tests-tabs-custom_color", {
	    color_light: "#00BCD4",
	  ...
	  polytheneCss.TabsCSS.addStyle(".tests-tabs-no-indicators", {
	    color_light: "#333",
	...
	var testsMithril = [].concat(genericTests({ Tabs: polytheneMithril.Tabs, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys })).concat(mithrilTests({ Tabs: polytheneMithril.Tabs, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys }));
	...
	*/
	...
	var ScrollableTabs = (function () {
	  return react.createElement(
	    ...
	    react.createElement(polytheneReact.Tabs, {
	      scrollable: true,
	...
	var testsReact = [].concat(genericTests({ Tabs: polytheneReact.Tabs, renderer: polytheneReact.renderer, keys: polytheneReact.keys })).concat(reactTests({ Tabs: polytheneReact.Tabs, renderer: polytheneReact.renderer, keys: polytheneReact.keys }));
...
//# sourceMappingURL=test-tabs.js.map
