...
const rgba = cfg.rgba;
const lightForeground = cfg.color_light_foreground;
const darkForeground = cfg.color_dark_foreground;
const activeColor = cfg.color_primary; // or override in CSS by setting 'color' property on '.pe-slider'
