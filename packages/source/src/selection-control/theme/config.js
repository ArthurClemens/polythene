...
const activeColor = cfg.color_primary; // or override in CSS by setting 'color' property on '.pe-checkbox' / '.pe-radio-button'
const rgba = cfg.rgba;
const label_padding = (cfg.grid_unit_icon_button - cfg.unit_icon_size) / 2; // 12
