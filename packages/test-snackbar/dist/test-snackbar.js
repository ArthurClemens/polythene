(function (global, factory) {
  ...
  var genericTests = (function (_ref) {
    ...
    polytheneCss.SnackbarCSS.addStyle(".notification-tests-blue-notification", {
  ...
  var buttonGroup = {
    view: function view(_ref) {
      ...
      return polytheneMithril.renderer(".pe-button-row", [attrs.variations.map(function (opts) {
        return polytheneMithril.renderer(polytheneMithril.RaisedButton, {
          label: opts.label,
          events: { onclick: function onclick() {
              return polytheneMithril.Snackbar.show(_extends({}, opts, attrs.snackbarOptions, { key: opts.title // add a key to let Mithril better distinguish between the notifications
              }), attrs.spawnOptions);
            } }
        });
      }), polytheneMithril.renderer(polytheneMithril.RaisedButton, {
        label: "Hide",
        disabled: polytheneMithril.Snackbar.count() === 0,
        events: { onclick: function onclick() {
            return polytheneMithril.Snackbar.hide(attrs.spawnOptions);
          } }
      }), polytheneMithril.renderer(polytheneMithril.RaisedButton, {
        label: "Clear",
        disabled: polytheneMithril.Snackbar.count() === 0,
        events: {
          onclick: function onclick() {
            return polytheneMithril.Snackbar.hide(attrs.spawnOptions).then(function () {
              return polytheneMithril.Snackbar.clear();
            });
          }
        }
      })]);
  ...
  var containerSelector = {
    view: function view(vnode) {
      ...
      return polytheneMithril.renderer("div", [polytheneMithril.renderer(attrs.buttonGroup, {
      ...
      }, polytheneMithril.renderer(polytheneMithril.FAB, {
        className: "self-end",
        icon: { svg: { content: polytheneMithril.renderer.trust(iconPlusSVG) } },
        z: 1,
        style: {
          margin: "0 16px 16px 0"
        }
      }), polytheneMithril.renderer(polytheneMithril.Snackbar, { spawn: attrs.spawn, position: attrs.position })))]);
    }
  };
  ...
  var testsMithril = [].concat(genericTests({ Snackbar: polytheneMithril.Snackbar, Dialog: polytheneMithril.Dialog, Button: polytheneMithril.Button, buttonGroup: buttonGroup, containerSelector: containerSelector, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys })).concat(mithrilTests({ Snackbar: polytheneMithril.Snackbar, Dialog: polytheneMithril.Dialog, Button: polytheneMithril.Button, buttonGroup: buttonGroup, containerSelector: containerSelector, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys }));
  ...
  */
  ...
  var _class = function (_Component) {
    ...
    function _class(props) {
      ...
      polytheneCore.subscribe("snackbar", _this.notificationChange);
      return _this;
    }
    ...
    _createClass(_class, [{
      ...
      value: function componentWillUnmount() {
        this._mounted = false;
        polytheneCore.unsubscribe("snackbar", this.notificationChange);
      }
    }, {
      key: "updateCount",
      ...
      value: function notificationChange() {
        this.updateCount(polytheneReact.Snackbar.count());
      }
    }, {
      key: "render",
      value: function render() {
        ...
        return react.createElement(
            ...
            return react.createElement(polytheneReact.RaisedButton, {
              ...
              events: {
                onClick: function onClick() {
                  ...
                  polytheneReact.Snackbar.show(_extends$3({}, opts, snackbarOptions, {
          ...
          react.createElement(polytheneReact.RaisedButton, {
            ...
            events: {
              onClick: function onClick() {
                return polytheneReact.Snackbar.hide({ spawn: spawn, position: position });
              }
            }
          }),
          react.createElement(polytheneReact.RaisedButton, {
            ...
            events: {
              onClick: function onClick() {
                return polytheneReact.Snackbar.hide({ spawn: spawn, position: position }).then(polytheneReact.Snackbar.clear);
              }
            }
          })
        );
        ...
        return react.createElement(
          ...
          react.createElement(
            ...
            react.createElement(
              ...
              react.createElement(polytheneReact.FAB, {
                className: "self-end",
              ...
              react.createElement(polytheneReact.Snackbar, {
                spawn: spawn,
                position: position
              })
            )
  ...
  var testsReact = [].concat(genericTests({ Snackbar: polytheneReact.Snackbar, Dialog: polytheneReact.Dialog, Button: polytheneReact.Button, buttonGroup: _class, containerSelector: _class$1, renderer: polytheneReact.renderer, keys: polytheneReact.keys })).concat(reactTests({ Snackbar: polytheneReact.Snackbar, Dialog: polytheneReact.Dialog, Button: polytheneReact.Button, buttonGroup: _class, containerSelector: _class$1, renderer: polytheneReact.renderer, keys: polytheneReact.keys }));
...
//# sourceMappingURL=test-snackbar.js.map
