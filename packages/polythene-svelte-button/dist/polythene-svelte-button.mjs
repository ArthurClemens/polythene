...
/* Users/arthur/code/Github Projects/Polythene/polythene/master/packages/polythene-svelte-shadow/src/Shadow.svelte generated by Svelte v3.5.1 */
...
/* src/TextLabel.svelte generated by Svelte v3.5.1 */
...
function create_fragment$2(ctx) {
	...
	var if_block0 = (ctx.disabled || ctx._noInk) && create_if_block_3();
	...
	var if_block2 = (ctx.dropdown) && create_if_block$1();
	...
	return {
		...
		p(changed, ctx) {
			...
			set_attributes(a, get_spread_update(a_levels, [
				(changed.domElement) && { ref: ctx.domElement },
				{ href: null },
				(changed.url) && ctx.url,
				(changed.R_classNames) && { class: ctx.R_classNames },
				(changed.style) && { style: ctx.style },
