(function (global, factory) {
  ...
  var genericTests = (function (_ref) {
    ...
    polytheneCss.NotificationCSS.addStyle(".notification-tests-blue-notification", {
  ...
  var buttonGroup = (function (messageOptions, spawnOptions) {
    return {
      view: function view() {
        return polytheneMithril.renderer(".pe-button-row", [polytheneMithril.renderer(polytheneMithril.RaisedButton, {
          label: "Show",
          events: { onclick: function onclick() {
              return polytheneMithril.Notification.show(messageOptions, spawnOptions);
            } }
        }), polytheneMithril.renderer(polytheneMithril.RaisedButton, {
          label: "Hide",
          disabled: polytheneMithril.Notification.count() === 0,
          events: { onclick: function onclick() {
              return polytheneMithril.Notification.hide(spawnOptions);
            } }
        }), polytheneMithril.renderer(polytheneMithril.RaisedButton, {
          label: "Clear",
          disabled: polytheneMithril.Notification.count() === 0,
          events: {
            onclick: function onclick() {
              return polytheneMithril.Notification.hide(spawnOptions).then(function () {
                return polytheneMithril.Notification.clear();
              });
            }
          }
        })]);
  ...
  var containerSelector = (function (buttonGroup) {
    ...
    return {
      view: function view() {
        return polytheneMithril.renderer("div", [polytheneMithril.renderer(Spawn1), polytheneMithril.renderer("#notifs1", {
          style: {
            position: "relative",
            height: "180px"
          }
        }, polytheneMithril.renderer(polytheneMithril.Notification, {
          spawn: "container1",
          position: "container"
        })), polytheneMithril.renderer(Spawn2), polytheneMithril.renderer("#notifs2", {
          style: {
            position: "relative",
            height: "180px"
          }
  ...
  var testsMithril = [].concat(genericTests({ Notification: polytheneMithril.Notification, Dialog: polytheneMithril.Dialog, Button: polytheneMithril.Button, buttonGroup: buttonGroup, containerSelector: containerSelector, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys })).concat(mithrilTests({ Notification: polytheneMithril.Notification, Dialog: polytheneMithril.Dialog, Button: polytheneMithril.Button, buttonGroup: buttonGroup, containerSelector: containerSelector, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys }));
  ...
  */
  ...
  var buttonGroup$1 = (function (messageOptions, spawnOptions) {
    return function (_Component) {
      ...
      function _class(props) {
        ...
        polytheneCore.subscribe("notification", _this.notificationChange);
        return _this;
      }
      ...
      _createClass(_class, [{
        ...
        value: function componentWillUnmount() {
          this._mounted = false;
          polytheneCore.unsubscribe("notification", this.notificationChange);
        }
      }, {
        key: "updateCount",
        ...
        value: function notificationChange() {
          this.updateCount(polytheneReact.Notification.count());
        }
      }, {
        key: "render",
        value: function render() {
          ...
          return react.createElement(
            ...
            react.createElement(polytheneReact.RaisedButton, {
              ...
              events: {
                onClick: function onClick() {
                  return polytheneReact.Notification.show(_extends$1({}, messageOptions, { key: messageOptions.title }), spawnOptions);
                }
              }
            }),
            react.createElement(polytheneReact.RaisedButton, {
              ...
              events: {
                onClick: function onClick() {
                  return polytheneReact.Notification.hide(spawnOptions);
                }
              }
            }),
            react.createElement(polytheneReact.RaisedButton, {
              ...
              events: {
                onClick: function onClick() {
                  return polytheneReact.Notification.hide(spawnOptions).then(polytheneReact.Notification.clear);
                }
              }
            })
          );
        ...
        value: function render() {
          return react.createElement(
            ...
            react.createElement(
              ...
              react.createElement(polytheneReact.Notification, { spawn: "container1", position: "container" })
            ),
            react.createElement(SpawnButtons2, { key: "two" }),
            react.createElement(
              "div",
              { id: "notifs2", style: containerStyle },
              react.createElement(polytheneReact.Notification, { spawn: "container2", position: "container" })
            )
          );
        }
      }]);
    ...
    footerButtons: [react.createElement(polytheneReact.Button, {
      ...
      events: {
        onClick: function onClick() {
          ...
          polytheneReact.Notification.unpause();
        }
      }
      ...
      events: {
        onClick: function onClick() {
          polytheneReact.Dialog.hide();
          polytheneReact.Notification.hide();
        }
      }
    })],
    backdrop: true,
  ...
  var ShowNotification = (function () {
    return react.createElement(polytheneReact.RaisedButton, {
      ...
      events: {
        onClick: function onClick() {
          return polytheneReact.Notification.show({
            title: "This is the message",
            layout: "vertical",
            action: react.createElement(polytheneReact.Button, {
              label: "Let me think about it",
              events: {
                onClick: function onClick() {
                  polytheneReact.Notification.pause();
                  polytheneReact.Dialog.show(dialogOptions);
                }
              }
            })
          });
  ...
  var testsReact = [].concat(genericTests({ Notification: polytheneReact.Notification, Dialog: polytheneReact.Dialog, Button: polytheneReact.Button, buttonGroup: buttonGroup$1, containerSelector: containerSelector$1, renderer: polytheneReact.renderer, keys: polytheneReact.keys })).concat(reactTests({ Notification: polytheneReact.Notification, Dialog: polytheneReact.Dialog, Button: polytheneReact.Button, buttonGroup: buttonGroup$1, containerSelector: containerSelector$1, renderer: polytheneReact.renderer, keys: polytheneReact.keys }));
