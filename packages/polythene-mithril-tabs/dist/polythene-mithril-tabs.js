(function (global, factory) {
  ...
  var Tab = polytheneMithrilBase.ViewComponent(_extends({}, polytheneCoreTabs.coreTab, {
    createProps: function createProps(vnode, args) {
      return polytheneCoreTabs.coreTab.createProps(vnode, _extends(args, { Icon: polytheneMithrilIcon.Icon }));
    },
  ...
  var ScrollButton = polytheneMithrilBase.ViewComponent(_extends$1({}, polytheneCoreTabs.coreScrollButton, {
  ...
  var Tabs = polytheneMithrilBase.StateComponent(_extends$2({}, polytheneCoreTabs.coreTabs, {
