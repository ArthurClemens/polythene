(function (global, factory) {
  ...
  var genericTests = (function (_ref) {
    ...
    polytheneCss.ListTileCSS.addStyle(".tests-list-tile-themed-list-tile", {
    ...
    polytheneCss.ListTileCSS.addStyle(".tests-list-tile-themed-highlight-list-tile", {
    ...
    return [{
      ...
      attrs: {
        title: "Click me",
        events: _defineProperty({}, keys.onclick, function () {
...

    {
      ...
      component: {
        view: function view() {
          return h("div", { className: "pe-rtl" }, h(ListTile, {
            title: "Ancillary Justice",
            subtitle: "The body lay naked and facedown, a deathly gray, spatters of blood staining the snow around it. It was minus fifteen degrees Celsius and a storm had passed just hours before.",
            secondary: {
              icon: {
  ...
  var testsMithril = [].concat(genericTests({ Icon: polytheneMithril.Icon, ListTile: polytheneMithril.ListTile, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys })).concat(mithrilTests({ Icon: polytheneMithril.Icon, ListTile: polytheneMithril.ListTile, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys }));
  ...
  */
...

    {
      ...
      component: withRouter(function (_ref7) {
        ...
        return react.createElement(ListTile, {
          title: "Ancillary Justice",
          highSubtitle: "The body lay naked and facedown, a deathly gray, spatters of blood staining the snow around it. It was minus fifteen degrees Celsius and a storm had passed just hours before.",
          front: react.createElement(Icon, {
            src: "http://arthurclemens.github.io/assets/polythene/examples/avatar-1.png",
            avatar: true,
            size: "large"
          }),
  ...
  var testsReact = [].concat(genericTests({ Icon: polytheneReact.Icon, ListTile: polytheneReact.ListTile, renderer: polytheneReact.renderer, keys: polytheneReact.keys })).concat(reactTests({ Icon: polytheneReact.Icon, ListTile: polytheneReact.ListTile, renderer: polytheneReact.renderer, keys: polytheneReact.keys }));
...
//# sourceMappingURL=test-list-tile.js.map
