(function (global, factory) {
  ...
  var longTitle = "Toolbar with a very very very very very very very very very long title";
  var shortTitle = "Toolbar title";
  var titleClass = "pe-toolbar__title";
  var indentedTitleClass = "pe-toolbar__title--indent";

  var shared = (function (_ref) {
    var ToolbarTitle = _ref.ToolbarTitle,
    ...
    var toolbarTitleComponent = [toolbarButton("menu", trustedIconMenu), h(ToolbarTitle, {
      key: "title", // for React
      text: longTitle
    }), toolbarButton("add", trustedIconAddSVG)];

    var toolbarTitleComponentCentered = [h(ToolbarTitle, {
      key: "title", // for React
      text: shortTitle,
      center: true
    })];

    var toolbarTitleComponentCenteredBalanced = [toolbarButton("menu", trustedIconMenu), h(ToolbarTitle, {
      key: "title", // for React
      text: shortTitle,
      center: true
    }), h(IconButton, {
    ...
    var toolbarTitleComponentIndented = [h(ToolbarTitle, {
      key: "title", // for React
      text: longTitle,
      indent: true
    }), toolbarButton("add", trustedIconAddSVG)];

    var toolbarTitleComponentAction = [h(ToolbarTitle, {
      key: "title", // for React
      text: longTitle
    }), h("a", {
    ...
    var toolbarTitleComponentAtStart = [h(ToolbarTitle, {
      key: "title",
      text: longTitle
    }), toolbarButton("add", trustedIconAddSVG)];
  ...
  var genericTests = (function (_ref) {
    ...
    var _shared = shared({ IconButton: IconButton, ToolbarTitle: ToolbarTitle, renderer: h }),
    ...
    polytheneCss.ToolbarCSS.addStyle(".tests-toolbar-themed-toolbar", {
    ...
    return [{
      ...
      component: {
        view: function view() {
          return h(Toolbar, { z: 1 }, toolbarRow);
        }
      }
    }, {
  ...
  var testsMithril = [].concat(genericTests({ Toolbar: polytheneMithril.Toolbar, ToolbarTitle: polytheneMithril.ToolbarTitle, IconButton: polytheneMithril.IconButton, renderer: polytheneMithril.renderer })).concat(mithrilTests({ Toolbar: polytheneMithril.Toolbar, ToolbarTitle: polytheneMithril.ToolbarTitle, IconButton: polytheneMithril.IconButton, renderer: polytheneMithril.renderer }));
  ...
  */
  ...
  var reactTests = function reactTests(_ref) {
    ...
    var ToolbarButton = function ToolbarButton(_ref2) {
      var svg = _ref2.svg;
      return react.createElement(IconButton, { icon: { svg: svg } });
    };
  ...
  var testsReact = [].concat(genericTests({ Toolbar: polytheneReact.Toolbar, ToolbarTitle: polytheneReact.ToolbarTitle, IconButton: polytheneReact.IconButton, renderer: polytheneReact.renderer })).concat(reactTests({ Toolbar: polytheneReact.Toolbar, ToolbarTitle: polytheneReact.ToolbarTitle, IconButton: polytheneReact.IconButton, renderer: polytheneReact.renderer }));
...
//# sourceMappingURL=test-toolbar.js.map
