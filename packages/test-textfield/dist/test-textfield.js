(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('polythene-css'), require('powerform'), require('validatex'), require('polythene-mithril'), require('polythene-react')) :
  typeof define === 'function' && define.amd ? define(['exports', 'polythene-css', 'powerform', 'validatex', 'polythene-mithril', 'polythene-react'], factory) :
  (factory((global.polythene = {}),global['polythene-css'],global.powerform,global.validatex,global['polythene-mithril'],global['polythene-react']));
}(this, (function (exports,polytheneCss,powerform,validatex,polytheneMithril,polytheneReact) { 'use strict';

  powerform = powerform && powerform.hasOwnProperty('default') ? powerform['default'] : powerform;
    ...
    return {
      oninit: function oninit(vnode) {
        ...
        _extends$1(vnode.state, {
          ...
          value: value,
          redrawOnUpdate: stream$1.merge([textfieldState, value]) // for React
        });
      },
      view: function view(vnode) {
        var state = vnode.state;
  ...
  var genericTests = (function (_ref) {
    ...
    var block = function block(test) {
      ...
      return h("div", {
        style: _extends$3({}, attrs.dark ? null : { background: "#fff" }, attrs.fullWidth ? null : { padding: "10px 15px" })
      }, test);
    };

    polytheneCss.TextFieldCSS.addStyle(".tests-textfield-themed-textfield", {
    ...
    var Focus = focus({ h: h, k: k, TextField: TextField, RaisedButton: RaisedButton });
    var OnChange = onChange({ h: h, k: k, TextField: TextField, RaisedButton: RaisedButton });
    var SetValue = setValue({ h: h, k: k, TextField: TextField, RaisedButton: RaisedButton });
    ...
    return [{
      ...
      component: {
        view: function view() {
          return block([h(TextField, _defineProperty$2({}, k.autofocus, true))]);
        }
      }
    }, {
      ...
      component: {
        view: function view() {
          ...
          return block([h(TextField, (_h2 = {
            defaultValue: "123"
          }, _defineProperty$2(_h2, k.maxlength, 3), _defineProperty$2(_h2, "error", "Enter max 3 characters"), _h2))]);
        }
      }
    }, {
      ...
      component: {
        view: function view() {
          return block([h(TextField, _defineProperty$2({
            label: "Description",
            floatingLabel: true,
            defaultValue: shortIpsum,
            counter: 30
      ...
      oninit: function oninit(vnode) {
        _extends$5(vnode.state, {
          form: powerform({
            username: {
              default: "",
              validator: validatex.required(true)
            },
            password: {
              default: "",
              validator: validatex.required(true)
            ...
            confirmPassword: {
              default: "",
              validator: [validatex.required(true), validatex.equalsTo("password")]
            }
          }),
  ...
  var mithrilTests = function mithrilTests(_ref) {
    ...
    var block = function block(test) {
      var attrs = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return h("div", {
        style: _extends$6({}, attrs.dark ? null : { background: "#fff" }, attrs.fullWidth ? null : { padding: "10px 15px" })
      }, test);
    };

    var SetValue = setValue$1({ h: h, TextField: TextField, RaisedButton: RaisedButton });
    var FormValidation = formValidation({ h: h, TextField: TextField, RaisedButton: RaisedButton });
  ...
  var testsMithril = [].concat(genericTests({ TextField: polytheneMithril.TextField, RaisedButton: polytheneMithril.RaisedButton, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys })).concat(mithrilTests({ TextField: polytheneMithril.TextField, RaisedButton: polytheneMithril.RaisedButton, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys }));
  ...
  */
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        ...
        return this.state.submitted ? react.createElement(
          ...
          react.createElement(polytheneReact.TextField, {
            name: "username",
  ...
  var reactTests = function reactTests(_ref) {
    ...
    var block = function block(test) {
      ...
      return react.createElement(
        "div",
        {
          style: _extends$8({}, attrs.dark ? null : { background: "#fff" }, attrs.fullWidth ? null : { padding: "10px 15px" })
        },
        test
      );
    };
    ...
    return [{
      ...
      component: function component() {
        return block([react.createElement(TextField, {
          type: "password",
          defaultValue: "123456",
          key: "a"
  ...
  var testsReact = [].concat(genericTests({ TextField: polytheneReact.TextField, RaisedButton: polytheneReact.RaisedButton, renderer: polytheneReact.renderer, keys: polytheneReact.keys })).concat(reactTests({ TextField: polytheneReact.TextField, RaisedButton: polytheneReact.RaisedButton, renderer: polytheneReact.renderer, keys: polytheneReact.keys }));
