...
import { TextField as TextField$1, RaisedButton as RaisedButton$1, renderer as renderer$1, keys as keys$1 } from 'polythene-react';
...
var genericTests = (function (_ref) {
  ...
  return [{
    ...
    component: {
      view: function view() {
        return block([h(TextField$$1, _defineProperty$2({}, k.autofocus, true))]);
      }
    }
  }, {
    ...
    component: {
      view: function view() {
        return block([h(TextField$$1, _defineProperty$2({
          label: "Description",
          floatingLabel: true,
          defaultValue: shortIpsum,
          counter: 30
