(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('polythene-core-css'), require('polythene-theme'), require('polythene-css'), require('polythene-mithril'), require('polythene-react')) :
	typeof define === 'function' && define.amd ? define(['exports', 'polythene-core-css', 'polythene-theme', 'polythene-css', 'polythene-mithril', 'polythene-react'], factory) :
	(factory((global.polythene = {}),global['polythene-core-css'],global['polythene-theme'],global['polythene-css'],global['polythene-mithril'],global['polythene-react']));
}(this, (function (exports,polytheneCoreCss,polytheneTheme,polytheneCss,polytheneMithril,polytheneReact) { 'use strict';
	...
	var onChange = (function (_ref) {
	  ...
	  return {
	    oninit: function oninit(vnode) {
	      var value = stream$1(attrs.defaultValue || attrs.value || 0);
	    ...
	    view: function view(vnode) {
	      ...
	      }, displayFn(value)), h(Slider, _extends({}, attrs, {
	...
	var styles = [{
	  " .volume": {
	    " .pe-header": {
	      fontSize: "14px",
	      color: polytheneCoreCss.rgba(polytheneTheme.vars.color_light_foreground, polytheneTheme.vars.blend_light_text_secondary)
	    },
	    " .pe-slider": {
	      color: "#009688",
	  ...
	  " .pe-dark-tone.volume": {
	    " .pe-header": {
	      color: polytheneCoreCss.rgba(polytheneTheme.vars.color_dark_foreground, polytheneTheme.vars.blend_dark_text_secondary)
	    }
	  }
	}];

	polytheneCoreCss.styler.add("polythene-test-slider-volume", styles);
	...
	var volumeSlider = (function (_ref) {
	  ...
	  return {
	    view: function view() {
	      return h(".volume", [h(".header", "Media volume"), h(Slider, _extends$1({}, defaults, {
	        defaultValue: 4,
	        before: h(Icon, {
	          svg: { content: volumeIcon }
	        })
	      })), h(".header", "Alarm volume"), h(Slider, _extends$1({}, defaults, {
	        defaultValue: 2,
	        before: h(Icon, {
	          svg: { content: alarmIcon }
	        })
	      })), h(".header", "Headphone volume"), h(Slider, _extends$1({}, defaults, {
	        defaultValue: 2,
	        disabled: true,
	        before: h(Icon, {
	...
	var genericTests = (function (_ref) {
	  ...
	  var VolumeSlider = volumeSlider({ Slider: Slider, Icon: Icon, h: h });

	  polytheneCss.SliderCSS.addStyle(".slider-custom-icon", {
	    color_light_thumb_on: "#f50057",
	    color_light_icon: "#fff",
	    thumb_size: 18
	  });

	  polytheneCss.SliderCSS.addStyle(".slider-custom-color", {
	  ...
	  return [{
	    ...
	    interactive: true,
	    component: onChange({ h: h, Slider: Slider, attrs: {} })
	  }, {
	...
	polytheneCoreCss.styler.add("polythene-test-slider-rgb", styles$1);
	...
	var colorSlider = function colorSlider(_ref) {
	  ...
	  return {
	    oninit: function oninit(vnode) {
	      ...
	      var value = stream$1(attrs.defaultValue);
	...
	var rgbSlider = (function (_ref4) {
	  var h = _ref4.h,
	      k = _ref4.k,
	      Slider = _ref4.Slider,
	      TextField = _ref4.TextField;

	  var ColorSlider = colorSlider({ h: h, k: k, Slider: Slider, TextField: TextField });

	  return {
	    oninit: function oninit(vnode) {
	      var red = stream$1(127);
	      var green = stream$1(127);
	      var blue = stream$1(127);

	      var rgb = stream$1.merge([red, green, blue]).map(function (values) {
	        return values.join(",");
	      });
	      _extends$2(vnode.state, {
	        red: red,
	...
	var mithrilTests = function mithrilTests(_ref) {
	  ...
	  var RGBSlider = rgbSlider({ Slider: Slider, Icon: Icon, TextField: TextField, h: h, k: k });
	...
	var testsMithril = [].concat(genericTests({ Slider: polytheneMithril.Slider, Icon: polytheneMithril.Icon, TextField: polytheneMithril.TextField, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys })).concat(mithrilTests({ Slider: polytheneMithril.Slider, Icon: polytheneMithril.Icon, TextField: polytheneMithril.TextField, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys }));
	...
	*/
	...
	polytheneCoreCss.styler.add("polythene-test-slider-rgb", styles$2);
	...
	var ColorSlider = function (_Component) {
	  ...
	  _createClass(ColorSlider, [{
	    ...
	    value: function render() {
	      ...
	      return react.createElement(polytheneReact.Slider, {
	        min: 0,
	        max: 255,
	        value: value,
	        ...
	        after: react.createElement(polytheneReact.TextField, {
	          type: "number",
	          hideSpinner: true,
	...
	var testsReact = [].concat(genericTests({ Slider: polytheneReact.Slider, Icon: polytheneReact.Icon, TextField: polytheneReact.TextField, renderer: polytheneReact.renderer, keys: polytheneReact.keys })).concat(reactTests({ Slider: polytheneReact.Slider, Icon: polytheneReact.Icon, TextField: polytheneReact.TextField, renderer: polytheneReact.renderer, keys: polytheneReact.keys }));
...
//# sourceMappingURL=test-slider.js.map
