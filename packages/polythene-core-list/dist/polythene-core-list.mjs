...
var _List = function _List(_ref) {
  ...
  var componentContent = [headerOpts ? h(ListTile, _objectSpread2(_objectSpread2(_objectSpread2({}, props.all), headerOpts), {}, {
    header: true
  })) : undefined].concat(_toConsumableArray(props.all ? tiles.map(function (tileOpts) {
    return h(ListTile, _objectSpread2(_objectSpread2({}, props.all), tileOpts));
  }) : tiles));
