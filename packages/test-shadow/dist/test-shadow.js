(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('polythene-mithril'), require('polythene-react')) :
	typeof define === 'function' && define.amd ? define(['exports', 'polythene-mithril', 'polythene-react'], factory) :
	(factory((global.polythene = {}),global['polythene-mithril'],global['polythene-react']));
}(this, (function (exports,polytheneMithril,polytheneReact) { 'use strict';
	  ...
	  return {
	    oninit: function oninit(vnode) {
	      ...
	      _extends(vnode.state, {
	        z: z,
	        redrawOnUpdate: stream$1.merge([z]) // for React
	      });
	    },
	...
	var genericTests = (function (_ref) {
	  ...
	  return [{
	    ...
	    component: {
	      view: function view() {
	        return h("div", [h("div", "Some element"), h(Shadow)]);
	      }
	    }
	  }, {
	    ...
	    interactive: true,
	    exclude: true,
	    component: interactive({ h: h, k: k, Shadow: Shadow })
	  },
	...
	var testsMithril = [].concat(genericTests({ Shadow: polytheneMithril.Shadow, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys })).concat(mithrilTests({ Shadow: polytheneMithril.Shadow, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys }));
	...
	*/
	...
	var testsReact = [].concat(genericTests({ Shadow: polytheneReact.Shadow, renderer: polytheneReact.renderer, keys: polytheneReact.keys })).concat(reactTests({ Shadow: polytheneReact.Shadow, renderer: polytheneReact.renderer, keys: polytheneReact.keys }));
...
//# sourceMappingURL=test-shadow.js.map
