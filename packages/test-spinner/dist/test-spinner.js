(function (global, factory) {
	...
	var progressOpener = (function (_ref) {
	  ...
	  return {
	    oninit: function oninit(vnode) {
	      var start = stream$1(null);
	      var percentage = stream$1(0);
	      ...
	      _extends$1(vnode.state, {
	        ...
	        redrawOnUpdate: stream$1.merge([start, percentage]) // update React
	      });
	    },
	    view: function view(vnode) {
	      var state = vnode.state;
	...
	var genericTests = (function (_ref) {
	  var MaterialDesignSpinner = _ref.MaterialDesignSpinner,
	      MaterialDesignProgressSpinner = _ref.MaterialDesignProgressSpinner,
	      IOSSpinner = _ref.IOSSpinner,
	      RaisedButton = _ref.RaisedButton,
	      Slider = _ref.Slider,
	  ...
	  polytheneCss.MaterialDesignSpinnerCSS.addStyle(".tests-spinner-themed-md-spinner", {
	  ...
	  polytheneCss.IOSSpinnerCSS.addStyle(".tests-spinner-themed-ios-spinner", {
	    color_light: "green",
	    color_dark: "yellow"
	  });
	...
	var testsMithril = [].concat(genericTests({ RaisedButton: polytheneMithril.RaisedButton, IOSSpinner: polytheneMithril.IOSSpinner, MaterialDesignSpinner: polytheneMithril.MaterialDesignSpinner, MaterialDesignProgressSpinner: polytheneMithril.MaterialDesignProgressSpinner, Slider: polytheneMithril.Slider, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys })).concat(mithrilTests({ RaisedButton: polytheneMithril.RaisedButton, IOSSpinner: polytheneMithril.IOSSpinner, MaterialDesignSpinner: polytheneMithril.MaterialDesignSpinner, MaterialDesignProgressSpinner: polytheneMithril.MaterialDesignProgressSpinner, Slider: polytheneMithril.Slider, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys }));
	...
	*/
	...
	var _class = function (_Component) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function render() {
	      ...
	      return polytheneReact.renderer("div", [polytheneReact.renderer("div", {
	        style: {
	          display: "flex",
	          width: "100%",
	          margin: "0 0 20px 0"
	        }
	      }, polytheneReact.renderer(polytheneReact.Slider, {
	        min: 0,
	        max: MAX_VALUE$1,
	        step: 0,
	        ...
	        after: polytheneReact.renderer(polytheneReact.MaterialDesignProgressSpinner, _extends$4({}, {
	          show: true,
	          percentage: percentage,
	          class: "self-center"
	        }))
	      })), polytheneReact.renderer(polytheneReact.RaisedButton, {
	        label: "Run",
	        events: {
	...
	var reactTests = function reactTests(_ref) {
	  ...
	  return [{
	    ...
	    component: function component() {
	      return react.createElement(polytheneReact.MaterialDesignSpinner, { permanent: true });
	    }
	  }, {
	    name: "Option: permanent (JSX) -- iOS Spinner",
	    component: function component() {
	      return react.createElement(polytheneReact.IOSSpinner, { permanent: true });
	    }
	  }];
	};

	var testsReact = [].concat(genericTests({ RaisedButton: polytheneReact.RaisedButton, IOSSpinner: polytheneReact.IOSSpinner, MaterialDesignSpinner: polytheneReact.MaterialDesignSpinner, MaterialDesignProgressSpinner: polytheneReact.MaterialDesignProgressSpinner, Slider: polytheneReact.Slider, renderer: polytheneReact.renderer, keys: polytheneReact.keys })).concat(reactTests({ RaisedButton: polytheneReact.RaisedButton, IOSSpinner: polytheneReact.IOSSpinner, MaterialDesignSpinner: polytheneReact.MaterialDesignSpinner, MaterialDesignProgressSpinner: polytheneReact.MaterialDesignProgressSpinner, Slider: polytheneReact.Slider, renderer: polytheneReact.renderer, keys: polytheneReact.keys }));
...
//# sourceMappingURL=test-spinner.js.map
