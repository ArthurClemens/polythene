(function (global, factory) {
	...
	var genericTests = (function (_ref) {
	  ...
	  polytheneCss.CheckboxCSS.addStyle(".tests-checkbox-themed-checkbox", {
	    label_font_size: 28,
	  ...
	  var sizes = function sizes(_sizes, attrs) {
	    return _sizes.map(function (size) {
	      return h(Checkbox, _extends$3({}, attrs, {
	        label: size,
	        size: size
	      }));
	    });
	  ...
	  return [{
	    ...
	    interactive: true,
	    exclude: true,
	    component: onChange({ h: h, Checkbox: Checkbox })
	  }, {
	    name: "Option: events",
	    interactive: true,
	    exclude: true,
	    component: events({ h: h, k: k, Checkbox: Checkbox })
	  }, {
	    name: "Setting the checked state",
	    interactive: true,
	    exclude: true,
	    component: toggleButton({ h: h, k: k, RaisedButton: RaisedButton, Checkbox: Checkbox })
	  },
	...
	var testsMithril = [].concat(genericTests({ Checkbox: polytheneMithril.Checkbox, RaisedButton: polytheneMithril.RaisedButton, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys })).concat(mithrilTests({ Checkbox: polytheneMithril.Checkbox, RaisedButton: polytheneMithril.RaisedButton, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys }));
	...
	*/
	  ...
	  _createClass(SimpleForm, [{
	    ...
	    value: function render() {
	      return react.createElement(
	        "div",
	        null,
	        react.createElement(polytheneReact.Checkbox, {
	          label: "Label",
	...
	var testsReact = [].concat(genericTests({ Checkbox: polytheneReact.Checkbox, RaisedButton: polytheneReact.RaisedButton, renderer: polytheneReact.renderer, keys: polytheneReact.keys })).concat(reactTests({ Checkbox: polytheneReact.Checkbox, RaisedButton: polytheneReact.RaisedButton, renderer: polytheneReact.renderer, keys: polytheneReact.keys }));
...
//# sourceMappingURL=test-checkbox.js.map
