...
var styles = [{
  ".layout, .layout.horizontal": flex$2.layout,
  ".layout.horizontal.inline, .layout.vertical.inline": flex$2.layoutInline,
  ".layout.horizontal": flex$2.layoutHorizontal,
  ".layout.horizontal.reverse": flex$2.layoutHorizontalReverse,
  ".layout.vertical": flex$2.layoutVertical,
  ".layout.vertical.reverse": flex$2.layoutVerticalReverse,
  ...
  ".flex.two": flex$2.flexIndex(2),
  ".flex.three": flex$2.flexIndex(3),
  ".flex.four": flex$2.flexIndex(4),
  ".flex.five": flex$2.flexIndex(5),
  ".flex.six": flex$2.flexIndex(6),
  ".flex.seven": flex$2.flexIndex(7),
  ".flex.eight": flex$2.flexIndex(8),
  ".flex.nine": flex$2.flexIndex(9),
  ".flex.ten": flex$2.flexIndex(10),
  ".flex.eleven": flex$2.flexIndex(11),
  ".flex.twelve": flex$2.flexIndex(12),

  // alignment in cross axis
  ".layout.start": flex$2.layoutStart,
  ".layout.center, .layout.center-center": flex$2.layoutCenter,
  ".layout.end": flex$2.layoutEnd,

  // alignment in main axis
  ".layout.start-justified": flex$2.layoutStartJustified,
  ".layout.center-justified, .layout.center-center": flex$2.layoutCenterJustified,
  ".layout.end-justified": flex$2.layoutEndJustified,
  ".layout.around-justified": flex$2.layoutAroundJustified,
  ".layout.justified": flex$2.layoutJustified,

  // self alignment
  ".self-start": flex$2.selfStart,
  ".self-center": flex$2.selfCenter,
  ".self-end": flex$2.selfEnd,
  ".self-stretch": flex$2.selfStretch
}];
