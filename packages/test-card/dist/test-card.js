(function (global, factory) {
  ...
  var genericTests = (function (_ref) {
    ...
    var twoButtonRow = [h(Button, { label: "Action 1", key: "one" }), h(Button, { label: "Action 2", key: "two" })];

    var twoButtonAndLessRow = [h(Button, {
      label: "Action 1",
      key: "one"
    }), h(Button, {
      label: "Action 2",
      key: "two"
    }), h(".flex", { key: "space" }), h(IconButton, {
      key: "three",
      icon: {
        size: "medium",
    ...
    var iconButtonRow = [h(".flex", { key: "space" }), h(IconButton, {
    ...
    polytheneCss.CardCSS.addStyle(".tests-card-colored-card", {
      ...
      attrs: {
        content: [{
          ...
          actions: {
            ...
            // keys for React
            h(ListTile, { hoverable: true, key: "one" }, "Action 1"), h(ListTile, { hoverable: true, key: "two" }, "Action 2"), h(ListTile, { hoverable: true, key: "three" }, "Action 3")])
          }
        }]
      }
    },
      ...
      attrs: {
        ...
        content: [{
          actions: {
            layout: "vertical",
            tight: true,
            content: h(List, { border: true }, [h(ListTile, { hoverable: true, key: "one" }, "Action 1"), h(ListTile, { hoverable: true, key: "two" }, "Action 2"), h(ListTile, { hoverable: true, key: "three" }, "Action 3")])
          }
        }]
      }
    }, {
  ...
  var testsMithril = [].concat(genericTests({ Card: polytheneMithril.Card, List: polytheneMithril.List, ListTile: polytheneMithril.ListTile, Button: polytheneMithril.Button, IconButton: polytheneMithril.IconButton, Tabs: polytheneMithril.Tabs, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys })).concat(mithrilTests({ Card: polytheneMithril.Card, List: polytheneMithril.List, ListTile: polytheneMithril.ListTile, Button: polytheneMithril.Button, IconButton: polytheneMithril.IconButton, Tabs: polytheneMithril.Tabs, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys }));
  ...
  */
          ...
          content: [{
            ...
            actions: {
              content: react.createElement(
                "div",
                null,
                react.createElement(Button, { label: "Action 1", key: "one" }),
                react.createElement(Button, { label: "Action 2", key: "two" })
              )
            }
          }]
        });
  ...
  var testsReact = [].concat(genericTests({ Card: polytheneReact.Card, List: polytheneReact.List, ListTile: polytheneReact.ListTile, Button: polytheneReact.Button, IconButton: polytheneReact.IconButton, Tabs: polytheneReact.Tabs, renderer: polytheneReact.renderer, keys: polytheneReact.keys })).concat(reactTests({ Card: polytheneReact.Card, List: polytheneReact.List, ListTile: polytheneReact.ListTile, Button: polytheneReact.Button, IconButton: polytheneReact.IconButton, Tabs: polytheneReact.Tabs, renderer: polytheneReact.renderer, keys: polytheneReact.keys }));
