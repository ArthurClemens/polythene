(function (global, factory) {
  ...
  var genericTests = (function (_ref) {
    ...
    polytheneCss.RaisedButtonCSS.addStyle(".tests-raised-button-themed-button", {
    ...
    return [{
      ...
      component: {
        view: function view() {
          return h(".pe-button-row", [h(RaisedButton, {
            key: "one", // for React
            label: "One"
          }), h(RaisedButton, {
            key: "two", // for React
  ...
  var mithrilTests = function mithrilTests(_ref) {
    var RaisedButton = _ref.RaisedButton,
        h = _ref.renderer;
    ...
    return [{
      ...
      component: {
        ...
        view: function view(vnode) {
          return [h("div", "onclick called: " + vnode.state.clicked), h(RaisedButton, {
            label: "Button",
            events: {
  ...
  var testsMithril = [].concat(genericTests({ RaisedButton: polytheneMithril.RaisedButton, renderer: polytheneMithril.renderer })).concat(mithrilTests({ RaisedButton: polytheneMithril.RaisedButton, renderer: polytheneMithril.renderer }));
  ...
  var reactTests = function reactTests(_ref) {
    ...
    return [{
      ...
      component: withCounter(function (_ref4) {
        ...
        return h("div", [h("div", "onclick called: " + counter), h(RaisedButton, {
          label: "Button",
          events: {
            onClick: increment
          }
      ...
      component: function component() {
        return react.createElement(RaisedButton, { label: "Button", z: 2 });
      }
    }, {
      name: "Option: inactivate (2s) (JSX)",
      component: function component() {
        return react.createElement(RaisedButton, { label: "Inactivated for 2s", inactivate: 2 });
      }
    }];
  };

  var testsReact = [].concat(genericTests({ RaisedButton: polytheneReact.RaisedButton, renderer: polytheneReact.renderer })).concat(reactTests({ RaisedButton: polytheneReact.RaisedButton, renderer: polytheneReact.renderer }));
...
//# sourceMappingURL=test-raised-button.js.map
