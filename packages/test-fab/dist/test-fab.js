(function (global, factory) {
  ...
  var genericTests = (function (_ref) {
    ...
    polytheneCss.FABCSS.addStyle(".tests-fab-themed-fab", {
  ...
  var testsMithril = [].concat(genericTests({ FAB: polytheneMithril.FAB, Icon: polytheneMithril.Icon, renderer: polytheneMithril.renderer })).concat(mithrilTests({ FAB: polytheneMithril.FAB, Icon: polytheneMithril.Icon, renderer: polytheneMithril.renderer }));
  ...
  */
  ...
  var reactTests = function reactTests(_ref) {
    ...
    return [{
      ...
      component: function component() {
        return react.createElement(FAB, { icon: { svg: { content: iconAlarmSVG } }, mini: true });
      }
    }, {
      ...
      name: "Option: z (5) (JSX)",
      component: function component() {
        return react.createElement(FAB, { mini: true, icon: { svg: { content: iconAlarmSVG } }, z: 5 });
      }
    }, {
      name: "Option: style (JSX)",
      component: function component() {
        return react.createElement(FAB, { icon: { svg: { content: iconAlarmSVG } }, style: { color: "#ef6c00", backgroundColor: "#fff" } });
      }
    }, {
  ...
  var testsReact = [].concat(genericTests({ FAB: polytheneReact.FAB, Icon: polytheneReact.Icon, renderer: polytheneReact.renderer })).concat(reactTests({ FAB: polytheneReact.FAB, Icon: polytheneReact.Icon, SVG: polytheneReact.SVG, renderer: polytheneReact.renderer }));
...
//# sourceMappingURL=test-fab.js.map
