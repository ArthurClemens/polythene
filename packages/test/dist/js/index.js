...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_j2c_plugin_prefix_browser__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_j2c__ = __webpack_require__(66);
...
var vars = _extends({}, __WEBPACK_IMPORTED_MODULE_0_polythene_core__["g" /* defaultVariables */], { color_primary: "255, 152, 0" // new base color: orange 500
});
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return multiple; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_ripple__ = __webpack_require__(15);
...
var layout = (function (selector, componentVars) {
  return [_defineProperty({}, selector, [__WEBPACK_IMPORTED_MODULE_4_polythene_css__["a" /* flex */].layout, {
    ...
    ".pe-list-tile--sticky": [__WEBPACK_IMPORTED_MODULE_4_polythene_css__["b" /* mixin */].sticky(2)],
    ...
    " .pe-list-tile__title": [__WEBPACK_IMPORTED_MODULE_4_polythene_css__["b" /* mixin */].ellipsis(1), {
      "font-size": componentVars.font_size_title + "px",
    ...
    " .pe-list-tile__subtitle": [__WEBPACK_IMPORTED_MODULE_4_polythene_css__["b" /* mixin */].ellipsis(componentVars.subtitle_line_count, componentVars.line_height_subtitle), {
      "font-size": componentVars.font_size_subtitle + "px",
      "line-height": componentVars.line_height_subtitle + "px",

      ".pe-list-tile__high-subtitle": [__WEBPACK_IMPORTED_MODULE_4_polythene_css__["b" /* mixin */].ellipsis(componentVars.high_subtitle_line_count, componentVars.line_height_subtitle), {
        "white-space": "normal"
      }]
    }],
    ...
    ".pe-list__header": {
      ...
      " .pe-list-tile__title": [__WEBPACK_IMPORTED_MODULE_4_polythene_css__["b" /* mixin */].ellipsis(1, componentVars.single_height), {
    ...
    ".pe-dialog .pe-menu__content &": {
      " .pe-list-tile__title": __WEBPACK_IMPORTED_MODULE_4_polythene_css__["b" /* mixin */].ellipsis("none")
    },
    ...
    ".pe-menu__content &": {
      ":not(.pe-list-tile--disabled)": {
        ...
        "&, .pe-list-tile__primary, .pe-list-tile__secondary": {
          " .pe-list-tile__title, .pe-list-tile__subtitle": [__WEBPACK_IMPORTED_MODULE_4_polythene_css__["b" /* mixin */].vendorize({
            userSelect: "none"
...
var customTheme = function customTheme(customSelector, customVars) {
  return __WEBPACK_IMPORTED_MODULE_4_polythene_css__["c" /* styler */].generateStyles([customSelector, selector], _extends$1({}, vars$1, customVars), fns);
};

__WEBPACK_IMPORTED_MODULE_4_polythene_css__["c" /* styler */].generateStyles([selector], vars$1, fns);
...
var secondaryContent = function secondaryContent() {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(element, _extends({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_polythene_core__["d" /* filterSupportedAttributes */])(secondaryAttrs), secondaryAttrs.url, {
    ...
    class: classes.content
  }, [secondaryAttrs.icon ? __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_icon__["a" /* icon */], secondaryAttrs.icon) : null, secondaryAttrs.content ? secondaryAttrs.content : null]));
};
...
var view = function view(vnode) {
  ...
  var content = [attrs.ink && !attrs.disabled ? __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_ripple__["a" /* ripple */], attrs.ripple) : null, primaryContent(primaryAttrs, attrs.children || vnode.children), attrs.secondary ? secondaryContent(attrs.secondary) : null];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_svg__ = __webpack_require__(17);
...
var customTheme = function customTheme(customSelector, customVars) {
  return __WEBPACK_IMPORTED_MODULE_3_polythene_css__["c" /* styler */].generateStyles([customSelector, selector], _extends$1({}, vars$1, customVars), fns);
};

__WEBPACK_IMPORTED_MODULE_3_polythene_css__["c" /* styler */].generateStyles([selector], vars$1, fns);
...
var view = function view(vnode) {
  ...
  var content = attrs.content ? attrs.content : attrs.svg ? __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_svg__["a" /* svg */], _extends({}, attrs.svg)) : attrs.msvg ? __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_svg__["a" /* svg */], attrs.msvg) : attrs.src ? __WEBPACK_IMPORTED_MODULE_0_mithril___default()("img", { src: attrs.src }) : attrs.children || vnode.children;
  return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(element, props, [attrs.before, content, attrs.after]);
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_ripple__ = __webpack_require__(15);
...
var baseLayout = (function (selector) {
  return [_defineProperty({}, selector, [__WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].vendorize({
    userSelect: "none"
    ...
    " .pe-button__label": [__WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].fontSmoothing(), {
      position: "relative",
      display: "block",
      borderRadius: "inherit",
      pointerEvents: "none"
    ...
    " .pe-button__wash, .pe-button__focus": [__WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].defaultTransition("background-color"), __WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].fit(), {
      borderRadius: "inherit",
      pointerEvents: "none"
    }],
...
var layout = (function (selector, componentVars) {
  return [_defineProperty$1({}, selector, {
    ...
    ".pe-button--borders": {
      " .pe-button__wash, pe-button__focus, .pe-ripple": __WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].fit(-1),
...
__WEBPACK_IMPORTED_MODULE_3_polythene_css__["c" /* styler */].generateStyles([baseSelector], vars$1, [baseLayout]);
__WEBPACK_IMPORTED_MODULE_3_polythene_css__["c" /* styler */].generateStyles([selector], vars$1, fns);
...
var view = function view(vnode) {
  ...
  // ripple
  disabled || noink ? null : __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_ripple__["a" /* ripple */], _extends({}, attrs.ripple, {
...
var borderStyle = function borderStyle(componentVars) {
  return __WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].hairline("border-bottom"), {
...
var layout = (function (selector, componentVars) {
  return [_defineProperty({}, selector, {
    ...
    "& + &": [__WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].hairline("border-top"), {
...
var view = function view(vnode) {
  ...
  var content = [headerOpts ? __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_list_tile__["a" /* listTile */], headerOpts) : null, attrs.tiles ? attrs.tiles : attrs.content ? attrs.content : attrs.children || vnode.children];
  return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(element, props, [attrs.before, content, attrs.after]);
};
...
var layout = (function (selector, componentVars) {
  ...
  return [(_ref = {}, _defineProperty(_ref, selector, [__WEBPACK_IMPORTED_MODULE_3_polythene_css__["a" /* flex */].layoutCenterCenter, {
    ...
    " .pe-dialog__header": {
      ...
      " .pe-dialog__title": [__WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].ellipsis(1), {
        width: "100%"
      }]
    },

    " .pe-dialog__body": [__WEBPACK_IMPORTED_MODULE_3_polythene_css__["a" /* flex */].selfStretch, __WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].hairline("border-top"), {
...
var showDialog = function showDialog(state, opts) {
  ...
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_polythene_core__["a" /* show */])(_extends({}, opts, {
    el: state.el,
...
var hideDialog = function hideDialog(state, opts) {
  var id = state.id;
  state.isTransitioning = true;
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_polythene_core__["b" /* hide */])(_extends({}, opts, {
    el: state.el,
    showClass: classes.visible
  })).then(function () {
    dialog.remove(id);
...
var createView = function createView(state, opts) {
  ...
  var cleanup = function cleanup() {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_polythene_core__["c" /* unsubscribe */])("resize", update);
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_polythene_core__["c" /* unsubscribe */])("keydown", handleEscape);
  };
  ...
  var props = _extends({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_polythene_core__["d" /* filterSupportedAttributes */])(opts), {
    ...
    oncreate: function oncreate(_ref2) {
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_polythene_core__["e" /* subscribe */])("resize", update);
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_polythene_core__["e" /* subscribe */])("keydown", handleEscape);
  ...
  var content = __WEBPACK_IMPORTED_MODULE_1_mithril___default()("div", {
    ...
    style: opts.style
  }, [opts.fullscreen ? null : __WEBPACK_IMPORTED_MODULE_1_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_shadow__["a" /* shadow */], {
    z: state.z,
    animated: true
...
var dialog = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_polythene_core__["f" /* multiple */])({
  instance: instance,
...
var view = function view(vnode) {
  var attrs = vnode.attrs;
  var content = attrs.content ? attrs.content : attrs.icon ? __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_icon__["a" /* icon */], attrs.icon) : attrs.children || vnode.children;
  return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_button__["a" /* button */], _extends({}, {
...
var cancelOkButtons = [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */], {
  label: "Cancel",
  events: {
    onclick: function onclick() {
      return __WEBPACK_IMPORTED_MODULE_2_polythene_dialog__["a" /* dialog */].hide();
    }
  }
}), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */], {
  label: "Discard",
  events: {
    onclick: function onclick() {
      return __WEBPACK_IMPORTED_MODULE_2_polythene_dialog__["a" /* dialog */].hide();
...
var layout = (function (selector, componentVars) {
  return [_defineProperty({}, selector, [__WEBPACK_IMPORTED_MODULE_2_polythene_css__["b" /* mixin */].fit(), {
    borderRadius: "inherit",
    pointerEvents: "none",

    " .pe-shadow__bottom, .pe-shadow__top": [__WEBPACK_IMPORTED_MODULE_2_polythene_css__["b" /* mixin */].fit(), {
      borderRadius: "inherit"
    }],
...
var customTheme = function customTheme(customSelector, customVars) {
  return __WEBPACK_IMPORTED_MODULE_2_polythene_css__["c" /* styler */].generateStyles([customSelector, selector], _extends$1({}, vars$1, customVars), fns);
};

__WEBPACK_IMPORTED_MODULE_2_polythene_css__["c" /* styler */].generateStyles([selector], vars$1, fns);
...
var createView = function createView(vnode) {
  ...
  var props = _extends({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_polythene_core__["d" /* filterSupportedAttributes */])(attrs), {
    ...
    oncreate: function oncreate(_ref) {
      ...
      state.el = dom;
      if (!attrs.permanent) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_polythene_core__["e" /* subscribe */])("resize", update);
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_polythene_core__["e" /* subscribe */])("keydown", handleEscape);
        setTimeout(function () {
          activateDismissTap();
    ...
    onremove: function onremove() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_polythene_core__["c" /* unsubscribe */])("resize", update);
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_polythene_core__["c" /* unsubscribe */])("keydown", handleEscape);
      if (!attrs.permanent) {
        deActivateDismissTap();
      }
    }
  ...
  }, [state.z > 0 && __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_shadow__["a" /* shadow */], {
    z: state.z,
    animated: true
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_polythene_core__["e" /* subscribe */])(__WEBPACK_IMPORTED_MODULE_3_polythene_core__["j" /* touchEndEvent */], function () {
  return tapEndAll();
});
...
var view = function view(vnode) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */], _extends({}, {
    parentClass: [attrs.parentClass || classes.component].join(" "),
    animateOnTap: false,
    shadowComponent: __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_shadow__["a" /* shadow */], { z: state.z, animated: true }),
    children: children
  }, attrs));
};
...
var layout = (function (selector, componentVars) {
  return [_defineProperty({}, selector, [__WEBPACK_IMPORTED_MODULE_2_polythene_css__["a" /* flex */].layout, __WEBPACK_IMPORTED_MODULE_2_polythene_css__["a" /* flex */].layoutHorizontal, __WEBPACK_IMPORTED_MODULE_2_polythene_css__["a" /* flex */].layoutCenter, {
    ...
    " > span, .pe-toolbar__title, .pe-toolbar__title--indent": [__WEBPACK_IMPORTED_MODULE_2_polythene_css__["a" /* flex */].layout, __WEBPACK_IMPORTED_MODULE_2_polythene_css__["a" /* flex */].flex(1), __WEBPACK_IMPORTED_MODULE_2_polythene_css__["b" /* mixin */].ellipsis(1, __WEBPACK_IMPORTED_MODULE_3_polythene_theme__["a" /* vars */].line_height, "em"), {
    ...
    " .pe-fit": [__WEBPACK_IMPORTED_MODULE_2_polythene_css__["b" /* mixin */].fit(), {
      margin: 0
    }]
  }])];
});
...
var layout = (function (selector) {
  return [_defineProperty({}, selector, [__WEBPACK_IMPORTED_MODULE_2_polythene_css__["b" /* mixin */].fit(), {
    ...
    " .pe-ripple__mask": [__WEBPACK_IMPORTED_MODULE_2_polythene_css__["b" /* mixin */].fit(), {
...
var animation = (function (e, el, wavesEl, attrs, classes, endCallback) {
  ...
  __WEBPACK_IMPORTED_MODULE_2_polythene_css__["c" /* styler */].add(animationId, keyframeStyle);
  ...
  var onEnd = function onEnd(evt) {
    ...
    __WEBPACK_IMPORTED_MODULE_2_polythene_css__["c" /* styler */].remove(animationId);
    if (attrs.end) {
      attrs.end(evt);
    }
  };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_core__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_icon__ = __webpack_require__(5);
...
var makeSize = function makeSize(componentVars, height) {
  ...
  return {
    ...
    " .pe-button__content": {
      ...
      " .pe-icon": [__WEBPACK_IMPORTED_MODULE_5_polythene_css__["b" /* mixin */].fit(iconOffset)]
    }
  };
};
...
var layout = (function (selector, componentVars, type) {
  ...
  }, _defineProperty$1(_selector, " input[type=" + type + "].pe-control__input", [__WEBPACK_IMPORTED_MODULE_5_polythene_css__["b" /* mixin */].vendorize({
    appearance: "none"
  ...
  }), _defineProperty$1(_selector, " .pe-button.pe-control__button", [__WEBPACK_IMPORTED_MODULE_5_polythene_css__["b" /* mixin */].defaultTransition("opacity", componentVars.animation_duration), {
    position: "absolute",
...
var customTheme = function customTheme(customSelector, customVars) {
  return __WEBPACK_IMPORTED_MODULE_2_polythene_css__["c" /* styler */].generateStyles([customSelector, selector], _extends$1({}, vars, customVars), fns);
};

__WEBPACK_IMPORTED_MODULE_2_polythene_css__["c" /* styler */].generateStyles([selector], vars, fns);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_raised_button__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_icon__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_polythene_css__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_polythene_theme__ = __webpack_require__(2);
...
var layout = (function (selector, componentVars) {
  return [_defineProperty({}, selector, [__WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].vendorize({
    ...
    " .pe-button__wash": [__WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].vendorize({
...
var view = function view(vnode) {
  var attrs = vnode.attrs;
  var content = attrs.content ? attrs.content : attrs.icon ? __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_icon__["a" /* icon */], attrs.icon) : attrs.children || vnode.children;
  return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_raised_button__["a" /* raisedButton */], _extends({}, {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_fastclick__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_material_design__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__styles__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__page__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_polythene_toolbar__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__tests_button_tests__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__tests_checkbox_tests__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__tests_dialog_tests__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__tests_fab_tests__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__tests_icon_tests__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__tests_icon_button_tests__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__tests_list_tests__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__tests_list_tile_tests__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__tests_menu_tests__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__tests_radio_button_tests__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__tests_raised_button_tests__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__tests_ripple_tests__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__tests_shadow_tests__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__tests_svg_tests__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__tests_switch_button_tests__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__tests_tabs_tests__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__tests_toolbar_tests__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__tests_css_tests__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__tests_css_classes_tests__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__tests_theme_tests__ = __webpack_require__(61);
...
var pages = [{
  ...
  path: "/raised-button",
  name: "Raised button",
  tests: __WEBPACK_IMPORTED_MODULE_18__tests_raised_button_tests__["a" /* tests */]
}, {
  path: "/checkbox",
  name: "Checkbox",
  tests: __WEBPACK_IMPORTED_MODULE_9__tests_checkbox_tests__["a" /* tests */]
}, {
  path: "/dialog",
  name: "Dialog",
  tests: __WEBPACK_IMPORTED_MODULE_10__tests_dialog_tests__["a" /* tests */]
}, {
  path: "/fab",
  name: "FAB",
  tests: __WEBPACK_IMPORTED_MODULE_11__tests_fab_tests__["a" /* tests */]
}, {
  path: "/icon",
  name: "Icon",
  tests: __WEBPACK_IMPORTED_MODULE_12__tests_icon_tests__["a" /* tests */]
}, {
  path: "/icon-button",
  name: "Icon Button",
  tests: __WEBPACK_IMPORTED_MODULE_13__tests_icon_button_tests__["a" /* tests */]
}, {
  path: "/list",
  name: "List",
  tests: __WEBPACK_IMPORTED_MODULE_14__tests_list_tests__["a" /* tests */]
}, {
  path: "/list-tile",
  name: "List tile",
  tests: __WEBPACK_IMPORTED_MODULE_15__tests_list_tile_tests__["a" /* tests */]
}, {
  path: "/menu",
  name: "Menu",
  tests: __WEBPACK_IMPORTED_MODULE_16__tests_menu_tests__["a" /* tests */]
}, {
  path: "/radio-button",
  name: "Radio button",
  tests: __WEBPACK_IMPORTED_MODULE_17__tests_radio_button_tests__["a" /* tests */]
}, {
  path: "/ripple",
  name: "Ripple",
  tests: __WEBPACK_IMPORTED_MODULE_19__tests_ripple_tests__["a" /* tests */]
}, {
  path: "/shadow",
  name: "Shadow",
  tests: __WEBPACK_IMPORTED_MODULE_20__tests_shadow_tests__["a" /* tests */]
}, {
  path: "/svg",
  name: "SVG",
  tests: __WEBPACK_IMPORTED_MODULE_21__tests_svg_tests__["a" /* tests */]
}, {
  path: "/switch-button",
  name: "Switch button",
  tests: __WEBPACK_IMPORTED_MODULE_22__tests_switch_button_tests__["a" /* tests */]
}, {
  path: "/tabs",
  name: "Tabs",
  tests: __WEBPACK_IMPORTED_MODULE_23__tests_tabs_tests__["a" /* tests */]
}, {
  path: "/toolbar",
  name: "Toolbar",
  tests: __WEBPACK_IMPORTED_MODULE_24__tests_toolbar_tests__["a" /* tests */]
}, {
  path: "/theme",
  name: "Custom theme",
  tests: __WEBPACK_IMPORTED_MODULE_27__tests_theme_tests__["a" /* tests */]
}, {
  path: "/css",
  name: "CSS tools",
  tests: __WEBPACK_IMPORTED_MODULE_25__tests_css_tests__["a" /* tests */]
}, {
  path: "/css-classes",
  name: "CSS classes",
  tests: __WEBPACK_IMPORTED_MODULE_26__tests_css_classes_tests__["a" /* tests */]
}];
...
var index = {
  ...
  view: function view() {
    return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_3__styles__["a" /* rules */].headerRow, __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_7_polythene_toolbar__["a" /* toolbar */], {
      style: {
        backgroundColor: "rgba(255,255,255,.93)"
      }
    }, __WEBPACK_IMPORTED_MODULE_0_mithril___default()("span", "Polythene components"))), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_5_polythene_list__["a" /* list */], {
      style: {
        padding: "88px 8px 24px 8px"
      }
    }, pages.map(function (link) {
      return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_6_polythene_list_tile__["a" /* listTile */], {
        title: link.name,
        url: {
          href: link.path,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__styles__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__scripts_render__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_polythene_toolbar__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_mmsvg_google_msvg_navigation_arrow_back__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_mmsvg_google_msvg_navigation_arrow_back___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_mmsvg_google_msvg_navigation_arrow_back__);
...
/* harmony default export */ __webpack_exports__["a"] = function (name, tests, previous) {
  return {
    ...
    view: function view() {
      return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1__styles__["a" /* rules */].headerRow, __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_3_polythene_toolbar__["a" /* toolbar */], {
        style: {
          backgroundColor: "rgba(255,255,255,.93)"
        }
      }, [previous && __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_4_polythene_icon_button__["a" /* iconButton */], {
        icon: { msvg: __WEBPACK_IMPORTED_MODULE_6_mmsvg_google_msvg_navigation_arrow_back___default.a },
        url: {
          href: "/",
          oncreate: __WEBPACK_IMPORTED_MODULE_0_mithril___default.a.route.link
        },
      ...
      })), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_5_polythene_dialog__["a" /* dialog */])];
    }
  };
};
...
__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */].theme(".tests-button-themed-button", {
  color_light_background: "#2196F3",
  color_dark_background: "#2196F3",
  color_light_text: "#fff"
});

__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */].theme(".blue-on-dark-button", {
  color_dark_text: "#1976D2"
});

__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */].theme(".tests-button-bordered-button", {
...
var tests = [{
  name: "Option: label",
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */],
  attrs: {
    label: "Label"
  }
}, {
  ...
  component: {
    ...
    view: function view(vnode) {
      return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()("div", "Updated: " + vnode.state.updated), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */], {
        label: "Button",
  ...
  component: {
    ...
    view: function view(vnode) {
      return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()("div", "onclick called: " + vnode.state.clicked), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */], {
        label: "Button",
        events: {
          onclick: function onclick() {
  ...
  component: {
    ...
    view: function view(vnode) {
      return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()("div", "onclick called: " + vnode.state.clickCount), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */], {
        label: "Button",
        events: {
          onclick: function onclick() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_checkbox__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_mmsvg_google_msvg_toggle_star_border__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_mmsvg_google_msvg_toggle_star__ = __webpack_require__(25);
...
__WEBPACK_IMPORTED_MODULE_1_polythene_checkbox__["a" /* checkbox */].theme(".tests-checkbox-themed-checkbox", {
  label_font_size: 28,
...
var sizes = function sizes(_sizes, attrs) {
  return _sizes.map(function (size) {
    return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_checkbox__["a" /* checkbox */], _extends({}, attrs, {
      label: size,
      size: size
    }));
  });
...
var tests = [{
  name: "Option: label",
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_checkbox__["a" /* checkbox */],
  attrs: {
    label: "Label"
  }
}, {
  ...
  component: {
    view: function view() {
      return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_checkbox__["a" /* checkbox */], {
        disabled: true,
        label: "Off"
      }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_checkbox__["a" /* checkbox */], {
        disabled: true,
        checked: true,
        label: "On"
      })];
  ...
  component: {
    ...
    view: function view(vnode) {
      ...
      }, "Checked: " + vnode.state.checked), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_checkbox__["a" /* checkbox */], {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_css_classes__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_css__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__block_styles__ = __webpack_require__(31);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return tests; });
...
__WEBPACK_IMPORTED_MODULE_2_polythene_css__["c" /* styler */].add("css-classes", __WEBPACK_IMPORTED_MODULE_3__block_styles__["a" /* styles */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_button__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_css__ = __webpack_require__(1);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return secondaryButton; });
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
__WEBPACK_IMPORTED_MODULE_2_polythene_css__["c" /* styler */].add("secondary-button", styles);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_button__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_css__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__secondary_button__ = __webpack_require__(33);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return tests; });
...
__WEBPACK_IMPORTED_MODULE_2_polythene_css__["c" /* styler */].add("my-component", myStyle);
...
__WEBPACK_IMPORTED_MODULE_2_polythene_css__["c" /* styler */].add("app-buttons", buttonStyles);
...
__WEBPACK_IMPORTED_MODULE_2_polythene_css__["c" /* styler */].add("app-buttons-x", mixinButtonStyles);
...
var tests = [{
  ...
  component: {
    view: function view() {
      return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */], {
        label: "Send",
        class: "send-button"
      }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */], {
        label: "Info",
  ...
  name: "Custom button",
  component: __WEBPACK_IMPORTED_MODULE_3__secondary_button__["a" /* secondaryButton */],
  attrs: {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_button__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared__ = __webpack_require__(10);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
  ...
  return _extends({}, __WEBPACK_IMPORTED_MODULE_3__shared__["c" /* commonDialogProps */], {
    ...
    formOptions: {
      ...
      onsubmit: function onsubmit(e) {
        ...
        __WEBPACK_IMPORTED_MODULE_1_polythene_dialog__["a" /* dialog */].hide();
        hasValue = false;
      }
    },
    footer: [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_button__["a" /* button */], {
      label: "Cancel",
      events: {
        onclick: function onclick() {
          return __WEBPACK_IMPORTED_MODULE_1_polythene_dialog__["a" /* dialog */].hide();
        }
      }
    }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_button__["a" /* button */], {
      disabled: !hasValue,
      label: "Post",
      element: "button",
      type: "submit"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_button__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_toolbar__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_polythene_icon_button__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_polythene_dialog__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_mmsvg_google_msvg_navigation_close__ = __webpack_require__(77);
...
var fullscreenToolbarRow = function fullscreenToolbarRow(title) {
  return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_3_polythene_icon_button__["a" /* iconButton */], {
    icon: {
      msvg: __WEBPACK_IMPORTED_MODULE_5_mmsvg_google_msvg_navigation_close___default.a
    },
    events: {
      onclick: function onclick() {
        __WEBPACK_IMPORTED_MODULE_4_polythene_dialog__["a" /* dialog */].show(confirmDialogOptsFn, DIALOG_CONFIRM);
      }
    }
  }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()("span.flex", title), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */], {
    label: "Save",
    events: {
      onclick: function onclick() {
        __WEBPACK_IMPORTED_MODULE_4_polythene_dialog__["a" /* dialog */].hide();
      }
    }
  })];
};
...
var fullscreenPanelBlock = {
  view: function view() {
    return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_toolbar__["a" /* toolbar */], {
...
var confirmDialogOptsFn = function confirmDialogOptsFn() {
  return _extends({}, __WEBPACK_IMPORTED_MODULE_6__shared__["c" /* commonDialogProps */], {
    class: "demo-dialog",
    footer: [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */], {
      label: "Cancel",
      events: {
        onclick: function onclick() {
          __WEBPACK_IMPORTED_MODULE_4_polythene_dialog__["a" /* dialog */].hide(DIALOG_CONFIRM);
        }
      }
    }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */], {
      label: "Discard",
...
/* harmony default export */ __webpack_exports__["a"] = _extends({}, __WEBPACK_IMPORTED_MODULE_6__shared__["c" /* commonDialogProps */], {
  body: __WEBPACK_IMPORTED_MODULE_0_mithril___default()(fullscreenPanelBlock),
  fullscreen: true
});
...
var buttons = [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_button__["a" /* button */], {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_mmsvg_google_msvg_action_account_circle__ = __webpack_require__(73);
...
/* harmony default export */ __webpack_exports__["a"] = _extends({}, __WEBPACK_IMPORTED_MODULE_5__shared__["c" /* commonDialogProps */], {
  ...
  menu: __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_3_polythene_list__["a" /* list */], {
    hoverable: true,
    tiles: [1, 2, 3].map(function () {
      return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_4_polythene_list_tile__["a" /* listTile */], {
        class: "demo-item",
        front: __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_icon__["a" /* icon */], {
          type: "large",
...
var dialogTwoOptions = _extends({}, __WEBPACK_IMPORTED_MODULE_3__shared__["c" /* commonDialogProps */], {
  ...
  footer: __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_button__["a" /* button */], {
    ...
    events: {
      onclick: function onclick() {
        return __WEBPACK_IMPORTED_MODULE_1_polythene_dialog__["a" /* dialog */].show(dialogOneOptions);
      }
    }
  })
});
...
var dialogOneOptions = _extends({}, __WEBPACK_IMPORTED_MODULE_3__shared__["c" /* commonDialogProps */], {
  ...
  footer: __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_button__["a" /* button */], {
    ...
    events: {
      onclick: function onclick() {
        return __WEBPACK_IMPORTED_MODULE_1_polythene_dialog__["a" /* dialog */].show(dialogTwoOptions);
      }
    }
  })
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_dialog__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_polythene_list_tile__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared__ = __webpack_require__(10);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var createListTile = function createListTile(title) {
  return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_3_polythene_list_tile__["a" /* listTile */], {
    title: title,
    events: {
      onclick: function onclick() {
        return __WEBPACK_IMPORTED_MODULE_2_polythene_dialog__["a" /* dialog */].hide();
...
/* harmony default export */ __webpack_exports__["a"] = _extends({}, __WEBPACK_IMPORTED_MODULE_4__shared__["c" /* commonDialogProps */], {
  menu: __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_list__["a" /* list */], {
    hoverable: true,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_dialog__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_raised_button__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__fullscreen__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__menu__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__fullwidth__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__form__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__replace__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__settings__ = __webpack_require__(40);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return tests; });
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var btn = function btn(dialogAttrs) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_raised_button__["a" /* raisedButton */], {
    label: label,
    events: { onclick: function onclick() {
        return __WEBPACK_IMPORTED_MODULE_1_polythene_dialog__["a" /* dialog */].show(dialogAttrs);
      } }
  });
};
...
var promiseShownBtn = function promiseShownBtn(dialogAttrs) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_raised_button__["a" /* raisedButton */], {
    label: label,
    events: { onclick: function onclick() {
        return __WEBPACK_IMPORTED_MODULE_1_polythene_dialog__["a" /* dialog */].show(dialogAttrs).then(function (id) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_fab__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_icon__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_mmsvg_google_msvg_action_alarm_add__ = __webpack_require__(22);
...
__WEBPACK_IMPORTED_MODULE_1_polythene_fab__["a" /* fab */].theme(".tests-fab-themed-fab", {
  color_light_background: "#2196F3",
...
var tests = [{
  name: "Child node",
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_fab__["a" /* fab */],
  attrs: null,
  children: __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_icon__["a" /* icon */], { msvg: __WEBPACK_IMPORTED_MODULE_3_mmsvg_google_msvg_action_alarm_add___default.a })
}, {
  name: "Option: icon",
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_fab__["a" /* fab */],
  attrs: {
  ...
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_fab__["a" /* fab */],
  attrs: {
    content: __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_icon__["a" /* icon */], { msvg: __WEBPACK_IMPORTED_MODULE_3_mmsvg_google_msvg_action_alarm_add___default.a })
  }
}, {
  name: "Colored icon",
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_fab__["a" /* fab */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_icon__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_mmsvg_google_msvg_action_favorite_border__ = __webpack_require__(74);
...
__WEBPACK_IMPORTED_MODULE_1_polythene_icon_button__["a" /* iconButton */].theme(".tests-icon-button-themed-icon-button", {
  padding: 32,
...
var tests = [{
  ...
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_icon_button__["a" /* iconButton */],
  attrs: null,
  children: __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_icon__["a" /* icon */], { msvg: __WEBPACK_IMPORTED_MODULE_3_mmsvg_google_msvg_action_favorite_border___default.a })
}, {
  name: "Option: icon",
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_icon_button__["a" /* iconButton */],
  attrs: {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_icon__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_svg__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_mmsvg_google_msvg_action_stars__ = __webpack_require__(18);
...
__WEBPACK_IMPORTED_MODULE_1_polythene_icon__["a" /* icon */].theme(".tests-icon-themed-icon", {
  size_regular: 50,
  color_light: "purple"
});
...
var tests = [{
  ...
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_icon__["a" /* icon */],
  attrs: null,
  children: __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_svg__["a" /* svg */], [__WEBPACK_IMPORTED_MODULE_3_mmsvg_google_msvg_action_stars___default.a])
}, {
  name: "Option: content",
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_icon__["a" /* icon */],
  attrs: {
...
__WEBPACK_IMPORTED_MODULE_1_polythene_list_tile__["a" /* listTile */].theme(".tests-list-tile-themed-list-tile", {
...
var tests = [{
  name: "Child node",
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_list_tile__["a" /* listTile */],
  attrs: null,
  children: __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_icon__["a" /* icon */], { msvg: __WEBPACK_IMPORTED_MODULE_3_mmsvg_google_msvg_action_stars___default.a })
}, {
  name: "Option: title",
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_list_tile__["a" /* listTile */],
  attrs: {
  ...
  attrs: {
    title: "Ancillary Justice",
    content: __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_icon__["a" /* icon */], { msvg: __WEBPACK_IMPORTED_MODULE_3_mmsvg_google_msvg_action_stars___default.a })
  }
}, {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_list__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_list_tile__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_polythene_icon__ = __webpack_require__(5);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return tests; });
...
__WEBPACK_IMPORTED_MODULE_1_polythene_list__["a" /* list */].theme(".tests-lists-themed-list", {
...
__WEBPACK_IMPORTED_MODULE_2_polythene_list_tile__["a" /* listTile */].theme(".tests-lists-themed-list-tile", {
...
var listTileJennifer = __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_list_tile__["a" /* listTile */], {
  title: "Jennifer Barker",
  subtitle: "Starting post doc",
  front: __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_3_polythene_icon__["a" /* icon */], {
    src: "http://arthurclemens.github.io/assets/polythene/examples/avatar-1.png",
    avatar: true,
    type: "large"
  }),
...
var listTileAli = __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_list_tile__["a" /* listTile */], {
  title: "Ali Connors",
...
var tests = [{
  name: "Child nodes",
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_list__["a" /* list */],
  attrs: {
    borders: true
  },
  children: [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_list_tile__["a" /* listTile */], {
    title: "Jennifer Barker",
    subtitle: "Starting post doc"
  }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_list_tile__["a" /* listTile */], {
    title: "Ali Connors",
    subtitle: "Brunch this weekend?"
  })]
}, {
  ...
  attrs: {
    borders: true,
    tiles: [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_list_tile__["a" /* listTile */], {
      title: "Jennifer Barker",
      subtitle: "Starting post doc"
    }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_list_tile__["a" /* listTile */], {
      title: "Ali Connors",
  ...
  component: {
    view: function view() {
      return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_list__["a" /* list */], {
        header: {
          title: "Friends"
        },
        borders: true,
        tiles: [listTileJennifer, listTileAli]
      }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_list__["a" /* list */], {
        header: {
          title: "Friends"
        },
        borders: true,
  ...
  attrs: {
    ...
    tiles: [listTileJennifer, __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_list_tile__["a" /* listTile */], {
      title: "Ali Connors",
      subtitle: "Brunch this weekend?",
      front: __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_3_polythene_icon__["a" /* icon */], {
        src: "http://arthurclemens.github.io/assets/polythene/examples/avatar-2.png",
  ...
  attrs: {
    ...
    tiles: [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_list_tile__["a" /* listTile */], { style: { color: "#fff" }, title: "One" }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_list_tile__["a" /* listTile */], { style: { color: "#fff" }, title: "Two" }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_list_tile__["a" /* listTile */], { style: { color: "#fff" }, title: "Three" })],
    style: {
      backgroundColor: "#EF6C00",
      color: "#fff"
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_menu__ = __webpack_require__(12);
...
/* harmony default export */ __webpack_exports__["a"] = {
  view: function view() {
    return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_menu__["a" /* menu */], {
      size: 5,
      permanent: true,
      content: [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_list__["a" /* list */], {
        compact: true,
        hoverable: true,
        tiles: [tile("Bold", "\u2318B"), tile("Italic", "\u2318I"), tile("Underline", "\u2318U"), tile("Strikethrough", "Alt+Shift+5"), tile("Superscript", "\u2318."), tile("Subscript", "\u2318,")]
      }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_list__["a" /* list */], {
        compact: true,
        hoverable: true,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_list__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_polythene_list_tile__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_polythene_shadow__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_polythene_icon_button__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_mmsvg_google_msvg_navigation_more_vert__ = __webpack_require__(79);
...
var positionContainer = {
  ...
  view: function view(vnode) {
    ...
    }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(".bar-row.pe-dark-theme.layout.horizontal", [vnode.attrs.buttonPosition === "right" ? __WEBPACK_IMPORTED_MODULE_0_mithril___default()(".flex") : null, __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_5_polythene_icon_button__["a" /* iconButton */], {
      id: vnode.attrs.id,
      icon: {
...
/* harmony default export */ __webpack_exports__["a"] = {
  view: function view() {
    return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_raised_button__["a" /* raisedButton */], {
      ...
      events: {
        onclick: function onclick() {
          return __WEBPACK_IMPORTED_MODULE_1_polythene_dialog__["a" /* dialog */].show(settingsMenuDialog);
        }
      }
    });
  }
...
/* harmony default export */ __webpack_exports__["a"] = {
  ...
  view: function view(vnode) {
    return __WEBPACK_IMPORTED_MODULE_0_mithril___default()("div", {
    ...
    }, [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_menu__["a" /* menu */], {
      ...
      tiles: [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_3_polythene_list_tile__["a" /* listTile */], {
        id: vnode.state.id,
      ...
      }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_3_polythene_list_tile__["a" /* listTile */], {
        title: "Item 2",
        disabled: true
      }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_3_polythene_list_tile__["a" /* listTile */], {
        title: "Item 3",
...
var simpleMenuContent = __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_3_polythene_list__["a" /* list */], [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_4_polythene_list_tile__["a" /* listTile */], {
  title: "Yes",
  ink: true
}), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_4_polythene_list_tile__["a" /* listTile */], {
  title: "No",
  ink: true
})]);
...
/* harmony default export */ __webpack_exports__["b"] = {
  ...
  view: function view(vnode) {
    return __WEBPACK_IMPORTED_MODULE_0_mithril___default()("div", {
      style: { position: "relative" }
    }, [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_raised_button__["a" /* raisedButton */], {
      label: "Open menu",
      id: vnode.state.id,
      events: {
        onclick: function onclick() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_list__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_polythene_list_tile__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__simple__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__sizes__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__menu_items__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__settings_dialog__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__position__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__settings__ = __webpack_require__(50);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return tests; });
...
__WEBPACK_IMPORTED_MODULE_1_polythene_menu__["a" /* menu */].theme(".menu-tests-blue-menu", {
  color_light_background: themeColor,
  border_radius: "5px"
});
__WEBPACK_IMPORTED_MODULE_3_polythene_list_tile__["a" /* listTile */].theme(".menu-tests-blue-menu-list-tile", {
  color_light_title: "#fff",
  color_light_background: themeColor
});

var themedSimpleMenuContent = __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_list__["a" /* list */], [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_3_polythene_list_tile__["a" /* listTile */], {
  title: "Yes",
  ink: true,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_radio_button__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_mmsvg_google_msvg_toggle_star_border__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_mmsvg_google_msvg_toggle_star_border___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_mmsvg_google_msvg_toggle_star_border__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_mmsvg_google_msvg_toggle_star__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_mmsvg_google_msvg_toggle_star___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_mmsvg_google_msvg_toggle_star__);
...
__WEBPACK_IMPORTED_MODULE_1_polythene_radio_button__["a" /* radioButton */].theme(".tests-radio-button-themed-radio", {
  label_font_size: 28,
  color_light_on: "#2196F3",
  color_light_off: "#2196F3",
  color_dark_on: "#2196F3",
...
var group = function group(attrs1) {
  ...
  return {
    view: function view() {
      return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_radio_button__["a" /* radioButton */], _extends({}, attrs1, {
        name: name
      })), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_radio_button__["a" /* radioButton */], _extends({}, attrs2, {
        name: name
      }))];
    }
  };
...
var radioGroup = {
  view: function view() {
    return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_radio_button__["a" /* radioButton */], {
      name: "setting",
      label: "Label"
    }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_radio_button__["a" /* radioButton */], {
      name: "setting",
      label: "Label",
      checked: true
    })];
  ...
  component: {
    view: function view() {
      return __WEBPACK_IMPORTED_MODULE_0_mithril___default()("div", sizeNames.map(function (size) {
        ...
        }, [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_radio_button__["a" /* radioButton */], options), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_radio_button__["a" /* radioButton */], options)]);
      }));
    }
  }
}, {
...

{
  ...
  component: {
    view: function view() {
      ...
      }, "On desktop, TAB can be used to give focus, ENTER to select."), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_radio_button__["a" /* radioButton */], options), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_radio_button__["a" /* radioButton */], options)];
    }
  }
}, {
  name: "Option: disabled",
  ...
  component: {
    ...
    view: function view(vnode) {
      ...
      }, "Value: " + vnode.state.radio.value), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_radio_button__["a" /* radioButton */], options("First", "first")), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_radio_button__["a" /* radioButton */], options("Second", "second"))];
    }
  }
}, {
  name: "Setting the value from outside",
  ...
  component: {
    ...
    view: function view(vnode) {
      ...
      }, "Value: " + vnode.state.value), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_radio_button__["a" /* radioButton */], options("First", "first")), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_radio_button__["a" /* radioButton */], options("Second", "second"))];
    }
  }
},
...
__WEBPACK_IMPORTED_MODULE_1_polythene_raised_button__["a" /* raisedButton */].theme(".tests-raised-button-themed-button", {
...
var tests = [{
  name: "Option: label",
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_raised_button__["a" /* raisedButton */],
  attrs: {
    label: "Label"
  }
}, {
  ...
  component: {
    ...
    view: function view(vnode) {
      return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()("div", "onclick called: " + vnode.state.clicked), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_raised_button__["a" /* raisedButton */], {
        label: "Button",
        events: {
          onclick: function onclick() {
            return vnode.state.clicked++;
...
__WEBPACK_IMPORTED_MODULE_1_polythene_ripple__["a" /* ripple */].theme(".tests-ripple-themed-ripple", {
  color_light: "#F44336"
});
...
var tests = [{
  ...
  interactive: true,
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_ripple__["a" /* ripple */],
  attrs: {
    constrained: true
  }
}, {
  ...
  component: {
    view: function view() {
      ...
      }, __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_ripple__["a" /* ripple */]));
    }
  }
}, {
  ...
  component: {
    ...
    view: function view(vnode) {
      return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_ripple__["a" /* ripple */], {
...
var interactiveTest = {
  ...
  view: function view(vnode) {
    ...
    }, "Click me"), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_shadow__["a" /* shadow */], {
      animated: true,
      z: vnode.state.z
    })];
  }
...
var tests = [{
  name: "Child node",
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_shadow__["a" /* shadow */],
  attrs: {},
  children: ["Child"]
}, {
  name: "Option: content",
  ...
  component: {
    view: function view() {
      return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()("div", "Some element"), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_shadow__["a" /* shadow */])];
    }
  }
}, {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_svg__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_mmsvg_google_msvg_action_stars__ = __webpack_require__(18);
...
var tests = [{
  ...
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_svg__["a" /* svg */],
  attrs: null,
  children: [trustedSvg]
}, {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_switch_button__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_icon__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_mmsvg_templarian_msvg_bullseye__ = __webpack_require__(82);
...
__WEBPACK_IMPORTED_MODULE_1_polythene_switch_button__["a" /* switchButton */].theme(".tests-switch-themed-switch", {
  label_font_size: 28,
  color_light_thumb_on: "#2196F3",
  color_dark_thumb_on: "#2196F3"
});

__WEBPACK_IMPORTED_MODULE_1_polythene_switch_button__["a" /* switchButton */].theme(".tests-switch-themed-icon", {
...
var sizes = function sizes(_sizes, attrs) {
  return _sizes.map(function (size) {
    ...
    }, __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_switch_button__["a" /* switchButton */], _extends({}, attrs, {
      label: size,
      size: size
    })));
  });
...
var tests = [{
  name: "No options",
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_switch_button__["a" /* switchButton */],
  attrs: null
}, {
  name: "Option: label",
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_switch_button__["a" /* switchButton */],
  ...
  component: {
    view: function view() {
      return __WEBPACK_IMPORTED_MODULE_0_mithril___default()("div", sizes(sizeNames, {
        ...
        icon: __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_icon__["a" /* icon */], {
  ...
  component: {
    view: function view() {
      return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_switch_button__["a" /* switchButton */], {
        disabled: true,
        label: "Off"
      }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_switch_button__["a" /* switchButton */], {
        disabled: true,
        checked: true,
        label: "On"
      })];
  ...
  component: {
    ...
    view: function view(vnode) {
      ...
      }, "Checked: " + vnode.state.checked), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_switch_button__["a" /* switchButton */], {
        getState: function getState(state) {
          return vnode.state.checked = state.checked;
        }
      })];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_tabs__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_mmsvg_templarian_msvg_heart__ = __webpack_require__(83);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_mmsvg_templarian_msvg_bell__ = __webpack_require__(81);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_mmsvg_templarian_msvg_settings__ = __webpack_require__(84);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_mmsvg_google_msvg_navigation_arrow_back__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_mmsvg_google_msvg_navigation_arrow_forward__ = __webpack_require__(76);
...
__WEBPACK_IMPORTED_MODULE_1_polythene_tabs__["a" /* tabs */].theme(".tests-tabs-fixed-width", {
  tab_max_width: 110,
  tab_min_width: 110
});

__WEBPACK_IMPORTED_MODULE_1_polythene_tabs__["a" /* tabs */].theme(".tests-tabs-custom_color", {
  color_light: "#00BCD4",
...
var tests = [{
  name: "Child node",
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_tabs__["a" /* tabs */],
  attrs: null,
  ...
  component: {
    view: function view() {
      ...
      }, __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_tabs__["a" /* tabs */], {
        buttons: longList,
        scrollable: true
      }));
    }
  ...
  component: {
    ...
    view: function view(vnode) {
      ...
      }, [__WEBPACK_IMPORTED_MODULE_0_mithril___default()("li", "" + vnode.state.tab.index), __WEBPACK_IMPORTED_MODULE_0_mithril___default()("li", "" + JSON.stringify(vnode.state.tab.data))]), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_tabs__["a" /* tabs */], {
        buttons: threeButtons,
        autofit: true,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_button__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_fab__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_polythene_icon__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_polythene_icon_button__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_polythene_list__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_polythene_list_tile__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_mmsvg_google_msvg_action_alarm_add__ = __webpack_require__(22);
...
__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */].theme(".tests-custom-theme-blue-button", {
  color_light_background: "#2196F3",
  color_light_text: "#fff"
});

__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */].theme(".tests-custom-theme-red-button", {
  color_light_background: "#ff0000",
  color_light_text: "#fff"
});

__WEBPACK_IMPORTED_MODULE_3_polythene_icon__["a" /* icon */].theme(".tests-custom-theme-red-icon", {
  color_light: "red"
});

__WEBPACK_IMPORTED_MODULE_2_polythene_fab__["a" /* fab */].theme(".tests-custom-theme-red-fab", {
  color_light_background: "#ff0000",
  color_light: "#fff"
});

__WEBPACK_IMPORTED_MODULE_4_polythene_icon_button__["a" /* iconButton */].theme(".tests-custom-theme-large-icon-button", {
  padding: 50,
  color_background: "#fff"
});

__WEBPACK_IMPORTED_MODULE_5_polythene_list__["a" /* list */].theme(".tests-custom-theme-blue-list", {
  color_light_border: "#2196F3"
});

__WEBPACK_IMPORTED_MODULE_6_polythene_list_tile__["a" /* listTile */].theme(".tests-custom-theme-red-list-tile", {
...
var secondaryButton = {
  theme: __WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */].theme,
  view: function view(vnode) {
    return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_button__["a" /* button */], _extends({
...
var tests = [{
  ...
  component: __WEBPACK_IMPORTED_MODULE_2_polythene_fab__["a" /* fab */],
  attrs: {
    icon: {
  ...
  component: __WEBPACK_IMPORTED_MODULE_3_polythene_icon__["a" /* icon */],
  attrs: {
  ...
  component: __WEBPACK_IMPORTED_MODULE_4_polythene_icon_button__["a" /* iconButton */],
  attrs: {
  ...
  component: __WEBPACK_IMPORTED_MODULE_5_polythene_list__["a" /* list */],
  attrs: {
    class: "tests-custom-theme-blue-list",
    borders: true,
    tiles: [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_6_polythene_list_tile__["a" /* listTile */], {
      title: "Jennifer Barker",
      subtitle: "Starting post doc"
    }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_6_polythene_list_tile__["a" /* listTile */], {
      title: "Ali Connors",
      subtitle: "Brunch this weekend?"
    }), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_6_polythene_list_tile__["a" /* listTile */], {
      title: "Mike Eden",
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_toolbar__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_icon_button__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_polythene_shadow__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_mmsvg_google_msvg_navigation_menu__ = __webpack_require__(78);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_mmsvg_google_msvg_navigation_refresh__ = __webpack_require__(80);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_mmsvg_google_msvg_content_add__ = __webpack_require__(75);
...
__WEBPACK_IMPORTED_MODULE_1_polythene_toolbar__["a" /* toolbar */].theme(".tests-toolbar-themed-toolbar", {
  color_dark_background: "#00c853"
});

var btn = function btn(msvg) {
  return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_icon_button__["a" /* iconButton */], {
    icon: { msvg: msvg }
  });
};
...
var tests = [{
  name: "Child node",
  component: __WEBPACK_IMPORTED_MODULE_1_polythene_toolbar__["a" /* toolbar */],
  attrs: null,
  children: toolbarRow
}, {
  name: "Option: content",
  ...
  component: {
    view: function view() {
      ...
      }, [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1_polythene_toolbar__["a" /* toolbar */], toolbarRow), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_3_polythene_shadow__["a" /* shadow */])]);
    }
  }
}, {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_selection_control__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_css__ = __webpack_require__(1);
...
var color$1 = (function (selector, componentVars) {
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_polythene_selection_control__["c" /* color */])(selector, componentVars);
});
...
var customTheme = function customTheme(customSelector, customVars) {
  return __WEBPACK_IMPORTED_MODULE_2_polythene_css__["c" /* styler */].generateStyles([customSelector, selector], _extends$1({}, __WEBPACK_IMPORTED_MODULE_1_polythene_selection_control__["a" /* vars */], customVars), fns);
};

__WEBPACK_IMPORTED_MODULE_2_polythene_css__["c" /* styler */].generateStyles([selector], __WEBPACK_IMPORTED_MODULE_1_polythene_selection_control__["a" /* vars */], fns);
...
__WEBPACK_IMPORTED_MODULE_0_polythene_css__["c" /* styler */].add("pe-layout", flex$1, commonStyle);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_fastclick__ = __webpack_require__(68);
...
if (__WEBPACK_IMPORTED_MODULE_1_polythene_core__["i" /* isTouch */]) {
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_polythene_core__["e" /* subscribe */])("scroll", handleScroll, THROTTLE_DELAY);
  add();
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_webfontloader__ = __webpack_require__(87);
...
__WEBPACK_IMPORTED_MODULE_0_polythene_css__["c" /* styler */].add("pe-theme", reset, typography, roboto);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_polythene_css__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_polythene_theme__ = __webpack_require__(2);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return switchButton; });
/* unused harmony export classes */
...
var controlView = function controlView(checked, attrs) {
  ...
  return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()("div", {
    ...
    }, [attrs.icon ? attrs.icon : null, raised ? __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_2_polythene_shadow__["a" /* shadow */], {
      z: z,
      animated: true
    }) : null])],
    style: attrs.style,
...
var transition = function transition(componentVars, properties) {
  ...
  return [__WEBPACK_IMPORTED_MODULE_4_polythene_css__["b" /* mixin */].defaultTransition(properties, duration, "ease-out")];
};
...
var layout$1 = (function (selector, componentVars) {
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_polythene_selection_control__["b" /* layout */])(selector, componentVars, "checkbox").concat([_defineProperty({}, selector, {
    ...
    " .pe-button__content .pe-switch-control__knob .pe-icon": [__WEBPACK_IMPORTED_MODULE_4_polythene_css__["b" /* mixin */].fit(), transition(componentVars, "color"), {
      width: "100%",
      height: "100%"
    }],
...
var color$1 = (function (selector, componentVars) {
  return [__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_polythene_selection_control__["c" /* color */])(selector, componentVars)].concat([style("", selector, componentVars, "light"), style(".pe-dark-theme ", selector, componentVars, "dark") // inside dark theme
  ]);
});
...
var customTheme = function customTheme(customSelector, customVars) {
  return __WEBPACK_IMPORTED_MODULE_4_polythene_css__["c" /* styler */].generateStyles([customSelector, selector], _extends$2({}, vars$3, customVars), fns);
};

__WEBPACK_IMPORTED_MODULE_4_polythene_css__["c" /* styler */].generateStyles([selector], vars$3, fns);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polythene_core__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_polythene_utilities__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_polythene_css__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_polythene_theme__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_polythene_icon__ = __webpack_require__(5);
...
var layout = (function (selector, componentVars) {
  return [_defineProperty({}, selector, [__WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].vendorize({
    ...
    " .pe-tabs__row": [__WEBPACK_IMPORTED_MODULE_3_polythene_css__["a" /* flex */].layoutHorizontal, __WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].vendorize({
      userSelect: "none"
    }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["a" /* vars */].prefixes_user_select), {
      position: "relative",
      whiteSpace: "nowrap",
    ...
    " .pe-tabs__tab": [__WEBPACK_IMPORTED_MODULE_3_polythene_css__["a" /* flex */].flex(), __WEBPACK_IMPORTED_MODULE_3_polythene_css__["a" /* flex */].flexIndex("none"), __WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].vendorize({
      userSelect: "none"
    }, __WEBPACK_IMPORTED_MODULE_4_polythene_theme__["a" /* vars */].prefixes_user_select), __WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].defaultTransition("color"), {
      margin: 0,
      borderRadius: 0,
      ...
      ".pe-text-button .pe-button__content": {
        ...
        " .pe-button__label": [__WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].defaultTransition("opacity", componentVars.animation_duration), {
    ...
    " .pe-toolbar--tabs .pe-toolbar__bar &": [__WEBPACK_IMPORTED_MODULE_3_polythene_css__["b" /* mixin */].fit(), {
      width: "auto",
      margin: 0,
      top: "auto"
    }]
...
var customTheme = function customTheme(customSelector, customVars) {
  return __WEBPACK_IMPORTED_MODULE_3_polythene_css__["c" /* styler */].generateStyles([customSelector, selector], _extends$1({}, vars$3, customVars), fns);
};

__WEBPACK_IMPORTED_MODULE_3_polythene_css__["c" /* styler */].generateStyles([selector], vars$3, fns);
...
var view$1 = function view(vnode) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_5_polythene_button__["a" /* button */], tabButtonOptions);
};
...
var view$2 = function view(vnode) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_6_polythene_icon_button__["a" /* iconButton */], {
...
var view = function view(vnode) {
  ...
  var props = _extends({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_polythene_core__["d" /* filterSupportedAttributes */])(attrs), {
    ...
    oninit: function oninit() {
      return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_polythene_core__["e" /* subscribe */])("resize", onResize);
    },
    oncreate: function oncreate(vnode) {
    ...
    onremove: function onremove() {
      return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_polythene_core__["c" /* unsubscribe */])("resize", onResize);
    }
  });
