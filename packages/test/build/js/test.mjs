...
import { button, ripple, shadow, svg, webfontLoader } from 'polythene';
...
var tests$4 = [{
  ...
  component: {
    view: function view() {
      return [m("div", "Some element"), m(component$3)];
    }
  }
}, {
  ...
  component: {
    ...
    view: function view(vnode) {
      return [m(rules.content, "Click me"), m(component$3, {
        animated: true,
        z: vnode.state.z
      })];
    }
