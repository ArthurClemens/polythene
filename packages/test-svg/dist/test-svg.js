(function (global, factory) {
  ...
  var genericTests = (function (_ref) {
    ...
    polytheneCss.SVGCSS.addStyle(".tests-svg-themed-svg", {
      color_light: "#0D47A1",
      color_dark: "orange"
    });
  ...
  var testsMithril = [].concat(genericTests({ SVG: polytheneMithril.SVG, renderer: polytheneMithril.renderer })).concat(mithrilTests({ SVG: polytheneMithril.SVG, renderer: polytheneMithril.renderer }));
    ...
    return [{
      ...
      component: function component() {
        return h("div", {
          ...
          className: "pe-light-tone"
        }, h(SVG, { content: h.trust(iconStars$2) }));
      }
    }, {
      name: "Dark tone class + light tone",
      className: "test-dark-tone",
      ...
      component: function component() {
        return react.createElement(SVG, { content: iconStarsSVG });
      }
    }, {
      ...
      component: function component() {
        return react.createElement(SVG, { content: iconStarsSVG, style: { color: "#EF6C00" } });
      }
    }];
  };

  var testsReact = [].concat(genericTests({ SVG: polytheneReact.SVG, renderer: polytheneReact.renderer })).concat(reactTests({ SVG: polytheneReact.SVG, renderer: polytheneReact.renderer }));
