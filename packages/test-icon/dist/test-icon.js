(function (global, factory) {
  ...
  var genericTests = (function (_ref) {
    ...
    polytheneCss.IconCSS.addStyle(".tests-icon-themed-icon", {
      size_regular: 50,
      color_light: "purple",
      color_dark: "orange"
    });
    ...
    var sizes = function sizes(_sizes, attrs) {
      return _sizes.map(function (size) {
        return h(Icon, _extends({}, attrs, { size: size }));
      });
    };
  ...
  var testsMithril = [].concat(genericTests({ Icon: polytheneMithril.Icon, SVG: polytheneMithril.SVG, renderer: polytheneMithril.renderer })).concat(mithrilTests({ Icon: polytheneMithril.Icon, SVG: polytheneMithril.SVG, renderer: polytheneMithril.renderer }));
  ...
  */
  ...
  var reactTests = function reactTests(_ref) {
    ...
    return [{
      ...
      component: function component() {
        return react.createElement(Icon, { svg: { content: iconStarsSVG } });
      }
    }, {
  ...
  var testsReact = [].concat(genericTests({ Icon: polytheneReact.Icon, SVG: polytheneReact.SVG, renderer: polytheneReact.renderer })).concat(reactTests({ Icon: polytheneReact.Icon, SVG: polytheneReact.SVG, renderer: polytheneReact.renderer }));
...
//# sourceMappingURL=test-icon.js.map
