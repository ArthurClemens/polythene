(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('polythene-core-css'), require('polythene-css'), require('polythene-mithril'), require('polythene-react')) :
  typeof define === 'function' && define.amd ? define(['exports', 'polythene-core-css', 'polythene-css', 'polythene-mithril', 'polythene-react'], factory) :
  (factory((global.polythene = {}),global['polythene-core-css'],global['polythene-css'],global['polythene-mithril'],global['polythene-react']));
}(this, (function (exports,polytheneCoreCss,polytheneCss,polytheneMithril,polytheneReact) { 'use strict';
    ...
    return {
      view: function view() {
        return h("div", null, [1.5, 2, 3, 4, 5, 6, 7, "auto"].map(function (size) {
          return createSizedMenu({ size: size, Menu: Menu, List: List, ListTile: ListTile, h: h });
        }));
      }
    };
  });
  ...
  polytheneCoreCss.styler.add("test-menu-position", styles);
  ...
  var createPositionContainer = function createPositionContainer(_ref) {
    ...
    return {
      ...
      view: function view(vnode) {
        ...
        var show = state.show();
        return h(".position-container.layout.vertical", { key: attrs.id }, [vnode.attrs.barPosition === "bottom" ? h(".flex") : null, h(".bar", [h(Shadow, { z: 1 }), h(Menu, {
        ...
        }), h(".bar-row.pe-dark-tone.layout.horizontal", [attrs.buttonPosition === "right" ? h(".flex") : null, h(IconButton, {
          id: attrs.id,
  ...
  var position = (function (_ref2) {
    ...
    var PositionContainer = createPositionContainer({ h: h, k: k, Menu: Menu, List: List, ListTile: ListTile, Shadow: Shadow, IconButton: IconButton });
    return {
      view: function view() {
  ...
  var themed = (function (_ref) {
    ...
    polytheneCss.MenuCSS.addStyle(".menu-tests-blue-menu", {
      color_dark_background: themeColor,
      border_radius: 6
    });
    polytheneCss.ListTileCSS.addStyle(".menu-tests-blue-menu-list-tile", {
      color_light_title: "#fff",
      color_light_background: themeColor
    });

    var themedList = h(List, [h(ListTile, {
      title: "Yes",
      ink: true,
    ...
    var styledList = h(List, [h(ListTile, {
      title: "Yes",
      ink: true,
      style: {
  ...
  var transitions = (function (_ref) {
    var show = _ref.show,
        ...
        getState = _ref.getState,
        transitionOptions = _ref.transitionOptions;
    return h(Menu, _extends$3({}, transitionOptions, {
      target: target,
      show: show,
      didHide: didHide,
      getState: getState,
  ...
  var genericTests = (function (_ref) {
    ...
    var _themed = themed({ renderer: renderer, Menu: Menu, List: List, ListTile: ListTile }),
    ...
    return [{
      name: "Menu items",
      component: menuItems({ renderer: renderer, Menu: Menu, List: List, ListTile: ListTile })
    }, {
      ...
      interactive: true,
      exclude: true,
      component: opener({ renderer: renderer, keys: keys, Menu: Menu, RaisedButton: RaisedButton, List: List, ListTile: ListTile, menuFn: simple, id: "simple" })
    }, {
      name: "Positioning",
      interactive: true,
      exclude: true,
      component: position({ renderer: renderer, keys: keys, Menu: Menu, List: List, ListTile: ListTile, Shadow: Shadow, IconButton: IconButton })
    }, {
      name: "Change setting and reposition according to selected item",
      interactive: true,
      exclude: true,
      component: settings({ renderer: renderer, keys: keys, Menu: Menu, List: List, ListTile: ListTile })
    }, {
      ...
      interactive: true,
      exclude: true,
      component: opener({ renderer: renderer, keys: keys, Menu: Menu, RaisedButton: RaisedButton, List: List, ListTile: ListTile, menuFn: transitions, id: "transitions",
        transitionOptions: {
          transitions: {
      ...
      interactive: true,
      exclude: true,
      component: opener({ renderer: renderer, keys: keys, Menu: Menu, RaisedButton: RaisedButton, List: List, ListTile: ListTile, menuFn: transitions, id: "showDelay",
        transitionOptions: {
          showDelay: .4,
          hideDelay: .4,
          showDuration: 1.0,
      ...
      name: "Option: size",
      component: sizes({ renderer: renderer, Menu: Menu, List: List, ListTile: ListTile })
    }];
  });
  ...
  var mithrilTests = function mithrilTests(_ref) {
    ...
    var settingsDialogOptions = settingsDialog({ renderer: polytheneMithril.renderer, keys: polytheneMithril.keys, Dialog: polytheneMithril.Dialog, Menu: Menu, List: List, ListTile: ListTile });
    ...
    return [{
      ...
      component: {
        view: function view() {
          return h(polytheneMithril.RaisedButton, {
            label: "Open",
            events: {
              onclick: function onclick() {
                return polytheneMithril.Dialog.show(settingsDialogOptions);
              }
            }
          });
        }
      ...
      interactive: true,
      exclude: true,
      component: opener({ renderer: polytheneMithril.renderer, keys: polytheneMithril.keys, Menu: Menu, RaisedButton: polytheneMithril.RaisedButton, List: List, ListTile: ListTile, menuFn: links, id: "links" })
    }];
  };

  var testsMithril = [].concat(genericTests({ Menu: polytheneMithril.Menu, List: polytheneMithril.List, ListTile: polytheneMithril.ListTile, RaisedButton: polytheneMithril.RaisedButton, Shadow: polytheneMithril.Shadow, IconButton: polytheneMithril.IconButton, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys })).concat(mithrilTests({ Menu: polytheneMithril.Menu, List: polytheneMithril.List, ListTile: polytheneMithril.ListTile, RaisedButton: polytheneMithril.RaisedButton, Shadow: polytheneMithril.Shadow, IconButton: polytheneMithril.IconButton, renderer: polytheneMithril.renderer, keys: polytheneMithril.keys }));
  ...
  */
  ...
  var warning$3 = emptyFunction_1$1;
  ...
  var _typeof$6 = typeof Symbol === "function" && _typeof2(Symbol.iterator) === "symbol" ? function (obj) {
  ...
  function valueEqual(a, b) {
    ...
    var aType = typeof a === 'undefined' ? 'undefined' : _typeof$6(a);
    var bType = typeof b === 'undefined' ? 'undefined' : _typeof$6(b);
  ...
  var _typeof$14 = typeof Symbol === "function" && _typeof2$3(Symbol.iterator) === "symbol" ? function (obj) {
  ...
  var NavLink = function NavLink(_ref) {
    ...
    return react.createElement(Route, {
      path: (typeof to === 'undefined' ? 'undefined' : _typeof$14(to)) === 'object' ? to.pathname : to,
      exact: exact,
      strict: strict,
      location: location,
  ...
  var _typeof$16 = typeof Symbol === "function" && _typeof2$4(Symbol.iterator) === "symbol" ? function (obj) {
  ...
  var _typeof$17 = typeof Symbol === "function" && _typeof2$5(Symbol.iterator) === "symbol" ? function (obj) {
  ...
  var StaticRouter = function (_React$Component) {
    ...
    StaticRouter.prototype.render = function render() {
      ...
      return react.createElement(Router, _extends$13({}, props, { history: history }));
    };
  ...
  var _class = function (_Component) {
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        ...
        return polytheneReact.renderer("div", { style: { position: "relative" } }, [polytheneReact.renderer(polytheneReact.RaisedButton, {
          label: "Open menu",
          id: target,
          events: {
            onClick: function onClick() {
        ...
        }), polytheneReact.renderer(polytheneReact.Menu, {
          target: "#" + target,
          show: isOpen,
          size: 2,
          didHide: function didHide() {
        ...
        }, polytheneReact.renderer(polytheneReact.List, [polytheneReact.renderer(polytheneReact.ListTile, { title: "Yes", key: "yes", ink: true, hoverable: true }), polytheneReact.renderer(polytheneReact.ListTile, { title: "No", key: "no", ink: true, hoverable: true })]))]);
      }
    }]);
        ...
        return react.createElement(
          ...
          react.createElement(
            ...
            react.createElement(
              polytheneReact.List,
              null,
              react.createElement(polytheneReact.ListTile, { title: "Yes", ink: true, hoverable: true }),
              react.createElement(polytheneReact.ListTile, { title: "No", ink: true, hoverable: true })
            )
          )
        );
      }
  ...
  var Tile = function Tile(_ref) {
    ...
    return react.createElement(polytheneReact.ListTile, {
      title: title,
      selected: selected,
      disabled: disabled,
      ink: true,
  ...
  var dialogOptions = {
    menu: react.createElement(polytheneReact.List, {
      hoverable: true,
  ...
  var SettingsJSX = (function () {
    return react.createElement(polytheneReact.RaisedButton, {
      ...
      events: {
        onClick: function onClick() {
          return polytheneReact.Dialog.show(dialogOptions);
        }
      }
    });
  });
    ...
    _createClass$2(_class, [{
      ...
      value: function render() {
        ...
        return polytheneReact.renderer("div", { style: { position: "relative" } }, [polytheneReact.renderer(polytheneReact.RaisedButton, {
          ...
          show: isOpen,
          size: 5,
          content: polytheneReact.renderer(polytheneReact.List, {
            all: {
              element: Link,
              ink: true,
              hoverable: true
  ...
  var reactTests = function reactTests(_ref) {
    ...
    var Tile = function Tile(left, right) {
      ...
      return react.createElement(ListTile, {
        key: left,
        title: left,
        secondary: { content: right },
        hoverable: true,
  ...
  var testsReact = [].concat(genericTests({ Menu: polytheneReact.Menu, List: polytheneReact.List, ListTile: polytheneReact.ListTile, RaisedButton: polytheneReact.RaisedButton, Shadow: polytheneReact.Shadow, IconButton: polytheneReact.IconButton, renderer: polytheneReact.renderer, keys: polytheneReact.keys })).concat(reactTests({ Menu: polytheneReact.Menu, List: polytheneReact.List, ListTile: polytheneReact.ListTile, RaisedButton: polytheneReact.RaisedButton, Shadow: polytheneReact.Shadow, IconButton: polytheneReact.IconButton, renderer: polytheneReact.renderer, keys: polytheneReact.keys }));
