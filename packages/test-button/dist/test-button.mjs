...
import { renderer as renderer$1, Button as Button$1 } from 'polythene-react';
...
var reactTests = function reactTests(_ref) {
  ...
  var SecondaryButton = function SecondaryButton(props) {
    return react.createElement(Button$$1, _extends$8({ className: "react-secondary-button", border: true }, props));
  };
