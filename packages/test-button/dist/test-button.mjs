...
var _typeof$22 = typeof Symbol === "function" && _typeof2$4(Symbol.iterator) === "symbol" ? function (obj) {
...
var createEagerElementUtil = function createEagerElementUtil(hasKey, isReferentiallyTransparent, type, props, children) {
  if (!hasKey && isReferentiallyTransparent) {
    if (children) {
      return type(_extends$8({}, props, { children: children }));
    }
    return type(props);
  }
...
var isClassComponent = function isClassComponent(Component$$1) {
  return Boolean(Component$$1 && Component$$1.prototype && _typeof$22(Component$$1.prototype.isReactComponent) === 'object');
};
...
var createFactory$1 = function createFactory(type) {
...
var withHandlers = function withHandlers(handlers) {
  return function (BaseComponent) {
    var factory = createFactory$1(BaseComponent);
    ...
    var WithHandlers = function (_Component) {
      ...
      WithHandlers.prototype.render = function render() {
        return factory(_extends$8({}, this.props, this.handlers));
      };
  ...
  return function (BaseComponent) {
    ...
    var WithState = function (_Component) {
      ...
      WithState.prototype.render = function render() {
        ...
        return factory(_extends$8({}, this.props, (_babelHelpers$extends = {}, _babelHelpers$extends[stateName] = this.state.stateValue, _babelHelpers$extends[stateUpdaterName] = this.updateStateValue, _babelHelpers$extends)));
      };
