(function (global, factory) {
  ...
  var genericTests = (function (_ref) {
    ...
    polytheneCss.ButtonCSS.addStyle(".tests-button-themed-button", {
      color_light_background: "#2196F3",
      color_dark_background: "#2196F3",
      color_light_text: "#fff"
    });

    polytheneCss.ButtonCSS.addStyle(".blue-on-dark-Button", {
      color_dark_text: "#2196F3"
    });

    polytheneCss.ButtonCSS.addStyle(".tests-button-bordered-button", {
    ...
    return [{
      ...
      component: {
        view: function view() {
          return h(".pe-button-row", [h(Button, {
            key: "one", // for React
            label: "One"
          }), h(Button, {
            key: "two", // for React
    ...
    return [{
      ...
      component: {
        ...
        view: function view(vnode) {
          return [h("div", "Updated: " + vnode.state.updated), h(Button, {
            label: "Button",
      ...
      component: {
        ...
        view: function view(vnode) {
          return [h("div", "onclick called: " + vnode.state.clicked), h(Button, {
            label: "Button",
            events: {
      ...
      component: {
        ...
        view: function view(vnode) {
          return [h("div", "onclick called: " + vnode.state.clickCount), h(Button, {
            label: "Button",
            events: {
              onclick: function onclick() {
  ...
  var testsMithril = [].concat(genericTests({ Button: polytheneMithril.Button, renderer: polytheneMithril.renderer })).concat(mithrilTests({ Button: polytheneMithril.Button, renderer: polytheneMithril.renderer }));
  ...
  */
  ...
  var inherits = function inherits(subClass, superClass) {
    if (typeof superClass !== "function" && superClass !== null) {
      throw new TypeError("Super expression must either be null or a function, not " + (typeof superClass === 'undefined' ? 'undefined' : _typeof2$4(superClass)));
    }
  ...
  var possibleConstructorReturn = function possibleConstructorReturn(self, call) {
    ...
    return call && ((typeof call === 'undefined' ? 'undefined' : _typeof2$4(call)) === "object" || typeof call === "function") ? call : self;
  };

  var createEagerElementUtil = function createEagerElementUtil(hasKey, isReferentiallyTransparent, type, props, children) {
    if (!hasKey && isReferentiallyTransparent) {
      if (children) {
        return type(_extends$7({}, props, { children: children }));
      }
      return type(props);
    }
    ...
    if (children) {
      return react.createElement(Component$$1, props, children);
    }
  ...
  var reactTests = function reactTests(_ref) {
    ...
    var SecondaryButton = function SecondaryButton(props) {
      return react.createElement(Button, _extends$8({ className: "react-secondary-button", border: true }, props));
    };

    polytheneCss.ButtonCSS.addStyle(".react-secondary-button", {
      color_light_text: "#673ab7",
      color_light_border: "#673ab7",
      color_dark_text: "yellow",
      color_dark_border: "yellow"
    ...
    return [{
      ...
      component: withCounter(function (_ref3) {
        ...
        return h("div", [h("div", "onclick called: " + counter), h(Button, {
          label: "Button",
          events: {
            onClick: increment
          }
      ...
      component: function component() {
        return react.createElement(Button, { label: "Button", className: "react-secondary-button", border: true });
      }
    }, {
      name: "Option: inactivate (2s) (JSX)",
      component: function component() {
        return react.createElement(Button, { label: "Inactivated for 2s", inactivate: 2 });
      }
    }, {
      name: "HOC (JSX)",
      component: function component() {
  ...
  var testsReact = [].concat(genericTests({ Button: polytheneReact.Button, renderer: polytheneReact.renderer })).concat(reactTests({ Button: polytheneReact.Button, renderer: polytheneReact.renderer }));
