(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('polythene-css'), require('polythene-mithril'), require('polythene-react')) :
	typeof define === 'function' && define.amd ? define(['exports', 'polythene-css', 'polythene-mithril', 'polythene-react'], factory) :
	(factory((global.polythene = {}),global['polythene-css'],global['polythene-mithril'],global['polythene-react']));
}(this, (function (exports,polytheneCss,polytheneMithril,polytheneReact) { 'use strict';
	...
	var navigation = (function (_ref) {
	  ...
	  return {
	    ...
	    view: function view(vnode) {
	      ...
	      var content = pushToolbar ? [h(Toolbar, { fullbleed: true, border: true }, createTopContent({ onClick: onClick })), navList] : navList;

	      var toolbarRow = [!drawerOpts.permanent && h(IconButton, {
	        key: "icon",
	      ...
	      }, h(Drawer, _extends({}, drawerOpts, { content: content }, !drawerOpts.permanent && {
	        show: state.show(),
	...
	var appDrawer = (function (_ref) {
	  ...
	  return {
	    ...
	    view: function view(_ref2) {
	      ...
	      }), h(Drawer, _extends$1({}, drawerOpts, {
	        key: "drawer", // for React
	...
	polytheneCss.ListTileCSS.addStyle(".tests-drawer-navigation-list", {
	...
	var genericTests = (function (_ref) {
	  ...
	  polytheneCss.DrawerCSS.addStyle(".drawer-tests-themed", {
	    color_dark_background: "rgba(69, 45, 157, 1)",
	    color_dark_text: "#fff",
	    color_dark_backdrop_background: "rgba(69, 45, 157, .5)"
	  });

	  polytheneCss.ToolbarCSS.addStyle(".tests-drawer-themed-toolbar", {
	  ...
	  var createTopContent = function createTopContent(_ref3) {
	    ...
	    return h(List, {
	      tiles: [h(ListTile, {
	        ...
	        hoverable: true,
	        navigation: true,
	        events: _defineProperty$3({}, keys.onclick, onClick)
	      })]
	    });
	  };
	  ...
	  return [{
	    ...
	    interactive: true,
	    exclude: true,
	    component: appDrawer({ renderer: renderer, keys: keys, Drawer: Drawer, RaisedButton: RaisedButton, createContent: createContent, drawerOpts: {
	        fixed: true,
	        backdrop: true,
	        z: 1
	      } })
	    ...
	    component: navigation({ renderer: renderer, keys: keys, Drawer: Drawer, Toolbar: Toolbar, IconButton: IconButton, createContent: createContent, drawerOpts: {
	        permanent: true,
	        border: true,
	        z: 0
	      } })
	    ...
	    interactive: true,
	    exclude: true,
	    component: navigation({ renderer: renderer, keys: keys, Drawer: Drawer, Toolbar: Toolbar, IconButton: IconButton, createContent: createContent, pushToolbar: true, createTopContent: createTopContent, drawerOpts: {
	        push: true,
	        border: true
	      } })
	  }, {
	    ...
	    interactive: true,
	    exclude: true,
	    component: navigation({ renderer: renderer, keys: keys, Drawer: Drawer, Toolbar: Toolbar, IconButton: IconButton, createContent: createContent, createTopContent: createTopContent, drawerOpts: {
	        push: true,
	        border: true,
	        mini: true
	      } })
	    ...
	    interactive: true,
	    exclude: true,
	    component: navigation({ renderer: renderer, keys: keys, Drawer: Drawer, Toolbar: Toolbar, IconButton: IconButton, createContent: createContent, repeats: 4, drawerOpts: {
	        backdrop: true,
	        z: 1
	      } })
	  }, {
...

	  {
	    ...
	    interactive: true,
	    exclude: true,
	    component: navigation({ renderer: renderer, keys: keys, Drawer: Drawer, Toolbar: Toolbar, IconButton: IconButton, createContent: createContent, rtl: true, drawerOpts: {
	        backdrop: true,
	        z: 1
	      } })
	  }, {
...

	  {
	    ...
	    component: navigation({ renderer: renderer, keys: keys, Drawer: Drawer, Toolbar: Toolbar, IconButton: IconButton, createContent: createContent, dark: true, drawerOpts: {
	        backdrop: true,
	        z: 1
	      } })
	  }];
	...
	var AppDrawer = {
	  ...
	  view: function view(_ref) {
	    ...
	    return [mithril(polytheneMithril.RaisedButton, {
	      label: "Show",
	      events: {
	        onclick: function onclick() {
	          return state.show = true;
	    ...
	    }), mithril(polytheneMithril.Drawer, _extends$2({}, drawerOpts, {
	      content: createContent({
	...
	var mithrilTests = function mithrilTests() {
	  ...
	  var h = polytheneMithril.renderer;
	  var createContent = function createContent(_ref) {
	    var repeats = _ref.repeats,
	        onClick = _ref.onClick;
	    return navigationList({ renderer: polytheneMithril.renderer, keys: polytheneMithril.keys, Icon: polytheneMithril.Icon, List: polytheneMithril.List, ListTile: polytheneMithril.ListTile, repeats: repeats, onClick: onClick });
	  };
	...
	var testsMithril = [].concat(genericTests({ renderer: polytheneMithril.renderer, keys: polytheneMithril.keys, Drawer: polytheneMithril.Drawer, List: polytheneMithril.List, ListTile: polytheneMithril.ListTile, Icon: polytheneMithril.Icon, Toolbar: polytheneMithril.Toolbar, IconButton: polytheneMithril.IconButton, RaisedButton: polytheneMithril.RaisedButton })).concat(mithrilTests({ renderer: polytheneMithril.renderer, keys: polytheneMithril.keys, Drawer: polytheneMithril.Drawer, List: polytheneMithril.List, ListTile: polytheneMithril.ListTile, Icon: polytheneMithril.Icon, Toolbar: polytheneMithril.Toolbar, IconButton: polytheneMithril.IconButton, RaisedButton: polytheneMithril.RaisedButton }));
	...
	*/
	...
	var reactTests = function reactTests() {
	  ...
	  var createContent = function createContent(_ref) {
	    var repeats = _ref.repeats,
	        onClick = _ref.onClick;
	    return navigationList({ renderer: polytheneReact.renderer, keys: polytheneReact.keys, Icon: polytheneReact.Icon, List: polytheneReact.List, ListTile: polytheneReact.ListTile, repeats: repeats, onClick: onClick });
	  };
	...
	var testsReact = [].concat(genericTests({ renderer: polytheneReact.renderer, keys: polytheneReact.keys, Drawer: polytheneReact.Drawer, List: polytheneReact.List, ListTile: polytheneReact.ListTile, Icon: polytheneReact.Icon, Toolbar: polytheneReact.Toolbar, IconButton: polytheneReact.IconButton, RaisedButton: polytheneReact.RaisedButton })).concat(reactTests({ renderer: polytheneReact.renderer, keys: polytheneReact.keys, Drawer: polytheneReact.Drawer, List: polytheneReact.List, ListTile: polytheneReact.ListTile, Icon: polytheneReact.Icon, Toolbar: polytheneReact.Toolbar, IconButton: polytheneReact.IconButton, RaisedButton: polytheneReact.RaisedButton }));
...
//# sourceMappingURL=test-drawer.js.map
