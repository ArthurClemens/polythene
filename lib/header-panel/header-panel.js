define([
    ...
    createView = function(ctrl, opts) {
        ...
        initOuterContainer = function(outerContainer, inited) {
            ...
            if (!opts.animated) {
                ctrl.initWithHeight(headerContainer.clientHeight);
            }
    ...
    return {
        controller: function(opts) {
            ...
            scrolled = false;
            prevScrollTop = 0;
            // defaults, finally set with initWithHeight
