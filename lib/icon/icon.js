...
Options:
    ...
    type (optional) (String): 'small', 'normal', 'medium', 'large' (default: 'normal'). Adds CSS class 'icon-small', 'icon-normal', 'icon-medium', 'icon-large.' Type 'medium' is the equivalent of passing className: 'icon-medium'
