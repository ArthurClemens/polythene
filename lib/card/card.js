define([
    ...
    createText = function(o) {
        ...
        opts = o.text || {};
        className = ['content', 'text', opts.class].join(' ');
        tag = 'div' || opts.tag;
        return m(tag, {
            class: className
    ...
    createMedia = function(o) {
        ...
        className = ['media-content', opts.type || null, ratio, opts.class].join(' ');
        tag = 'div' || opts.tag;
    ...
    createHeader = function(o) {
        ...
        props = Object.assign({
            class: ['content', 'card-header', opts.class].join(' '),
            config: opts.config
    ...
    createPrimary = function(o) {
        ...
        opts = o.primary || {};
        className = ['content', 'primary', opts.media ? 'has-media' : null, opts.class].join(' ');
