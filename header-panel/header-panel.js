...
var _polythene = require('polythene/polythene/polythene');

var _polythene2 = _interopRequireDefault(_polythene);

var _events = require('polythene/common/events');
...
var _toolbar = require('polythene/toolbar/toolbar');

var _toolbar2 = _interopRequireDefault(_toolbar);

require('polythene/header-panel/theme/theme');
...
var scroller = undefined; // keep track of scrolling elements on the page
var scrollPositions = {};
...
var classForMode = function classForMode() {
    var mode = arguments.length <= 0 || arguments[0] === undefined ? 'standard' : arguments[0];
...
var createHeaderComponent = function createHeaderComponent() {
    ...
    if (toolbarOpts) {
        ...
        return _mithril2.default.component(_toolbar2.default, toolbarOpts);
