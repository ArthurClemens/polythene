...
const createSlider = (ctrl, opts = {}, hasTicks, interactiveTrack) => {
    ...
    return [
        m("div", Object.assign({}, {
            ...
            ), opts.icon ? m("div", {class: classes.thumb}, opts.icon) : null),
            m("div",
                {
            ...
            (hasTicks && !opts.disabled) ? m("div", {class: classes.ticks}, generateTickMarks(ctrl.min, ctrl.max, stepCount)) : null,
...
const createView = (ctrl, opts = {}) => {
    ...
    const props = {
        class: [
            classes.component,
            (opts.disabled ? classes.isDisabled : null),
            (opts.pin ? classes.hasPin : null),
            (interactiveTrack ? classes.hasTrack : null),
            (ctrl.isActive ? classes.isActive : null),
            (ctrl.hasFocus ? classes.hasFocus : null),
            (ctrl.fraction() === 0 ? classes.isAtMin : null),
