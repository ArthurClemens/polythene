...
To create an indented title, use class key `indentedTitle`. This positions the title as if it would be next to an icon.

~~~javascript
import { Toolbar, IconButton } from "polythene-toolbar"
