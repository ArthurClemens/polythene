...
| **content**   | use children or `content` or `tabs` | Array of option objects | | Button row content; replaces children |
...
| **Parameter** |  **Mandatory** | **Type** | **Default** | **Description** |
| ------------- | -------------- | -------- | ----------- | --------------- |
| **tabs**   | use children or `content` or `tabs` | Array of option objects | | Button row content |
