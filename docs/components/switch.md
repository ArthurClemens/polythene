...
| **Parameter** |  **Mandatory** | **Type** | **Default** | **Description** |
| ------------- | -------------- | -------- | ----------- | --------------- |
| **size** | optional | String | 'regular' | Equivalent to [Icon's type](icon.md) option; either 'small' (16px), 'regular' (24px), 'medium' (32px), 'large' (40px.md) |
...
Switch is composed with [Selection control](selection-control.md).
