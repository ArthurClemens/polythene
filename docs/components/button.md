...
Displays a text button with a [Shadow](shadow.md) and [Ripple](ripple.md) effect.

See also: [Icon Button](icon-button.md) and [Floating Action Button](fab.md)
...
* No icon in button, as this is not part of the Material Design guidelines; use [icon Button](icon-button.md) instead
