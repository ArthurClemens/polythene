...
| **scrollAwayTopbar** | optional | Boolean | false | Set to `true` to scroll away the top part ([Toolbar's topBar](toolbar.md) of the header to be scrolled away |
...
Alternatively, pass [Toolbar](toolbar.md) options to use a toolbar as header:
